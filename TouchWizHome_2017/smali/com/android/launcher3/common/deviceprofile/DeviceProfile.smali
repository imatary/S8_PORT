...
.method public constructor <init>(Landroid/content/Context;IIIIZ)V
    ...
    iput-object v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->homeGridInfo:Ljava/util/ArrayList;

    new-instance v5, Ljava/util/ArrayList;

    invoke-direct {v5}, Ljava/util/ArrayList;-><init>()V

    iput-object v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->hotseatGridIconInfo:Ljava/util/ArrayList;

    new-instance v5, Ljava/util/ArrayList;

    invoke-direct {v5}, Ljava/util/ArrayList;-><init>()V

    iput-object v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->appsGridInfo:Ljava/util/ArrayList;

    new-instance v5, Ljava/util/ArrayList;

    invoke-direct {v5}, Ljava/util/ArrayList;-><init>()V

    iput-object v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->folderGridInfo:Ljava/util/ArrayList;
    ...
    iget v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->widthPx:I

    sub-int/2addr v5, p2

    :goto_0
    iput v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->navigationBarHeight:I
    ...
    iput v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->defaultIconSize:I
    ...
    iput v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->gedHomeCellWidth:I
    ...
    iput v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->gedHomeCellHeight:I
    ...
    iput v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->gedHomeCellCountX:I
    ...
    iput v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->gedHomeCellCountY:I
    ...
    iput v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->defaultCellWidth:I
    ...
    iput v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->defaultCellHeight:I
    ...
    iput v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->workspacePagePadding:I
    ...
    iput-boolean v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->hotseatRightLayoutWithOrientation:Z
    ...
    iput v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->appsExtraPaddingTop:I

    iget-object v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->appsGridInfo:Ljava/util/ArrayList;

    const/high16 v7, 0x7f0b0000

    invoke-direct {p0, p1, v5, v7}, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->loadGridInfo(Landroid/content/Context;Ljava/util/ArrayList;I)V
    ...
    iget-object v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->homeGridInfo:Ljava/util/ArrayList;

    const v7, 0x7f0b0002

    invoke-direct {p0, p1, v5, v7}, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->loadGridInfo(Landroid/content/Context;Ljava/util/ArrayList;I)V

    iget-object v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->hotseatGridIconInfo:Ljava/util/ArrayList;

    const v7, 0x7f0b0003

    invoke-direct {p0, p1, v5, v7}, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->loadHotseatGridInfo(Landroid/content/Context;Ljava/util/ArrayList;I)V
    ...
    iput v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->maxHotseatCount:I
    ...
    invoke-virtual {p0, v5, v6}, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->setAppsCurrentGrid(II)V

    return-void

    :cond_2
    iget v5, p0, Lcom/android/launcher3/common/deviceprofile/DeviceProfile;->heightPx:I
