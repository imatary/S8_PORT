...
.method static synthetic access$100(Lcom/android/launcher3/folder/controller/FolderController;)Lcom/android/launcher3/Launcher;
    .locals 1
...
.method static synthetic access$200(Lcom/android/launcher3/folder/controller/FolderController;)Lcom/android/launcher3/folder/view/FolderIconView;
    .locals 1
...
.method static synthetic access$300(Lcom/android/launcher3/folder/controller/FolderController;Lcom/android/launcher3/folder/view/FolderView;)V
    .locals 0
...
.method protected onStageEnter(Lcom/android/launcher3/common/stage/StageEntry;)Landroid/animation/Animator;
    ...
    const-string v9, "FolderController"
    ...
    iget v6, p1, Lcom/android/launcher3/common/stage/StageEntry;->fromStage:I

    invoke-virtual {p1}, Lcom/android/launcher3/common/stage/StageEntry;->getLayerViews()Ljava/util/HashMap;

    move-result-object v7

    const-string v9, "KEY_FOLDER_ICON_VIEW"

    invoke-virtual {p1, v9}, Lcom/android/launcher3/common/stage/StageEntry;->getExtras(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Lcom/android/launcher3/folder/view/FolderIconView;

    const-string v9, "KEY_FOLDER_ICON_APPSEARCHED"
    ...
    iput-object v9, p0, Lcom/android/launcher3/folder/controller/FolderController;->mSearchedAppInfo:Lcom/android/launcher3/common/base/item/IconInfo;

    const-string v9, "KEY_SELECTED_ITEMS"
    ...
    iput-object v4, p0, Lcom/android/launcher3/folder/controller/FolderController;->mTargetFolderIconView:Lcom/android/launcher3/folder/view/FolderIconView;
    ...
    invoke-virtual {v3, p0}, Lcom/android/launcher3/folder/view/FolderView;->bindController(Lcom/android/launcher3/folder/controller/FolderController;)V
    ...
    iget-object v11, p0, Lcom/android/launcher3/folder/controller/FolderController;->mTargetFolderItems:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v3}, Lcom/android/launcher3/folder/controller/FolderController;->onOpenFolder(Lcom/android/launcher3/folder/view/FolderView;)V

    invoke-virtual {v3}, Lcom/android/launcher3/folder/view/FolderView;->prepareOpen()V
    ...
    invoke-virtual {v9, v3, v10}, Lcom/android/launcher3/folder/FolderTransitionAnimation;->getEnterFromHomeOrAppsAnimation(Lcom/android/launcher3/folder/view/FolderView;Lcom/android/launcher3/folder/view/FolderIconView;)Landroid/animation/Animator;

    move-result-object v2

    invoke-virtual {v3, v2}, Lcom/android/launcher3/folder/view/FolderView;->onOpen(Landroid/animation/Animator;)V
    ...
    invoke-virtual {p0, v9}, Lcom/android/launcher3/folder/controller/FolderController;->enterDragState(Z)V
    ...
    invoke-virtual {v9}, Lcom/android/launcher3/LauncherAppState;->getTopViewChangedMessageHandler()Lcom/android/launcher3/proxy/LauncherTopViewChangedMessageHandler;

    move-result-object v9

    const/4 v10, 0x3

    invoke-virtual {v9, v10}, Lcom/android/launcher3/proxy/LauncherTopViewChangedMessageHandler;->sendMessage(I)V
    ...
    invoke-virtual {v9}, Lcom/android/launcher3/folder/FolderInfo;->isLocked()Z
    ...
    invoke-virtual {v5, v9}, Lcom/android/launcher3/folder/folderlock/FolderLock;->lockFolderAfterAdd(Lcom/android/launcher3/folder/FolderInfo;)V
    ...
    invoke-virtual {v9, v10}, Lcom/android/launcher3/folder/view/FolderBgView;->setHelpTextColor(Z)V

    iget v9, p0, Lcom/android/launcher3/folder/controller/FolderController;->mState:I
    ...
    invoke-virtual {p0, v9, v10}, Lcom/android/launcher3/folder/controller/FolderController;->showFolderBgView(ZZ)V
    ...
    :goto_2
    invoke-static {v10, v9}, Lcom/android/launcher3/Utilities;->hideStatusBar(Landroid/view/Window;Z)V

    sget-object v9, Lcom/android/launcher3/util/Talk;->INSTANCE:Lcom/android/launcher3/util/Talk;

    invoke-virtual {v9}, Lcom/android/launcher3/util/Talk;->isAccessibilityEnabled()Z
    ...
    new-instance v9, Lcom/android/launcher3/folder/controller/FolderController$2;

    invoke-direct {v9, p0}, Lcom/android/launcher3/folder/controller/FolderController$2;-><init>(Lcom/android/launcher3/folder/controller/FolderController;)V
    ...
    iput v9, p0, Lcom/android/launcher3/folder/controller/FolderController;->mFolderCloseReason:I
    ...
    iget-boolean v9, v9, Lcom/android/launcher3/folder/FolderInfo;->opened:Z
    ...
    invoke-virtual {v3, v9}, Lcom/android/launcher3/folder/view/FolderView;->onOpen(Landroid/animation/Animator;)V
    ...
    invoke-virtual {v9, v0}, Lcom/android/launcher3/folder/view/FolderIconView;->addItems(Ljava/util/ArrayList;)V

    :cond_c
    iget-object v9, p0, Lcom/android/launcher3/folder/controller/FolderController;->mTransitionAnimation:Lcom/android/launcher3/folder/FolderTransitionAnimation;

    invoke-virtual {v9, v3, v0}, Lcom/android/launcher3/folder/FolderTransitionAnimation;->getEnterFromFolderAddAppsAnimation(Lcom/android/launcher3/folder/view/FolderView;Ljava/util/ArrayList;)Landroid/animation/Animator;
    ...
    invoke-virtual {v9, v3}, Lcom/android/launcher3/folder/FolderTransitionAnimation;->getEnterFromWidgetAnimation(Lcom/android/launcher3/folder/view/FolderView;)Landroid/animation/Animator;
    ...
    iget-wide v10, v9, Lcom/android/launcher3/folder/FolderInfo;->container:J
    ...
    new-instance v9, Lcom/android/launcher3/folder/controller/FolderController$1;

    invoke-direct {v9, p0}, Lcom/android/launcher3/folder/controller/FolderController$1;-><init>(Lcom/android/launcher3/folder/controller/FolderController;)V
    ...
    invoke-virtual {v1, v9}, Lcom/android/launcher3/common/view/DragLayer;->setBackgroundImageAlpha(F)V
...
.method protected onStageExit(Lcom/android/launcher3/common/stage/StageEntry;)Landroid/animation/Animator;
    ...
    const-string v11, "FolderController"

    const-string v12, "onStageExit()"
    ...
    invoke-static {v11}, Lcom/android/launcher3/Utilities;->closeDialog(Landroid/app/Activity;)V

    const/4 v3, 0x0

    if-eqz p1, :cond_9

    iget v10, p1, Lcom/android/launcher3/common/stage/StageEntry;->toStage:I
    ...
    iget-object v11, p0, Lcom/android/launcher3/folder/controller/FolderController;->mSearchedAppInfo:Lcom/android/launcher3/common/base/item/IconInfo;

    if-eqz v11, :cond_0

    const/4 v11, 0x0

    iput-object v11, p0, Lcom/android/launcher3/folder/controller/FolderController;->mSearchedAppInfo:Lcom/android/launcher3/common/base/item/IconInfo;
    ...
    invoke-virtual {v11}, Lcom/android/launcher3/folder/view/FolderIconView;->getFolderView()Lcom/android/launcher3/folder/view/FolderView;
    ...
    invoke-virtual {v11}, Lcom/android/launcher3/folder/view/FolderIconView;->getParent()Landroid/view/ViewParent;
    ...
    iget-object v12, p0, Lcom/android/launcher3/folder/controller/FolderController;->mTargetFolderIconView:Lcom/android/launcher3/folder/view/FolderIconView;

    invoke-virtual {p1, v11, v12}, Lcom/android/launcher3/common/stage/StageEntry;->putExtras(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    iput v11, p0, Lcom/android/launcher3/folder/controller/FolderController;->mBackupBackgroundAlpha:F

    const/4 v11, 0x0

    iput v11, p0, Lcom/android/launcher3/folder/controller/FolderController;->mBackupBlurAmount:F

    :cond_5
    invoke-direct {p0, v4}, Lcom/android/launcher3/folder/controller/FolderController;->onCloseFolder(Lcom/android/launcher3/folder/view/FolderView;)V

    iget v11, p1, Lcom/android/launcher3/common/stage/StageEntry;->stageCountOnFinishAllStage:I

    const/4 v12, 0x2

    if-gt v11, v12, :cond_6

    iget-boolean v11, p1, Lcom/android/launcher3/common/stage/StageEntry;->broughtToHome:Z

    if-eqz v11, :cond_d

    :cond_6
    const-string v11, "KEY_SUPPRESS_CHANGE_STAGE_ONCE"
    ...
    invoke-virtual {p1, v11, v12}, Lcom/android/launcher3/common/stage/StageEntry;->getExtras(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :goto_2
    iput v11, p0, Lcom/android/launcher3/folder/controller/FolderController;->mFolderCloseReason:I

    const/4 v11, 0x0

    invoke-virtual {v4, v11}, Lcom/android/launcher3/folder/view/FolderView;->onClose(Landroid/animation/Animator;)V
    ...
    invoke-virtual {v11}, Lcom/android/launcher3/folder/FolderInfo;->isContainApps()Z
    ...
    iget v12, p0, Lcom/android/launcher3/folder/controller/FolderController;->mFolderCloseReason:I

    invoke-static {v12}, Ljava/lang/String;->valueOf(I)Ljava/lang/String;

    move-result-object v12

    invoke-virtual {v11, v8, v2, v12}, Lcom/android/launcher3/util/logging/SALogging;->insertEventLog(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    move-object v0, v4

    if-eqz v3, :cond_f

    new-instance v11, Lcom/android/launcher3/folder/controller/FolderController$3;

    invoke-direct {v11, p0, v0}, Lcom/android/launcher3/folder/controller/FolderController$3;-><init>(Lcom/android/launcher3/folder/controller/FolderController;Lcom/android/launcher3/folder/view/FolderView;)V
    ...
    invoke-virtual {p0, v11, v12}, Lcom/android/launcher3/folder/controller/FolderController;->showFolderBgView(ZZ)V
    ...
    :cond_d
    iget-object v11, p0, Lcom/android/launcher3/folder/controller/FolderController;->mTransitionAnimation:Lcom/android/launcher3/folder/FolderTransitionAnimation;

    iget-object v12, p0, Lcom/android/launcher3/folder/controller/FolderController;->mTargetFolderIconView:Lcom/android/launcher3/folder/view/FolderIconView;

    invoke-virtual {v11, v4, v12}, Lcom/android/launcher3/folder/FolderTransitionAnimation;->getExitToHomeOrAppsAnimation(Lcom/android/launcher3/folder/view/FolderView;Lcom/android/launcher3/folder/view/FolderIconView;)Landroid/animation/Animator;

    move-result-object v3

    invoke-virtual {v4, v3}, Lcom/android/launcher3/folder/view/FolderView;->onClose(Landroid/animation/Animator;)V
    ...
    invoke-virtual {v11, v12}, Lcom/android/launcher3/folder/view/FolderIconView;->setVisibility(I)V
    ...
    invoke-virtual {v11, v4}, Lcom/android/launcher3/folder/FolderTransitionAnimation;->getExitToFolderAddAppsAnimation(Lcom/android/launcher3/folder/view/FolderView;)Landroid/animation/Animator;
    ...
    invoke-virtual {v11, v4}, Lcom/android/launcher3/folder/FolderTransitionAnimation;->getExitToWidgetAnimation(Lcom/android/launcher3/folder/view/FolderView;)Landroid/animation/Animator;
    ...
    invoke-virtual {v1, v11}, Lcom/android/launcher3/common/view/DragLayer;->setBackgroundImageAlpha(F)V
