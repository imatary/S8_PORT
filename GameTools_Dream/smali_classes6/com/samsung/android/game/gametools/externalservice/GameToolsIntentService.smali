...
.field public static final BEDDING_MODE_OFF:I = 0x9

.field public static final BEDDING_MODE_ON:I = 0xa
...
.field private static isGameApp:Z

.field private static isOnResume:Z
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/samsung/android/game/gametools/externalservice/GameToolsIntentService;->isOnResume:Z

    sput-boolean v0, Lcom/samsung/android/game/gametools/externalservice/GameToolsIntentService;->isGameApp:Z
...
.method public static declared-synchronized isGameApp()Z
    .locals 2
    ...
    :try_start_0
    sget-boolean v1, Lcom/samsung/android/game/gametools/externalservice/GameToolsIntentService;->isGameApp:Z
    :try_end_0
...
.method public static declared-synchronized isOnResume()Z
    .locals 2
    ...
    :try_start_0
    sget-boolean v1, Lcom/samsung/android/game/gametools/externalservice/GameToolsIntentService;->isOnResume:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static declared-synchronized setGameApp(Z)V
    .locals 4

    const-class v1, Lcom/samsung/android/game/gametools/externalservice/GameToolsIntentService;
    ...
    const-string/jumbo v3, "setGameApp : "
    ...
    sput-boolean p0, Lcom/samsung/android/game/gametools/externalservice/GameToolsIntentService;->isGameApp:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static declared-synchronized setIsOnResume(Z)V
    .locals 2
    ...
    :try_start_0
    sput-boolean p0, Lcom/samsung/android/game/gametools/externalservice/GameToolsIntentService;->isOnResume:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public makeGameLauncherHun(Landroid/content/Context;)V
    .locals 11
    ...
    invoke-static {p1}, Lcom/sec/game/gamecast/common/model/SettingData;->isGameHomeEnableSync(Landroid/content/Context;)Z

    move-result v4

    sget-wide v0, Lcom/sec/game/gamecast/common/constant/Define;->AFTER_3HOUR_OOBE_TIME:J

    invoke-static {p1, v0, v1}, Lcom/sec/game/gamecast/common/model/SettingData;->isAfterFromSetupWizardComplete(Landroid/content/Context;J)Z

    move-result v3

    invoke-static {p1}, Lcom/sec/game/gamecast/common/model/SettingData;->isLauncherNotificationClose(Landroid/content/Context;)Z

    move-result v5

    const-string/jumbo v6, "GameToolsIntentService"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v8, "isHomeEnabled = "
    ...
    const-string/jumbo v8, "SetupWizard Time Duration:"
    ...
    invoke-static {p1}, Lcom/sec/game/gamecast/common/model/SettingData;->getLauncherNotificationCount(Landroid/content/Context;)I

    move-result v2

    const-string/jumbo v6, "GameToolsIntentService"

    const-string/jumbo v7, "isAfterSetupWizardCompleteTime and isNotLauncherNotificationClose"
    ...
    const-string/jumbo v8, "enableLauncherCount: "
    ...
    invoke-static {p1, v9}, Lcom/sec/game/gamecast/common/model/SettingData;->setLauncherNotificationCount(Landroid/content/Context;I)V

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v6

    invoke-static {p1, v6, v7}, Lcom/sec/game/gamecast/common/model/SettingData;->setFirstLauncherHunTime(Landroid/content/Context;J)V

    const/4 v6, 0x0

    invoke-static {p1, v6}, Lcom/samsung/android/game/gametools/floatingui/notification/NotificationController;->makeAndShowHeadUpNotification(Landroid/content/Context;Z)V
    ...
    invoke-static {p1, v10}, Lcom/sec/game/gamecast/common/model/SettingData;->setLauncherNotificationCount(Landroid/content/Context;I)V
    ...
    invoke-static {p1}, Lcom/sec/game/gamecast/common/model/SettingData;->isAfterHourFirstCloseLauncherHun(Landroid/content/Context;)Z

    move-result v6

    if-eqz v6, :cond_0

    invoke-static {p1, v9}, Lcom/sec/game/gamecast/common/model/SettingData;->setLauncherNotificationClose(Landroid/content/Context;Z)V

    invoke-static {p1, v9}, Lcom/sec/game/gamecast/common/model/SettingData;->setGameHomeEnableSync(Landroid/content/Context;Z)V

    invoke-static {p1}, Lcom/samsung/android/game/gametools/floatingui/notification/NotificationController;->makeEnableLauncherNotification(Landroid/content/Context;)V
...
.method protected onHandleIntent(Landroid/content/Intent;)V
    ...
    invoke-static/range {p0 .. p0}, Lcom/sec/game/gamecast/common/utility/DeviceUtil;->isDesktopMode(Landroid/content/Context;)Z

    move-result v2

    if-nez v2, :cond_0

    invoke-static/range {p0 .. p0}, Lcom/sec/game/gamecast/common/utility/CommonUtil;->isSemCarModeOn(Landroid/content/Context;)Z
    ...
    invoke-static {v2}, Lcom/samsung/android/game/gametools/externalservice/GameToolsIntentService;->setGameApp(Z)V

    invoke-static {v8}, Lcom/sec/game/gamecast/common/model/SettingData;->isPerformanceGameModeOn(Landroid/content/Context;)Z
    ...
    :cond_3
    :try_start_1
    invoke-static {v8}, Lcom/sec/game/gamecast/common/model/SettingData;->getPrevDefaultLauncher(Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_4
    invoke-static {v8}, Lcom/sec/game/gamecast/common/controller/PackageManagerWrapper;->getInstance(Landroid/content/Context;)Lcom/sec/game/gamecast/common/controller/PackageManagerWrapper;

    move-result-object v2

    invoke-virtual {v2, v12}, Lcom/sec/game/gamecast/common/controller/PackageManagerWrapper;->isDefaultLauncher(Ljava/lang/String;)Z
    ...
    invoke-static {v8, v12}, Lcom/sec/game/gamecast/common/model/SettingData;->setPrevDefaultLauncher(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {v8, v2, v12}, Lcom/sec/game/gamecast/common/utility/PermissionUtil;->hasPermissionOnPackage(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v2}, Lcom/samsung/android/game/gametools/externalservice/GameToolsIntentService;->setIsOnResume(Z)V
    ...
    invoke-virtual {v0, v15, v12, v2}, Lcom/samsung/android/game/gametools/externalservice/GameToolsIntentService;->startToolsService(ILjava/lang/String;Z)V

    const/4 v2, 0x0

    invoke-static {v8, v2}, Lcom/samsung/android/game/gametools/externalservice/GameToolsIntentService;->registerSuicideAlarm(Landroid/content/Context;Z)V
    ...
    invoke-static {v8}, Lcom/sec/game/gamecast/common/utility/ContextProviderUtil;->getInstance(Landroid/content/Context;)Lcom/sec/game/gamecast/common/utility/ContextProviderUtil;

    move-result-object v2

    invoke-virtual/range {p0 .. p0}, Lcom/samsung/android/game/gametools/externalservice/GameToolsIntentService;->getPackageName()Ljava/lang/String;
    ...
    invoke-direct {v3, v0, v8}, Lcom/samsung/android/game/gametools/externalservice/GameToolsIntentService$1;-><init>(Lcom/samsung/android/game/gametools/externalservice/GameToolsIntentService;Landroid/content/Context;)V
    ...
    invoke-static {v8}, Lcom/sec/game/gamecast/common/model/SettingData;->getAudioSource(Landroid/content/Context;)I
    ...
    invoke-static/range {v16 .. v16}, Lcom/sec/game/gamecast/common/model/SettingData;->getProfileSource(Landroid/content/Context;)I
    ...
    invoke-static/range {v16 .. v16}, Lcom/sec/game/gamecast/common/model/SettingData;->getBitrateUI(Landroid/content/Context;)I
    ...
    invoke-virtual {v2, v3, v12, v4}, Lcom/sec/game/gamecast/common/utility/NoAlertsUtil;->requestNoAlertsOnRuntime(ZLjava/lang/String;Z)Z
    ...
    invoke-static {v8}, Lcom/sec/game/gamecast/common/utility/DeviceUtil;->isSetupWizardFinished(Landroid/content/Context;)Z
    ...
    :cond_e
    invoke-static {v8}, Lcom/sec/game/gamecast/common/utility/CommonUtil;->isKidsMode(Landroid/content/Context;)Z
    ...
    :cond_f
    invoke-static {v8}, Lcom/sec/game/gamecast/common/utility/CommonUtil;->isGameLauncherPreloadVersion(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v8}, Lcom/samsung/android/game/gametools/externalservice/GameToolsIntentService;->makeGameLauncherHun(Landroid/content/Context;)V
    ...
    sget-boolean v2, Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->isLocked:Z

    if-nez v2, :cond_0

    const-string/jumbo v2, "GameToolsIntentService"

    const-string/jumbo v3, "BEDDING_MODE_ON"
    ...
    new-instance v3, Lcom/samsung/android/game/gametools/externalservice/GameToolsIntentService$2;

    move-object/from16 v0, p0

    invoke-direct {v3, v0, v10, v8}, Lcom/samsung/android/game/gametools/externalservice/GameToolsIntentService$2;-><init>(Lcom/samsung/android/game/gametools/externalservice/GameToolsIntentService;ZLandroid/content/Context;)V
    ...
    :try_start_5
    invoke-static {v9}, Lcom/sec/game/gamecast/common/logger/TLog;->e(Ljava/lang/Throwable;)V
    :try_end_5
...
.method public showFloatingWindowPermissionNotification(Landroid/content/Context;)V
    ...
    sget v19, Lcom/samsung/android/game/gametools/floatingui/R$drawable;->stat_gametools_nmr:I
