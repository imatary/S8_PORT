...
.field public static final STOP_RECORDING:I = 0x7

.field private static TARGET_BATTERY_PERCENTAGE:I

.field private static instance:Lcom/samsung/android/game/gametools/externalservice/GameToolsService;
...
.field private mShowToolkitRunnable:Ljava/lang/Runnable;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->instance:Lcom/samsung/android/game/gametools/externalservice/GameToolsService;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->mIsImcomingCall:Z

    iput-object v2, p0, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->mToolkitController:Lcom/samsung/android/game/gametools/floatingui/toolkit/ToolkitController;
    ...
    iput-object v0, p0, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->mMainHandler:Landroid/os/Handler;
    ...
    iput-object v0, p0, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->mShowToolkitRunnable:Ljava/lang/Runnable;
...
.method static synthetic access$100(Lcom/samsung/android/game/gametools/externalservice/GameToolsService;)V
    .locals 0

    invoke-direct {p0}, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->refreshToolkit()V

    return-void
.end method

.method static synthetic access$200(Lcom/samsung/android/game/gametools/externalservice/GameToolsService;)Z
    .locals 1
...
.method static synthetic access$302(Lcom/samsung/android/game/gametools/externalservice/GameToolsService;Z)Z
    .locals 0
...
.method static synthetic access$500(Lcom/samsung/android/game/gametools/externalservice/GameToolsService;)Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModule;
    .locals 1
...
.method public static declared-synchronized getService()Lcom/samsung/android/game/gametools/externalservice/GameToolsService;
    .locals 2

    const-class v0, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->instance:Lcom/samsung/android/game/gametools/externalservice/GameToolsService;
    :try_end_0
...
.method private onGamePause(Ljava/lang/String;Z)V
    ...
    iget-object v0, p0, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->mMainHandler:Landroid/os/Handler;

    iget-object v1, p0, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->mShowToolkitRunnable:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->stopRecordService(Z)V
...
.method private refreshToolkit()V
    .locals 2

    const-string/jumbo v0, "GameTools Service"

    const-string/jumbo v1, "refreshToolkit"
    ...
    const-string/jumbo v1, "refreshToolkit : game ON"
    ...
    const-string/jumbo v1, "refreshToolkit : game OFF"
...
.method public static declared-synchronized setService(Lcom/samsung/android/game/gametools/externalservice/GameToolsService;)V
    .locals 2
    ...
    :try_start_0
    sput-object p0, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->instance:Lcom/samsung/android/game/gametools/externalservice/GameToolsService;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public forceStopRecordService()V
    .locals 3
    ...
    const-string/jumbo v1, "forceStopRecordService"
    ...
    invoke-virtual {v0, v2, v2}, Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModule;->stopRecordingModule(ZZ)V
...
.method public getRecordModule(Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModule$RecordingListener;)Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModule;
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModule;->setRecordingListener(Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModule$RecordingListener;)V
...
.method public getToolkitController()Lcom/samsung/android/game/gametools/floatingui/toolkit/ToolkitController;
    .locals 1
...
.method public declared-synchronized onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    sget-boolean v1, Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->isLocked:Z
...
.method public onCreate()V
    ...
    invoke-static {p0}, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->setService(Lcom/samsung/android/game/gametools/externalservice/GameToolsService;)V
...
.method public onDestroy()V
    ...
    invoke-static {v2}, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->setService(Lcom/samsung/android/game/gametools/externalservice/GameToolsService;)V
    ...
    iput-object v2, p0, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->mReceiver:Lcom/samsung/android/game/gametools/externalservice/GameToolsService$AlwaysReceiver;
    ...
    invoke-virtual {v0, v3, v1, v3}, Lcom/sec/game/gamecast/common/utility/NoAlertsUtil;->requestNoAlertsOnRuntime(ZLjava/lang/String;Z)Z
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    const-string/jumbo v5, "GameTools Service"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v7, "onStartCommand(intent="
    ...
    const-string/jumbo v6, "PerformanceGameMode ON"
    ...
    :sswitch_0
    const-string/jumbo v5, "GameToolsVersionName"

    iget-object v6, p0, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->mGameToolsVersionName:Ljava/lang/String;
    ...
    const-string/jumbo v7, "onStartCommand RESUMED : "
    ...
    invoke-direct {p0, v4, v1, v0}, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->onGameStateChanged(ZLjava/lang/String;Z)V
    ...
    const-string/jumbo v6, "onStartCommand PAUSED : "
    ...
    invoke-direct {p0, v8, v1, v0}, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->onGameStateChanged(ZLjava/lang/String;Z)V
    ...
    const-string/jumbo v6, "onStartCommand STOP_RECORD"
    ...
    const-string/jumbo v6, "sem_statusbar"
    ...
    :cond_3
    iget-object v5, p0, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->mRecordingModule:Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModule;

    if-eqz v5, :cond_1

    iget-object v5, p0, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->mRecordingModule:Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModule;

    invoke-virtual {v5, v8}, Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModule;->setScreenWasLeftException(Z)V

    invoke-virtual {p0, v4}, Lcom/samsung/android/game/gametools/externalservice/GameToolsService;->stopRecordService(Z)V
...
.method public stopRecordService(Z)V
    .locals 3
    ...
    invoke-virtual {v0}, Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModule;->getFloatingMovingCnt()Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, v1}, Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModule;->stopRecordingModule(ZZ)V
    ...
    invoke-static {v0}, Lcom/samsung/android/game/gametools/floatingui/util/SAToolsUtil;->sendEventToSA(Ljava/lang/String;)V
