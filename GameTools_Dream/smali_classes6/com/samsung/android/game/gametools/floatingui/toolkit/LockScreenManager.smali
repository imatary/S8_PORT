...
.field public static volatile isLocked:Z
...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->isLocked:Z
...
.method private inflate(Z)V
    ...
    new-instance v6, Lcom/samsung/android/game/gametools/floatingui/view/customview/KeyDispatchFrameLayout;
    ...
    invoke-direct {v6, v7}, Lcom/samsung/android/game/gametools/floatingui/view/customview/KeyDispatchFrameLayout;-><init>(Landroid/content/Context;)V

    iput-object v6, p0, Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->mMainView:Lcom/samsung/android/game/gametools/floatingui/view/customview/KeyDispatchFrameLayout;
    ...
    iput-object v6, p0, Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->mLockView:Landroid/widget/FrameLayout;

    iget-object v6, p0, Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->mLockView:Landroid/widget/FrameLayout;

    sget v7, Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->LOCK_SCRREN_COLOR:I
    ...
    iget-object v6, p0, Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->mContext:Landroid/content/Context;
    ...
    sget v6, Lcom/samsung/android/game/gametools/floatingui/R$layout;->layout_gamelock_textlayer:I
    ...
    iput-object v6, p0, Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->mTextLayout:Landroid/widget/RelativeLayout;

    iget-object v6, p0, Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->mTextLayout:Landroid/widget/RelativeLayout;

    sget v7, Lcom/samsung/android/game/gametools/floatingui/R$id;->tv_summary:I
    ...
    sget v7, Lcom/samsung/android/game/gametools/floatingui/R$id;->tv_no_alerts:I
    ...
    sget v6, Lcom/samsung/android/game/gametools/floatingui/R$string;->MIDS_GH_NPBODY_GAME_BEING_PLAYED:I
    ...
    invoke-static {v6}, Lcom/sec/game/gamecast/common/model/SettingData;->isNoAlertsOnSystemSettings(Landroid/content/Context;)Z
    ...
    sget v7, Lcom/samsung/android/game/gametools/floatingui/R$string;->DREAM_GH_BODY_NO_ALERTS_DURING_GAME_TURNED_ON:I
    ...
    iget-object v6, p0, Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->mMainView:Lcom/samsung/android/game/gametools/floatingui/view/customview/KeyDispatchFrameLayout;
    ...
    invoke-virtual {v6, v7, v2}, Lcom/samsung/android/game/gametools/floatingui/view/customview/KeyDispatchFrameLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v6, v7, v4}, Lcom/samsung/android/game/gametools/floatingui/view/customview/KeyDispatchFrameLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v6, v7, v8}, Lcom/samsung/android/game/gametools/floatingui/view/customview/KeyDispatchFrameLayout;->setLayerType(ILandroid/graphics/Paint;)V

    iget-object v6, p0, Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->mMainView:Lcom/samsung/android/game/gametools/floatingui/view/customview/KeyDispatchFrameLayout;

    iget-object v7, p0, Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->mLockViewTouchListener:Landroid/view/View$OnTouchListener;

    invoke-virtual {v6, v7}, Lcom/samsung/android/game/gametools/floatingui/view/customview/KeyDispatchFrameLayout;->setOnTouchListener(Landroid/view/View$OnTouchListener;)V

    :goto_2
    return-void

    :cond_0
    sget v6, Lcom/samsung/android/game/gametools/floatingui/R$string;->MIDS_GHUB_TPOP_APP_RUNNING:I
    ...
    sget v7, Lcom/samsung/android/game/gametools/floatingui/R$string;->DREAM_GH_BODY_NO_ALERTS_WHILE_USING_APP_IS_ON:I
...
.method private updateBatteryText()V
    ...
    iget v3, p0, Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->mBatteryPercent:I
...
.method public declared-synchronized lock(Ljava/lang/Runnable;Z)V
    ...
    sput-boolean v2, Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->isLocked:Z
