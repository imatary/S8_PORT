...
.field public static final BITRATE_AUTO_1080P:I = 0xbdd800

.field public static final BITRATE_AUTO_360P:I = 0x189c00

.field public static final BITRATE_AUTO_480P:I = 0x2bbba0

.field public static final BITRATE_AUTO_540P:I = 0x375f00

.field public static final BITRATE_AUTO_720P:I = 0x627000
...
.method public static getCafeIdTable(Landroid/content/Context;)Ljava/lang/String;
    .locals 2

    const-string/jumbo v0, "key_cafe_id_table"
...
.method public static getFirstLauncherHunTime(Landroid/content/Context;)J
    .locals 4

    const-string/jumbo v0, "key_launcher_notification_close_first_time"
...
.method public static getLauncherNotificationCount(Landroid/content/Context;)I
    .locals 2

    const-string/jumbo v0, "key_launhcer_notification_count"
...
.method public static getUuidByGos(Landroid/content/Context;)Ljava/lang/String;
    .locals 2

    const-string/jumbo v0, "key_uuid_issued_by_gos"
...
.method public static getUuidInfo(Landroid/content/Context;)Ljava/lang/String;
    .locals 2

    const-string/jumbo v0, "key_uuid_info"
...
.method public static isAfterHourFirstCloseLauncherHun(Landroid/content/Context;)Z
    .locals 6

    invoke-static {p0}, Lcom/sec/game/gamecast/common/model/SettingData;->getFirstLauncherHunTime(Landroid/content/Context;)J
    ...
    invoke-static {p0, v0, v1}, Lcom/sec/game/gamecast/common/model/SettingData;->setFirstLauncherHunTime(Landroid/content/Context;J)V
    ...
    sget-wide v4, Lcom/sec/game/gamecast/common/constant/Define;->GAME_TOOLS_1HOUR:J
...
.method public static isLauncherNotificationClose(Landroid/content/Context;)Z
    .locals 2

    const-string/jumbo v0, "key_launcher_notification_close"
...
.method public static setCafeIdTable(Landroid/content/Context;Ljava/lang/String;)V
    .locals 1
...
.method public static setFirstLauncherHunTime(Landroid/content/Context;J)V
    .locals 1
...
.method public static setGameHomeEnableSync(Landroid/content/Context;Z)V
    ...
    invoke-static {p0, v0}, Lcom/sec/game/gamecast/common/model/SettingData;->setLauncherNotificationClose(Landroid/content/Context;Z)V

    invoke-static {p0, v0}, Lcom/sec/game/gamecast/common/model/SettingData;->setSelectedNotificationClose(Landroid/content/Context;Z)V
...
.method public static setLauncherNotificationClose(Landroid/content/Context;Z)V
    .locals 1
...
.method public static setLauncherNotificationCount(Landroid/content/Context;I)V
    .locals 1
...
.method public static setNoAlertsOnSystemSettings(Landroid/content/Context;Z)V
    ...
    const-string/jumbo v1, "setNoAlertsOnSystemSettings : "
...
.method public static setSelectedNotificationClose(Landroid/content/Context;Z)V
    .locals 1
...
.method public static setUuidByGos(Landroid/content/Context;Ljava/lang/String;)V
    .locals 1
...
.method public static setUuidInfo(Landroid/content/Context;Ljava/lang/String;)V
    .locals 1
