...
.method private placeEmergencyCall()V
    ...
    const-string/jumbo v2, "EmergencyCallHelper"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v4, "placeEmergencyCall(): placeCall() failed: callStatus = "
...
.method private powerOnRadio()V
    ...
    invoke-virtual {v1, v2}, Lcom/android/internal/telephony/Phone;->setRadioPower(Z)V
...
.method private scheduleRetryOrBailOut()V
    ...
    const-string/jumbo v0, "EmergencyCallHelper"

    const-string/jumbo v1, "scheduleRetryOrBailOut: hit MAX_NUM_RETRIES; giving up..."
...
.method private startSequenceInternal(Landroid/os/Message;)V
    ...
    const-string/jumbo v1, "EmergencyCallHelper"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string/jumbo v2, "handleMessage: unexpected message: "
