...
.method static synthetic -wrap0(Lcom/android/phone/HfaLogic;Ljava/lang/String;)V
    .locals 0
...
.method static synthetic -wrap1(Lcom/android/phone/HfaLogic;)V
    .locals 0
...
.method static synthetic -wrap2(Lcom/android/phone/HfaLogic;Landroid/telephony/ServiceState;)V
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/phone/HfaLogic$HfaLogicCallback;Landroid/app/PendingIntent;)V
    ...
    new-instance v0, Lcom/android/phone/HfaLogic$1;

    invoke-direct {v0, p0}, Lcom/android/phone/HfaLogic$1;-><init>(Lcom/android/phone/HfaLogic;)V
...
.method private onHfaError(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "onHfaError: call mCallBack.onError errorMsg="
    ...
    const-string/jumbo v1, "onHfaError: retry"
    ...
    const-string/jumbo v1, "onHfaError: Declare OTASP_FAILURE"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    iput v3, p0, Lcom/android/phone/HfaLogic;->mRetryCount:I
...
.method private onHfaSuccess()V
    ...
    const-string/jumbo v1, "onHfaSuccess: NOT bouncing radio call onTotalSuccess"
...
.method private onServiceStateChange(Landroid/telephony/ServiceState;)V
    ...
    const-string/jumbo v6, "Radio is on: "
    ...
    invoke-virtual {v0, v4}, Lcom/android/internal/telephony/Phone;->setRadioPower(Z)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/internal/telephony/Phone;->unregisterForServiceStateChanged(Landroid/os/Handler;)V
...
.method private onTotalSuccess()V
    ...
    const-string/jumbo v1, "onTotalSuccess: call mCallBack.onSuccess"
...
.method private sendFinalResponse(ILjava/lang/String;)V
    ...
    const-string/jumbo v2, "otasp_error_code"
    ...
    const-string/jumbo v4, "Sending OTASP confirmation with result code: "
    ...
    const-string/jumbo v3, "Pending Intent canceled"
...
.method private sendHfaCommand(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "sendHfaCommand: command="
...
.method private startHfaIntentReceiver()V
    ...
    new-instance v1, Lcom/android/phone/HfaLogic$2;

    invoke-direct {v1, p0}, Lcom/android/phone/HfaLogic$2;-><init>(Lcom/android/phone/HfaLogic;)V
...
.method private startProvisioning()V
    ...
    const-string/jumbo v1, "startProvisioning:"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    const-string/jumbo v0, "com.android.action.START_HFA"
...
.method private stopHfaIntentReceiver()V
    ...
    iput-object v2, p0, Lcom/android/phone/HfaLogic;->mReceiver:Landroid/content/BroadcastReceiver;
