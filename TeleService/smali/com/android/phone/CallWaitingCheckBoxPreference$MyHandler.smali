...
.method synthetic constructor <init>(Lcom/android/phone/CallWaitingCheckBoxPreference;Lcom/android/phone/CallWaitingCheckBoxPreference$MyHandler;)V
    .locals 0
...
.method private checkDSAforCW()V
    ...
    invoke-static {v2}, Lcom/android/phone/CallWaitingCheckBoxPreference;->-get0(Lcom/android/phone/CallWaitingCheckBoxPreference;)Landroid/content/Context;
    ...
    invoke-static {v2}, Lcom/android/phone/CallWaitingCheckBoxPreference;->-get2(Lcom/android/phone/CallWaitingCheckBoxPreference;)I
...
.method private handleGetCallWaitingResponse(Landroid/os/Message;)V
    ...
    invoke-static {v6}, Lcom/android/phone/CallWaitingCheckBoxPreference;->-get3(Lcom/android/phone/CallWaitingCheckBoxPreference;)Lcom/android/phone/TimeConsumingPreferenceListener;
    ...
    invoke-interface {v6, v7, v5}, Lcom/android/phone/TimeConsumingPreferenceListener;->onFinished(Landroid/preference/Preference;Z)V
    ...
    const-string/jumbo v6, "CallWaitingCheckBoxPreference"
    ...
    invoke-static {v4}, Lcom/android/phone/CallWaitingCheckBoxPreference;->-get3(Lcom/android/phone/CallWaitingCheckBoxPreference;)Lcom/android/phone/TimeConsumingPreferenceListener;
    ...
    invoke-interface {v6, v7, v4}, Lcom/android/phone/TimeConsumingPreferenceListener;->onException(Landroid/preference/Preference;Lcom/android/internal/telephony/CommandException;)V

    :cond_1
    iget-object v4, p0, Lcom/android/phone/CallWaitingCheckBoxPreference$MyHandler;->this$0:Lcom/android/phone/CallWaitingCheckBoxPreference;

    invoke-virtual {v4, v5}, Lcom/android/phone/CallWaitingCheckBoxPreference;->setEnabled(Z)V
    ...
    invoke-interface {v6, v7, v4}, Lcom/android/phone/TimeConsumingPreferenceListener;->onFinished(Landroid/preference/Preference;Z)V
    ...
    invoke-interface {v4, v6, v7}, Lcom/android/phone/TimeConsumingPreferenceListener;->onError(Landroid/preference/Preference;I)V
    ...
    :goto_2
    invoke-virtual {v7, v6}, Lcom/android/phone/CallWaitingCheckBoxPreference;->setChecked(Z)V
    ...
    const-string/jumbo v6, "volte_call_waiting"
    ...
    const-string/jumbo v4, "CallWaitingCheckBoxPreference"
...
.method private handleSetCallWaitingResponse(Landroid/os/Message;)V
    ...
    invoke-static {v1}, Lcom/android/phone/CallWaitingCheckBoxPreference;->-get1(Lcom/android/phone/CallWaitingCheckBoxPreference;)Lcom/android/internal/telephony/Phone;
