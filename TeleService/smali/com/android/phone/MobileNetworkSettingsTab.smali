...
.method private getSimName(I)Ljava/lang/String;
    ...
    iget v1, p0, Lcom/android/phone/MobileNetworkSettingsTab;->mLayoutDirection:I
...
.method private setupTab(I)V
    ...
    const-string/jumbo v2, "MobileNetworkSettingsTab"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v4, "setupTab : "
    ...
    const-string/jumbo v4, "tab_slot1"

    invoke-virtual {v3, v4}, Landroid/widget/TabHost;->newTabSpec(Ljava/lang/String;)Landroid/widget/TabHost$TabSpec;

    move-result-object v3

    invoke-direct {p0, p1}, Lcom/android/phone/MobileNetworkSettingsTab;->getSimName(I)Ljava/lang/String;
    ...
    const-string/jumbo v4, "tab_slot2"
    ...
    const-string/jumbo v4, "Wrong Tab index!! : "
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput v1, p0, Lcom/android/phone/MobileNetworkSettingsTab;->mLayoutDirection:I

    const-string/jumbo v1, "MobileNetworkSettingsTab"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v3, "mIsPreferredNetworks : "
    ...
    const-string/jumbo v3, "mIsNetworkSetting : "
...
.method public onTabChanged(Ljava/lang/String;)V
    ...
    const-string/jumbo v0, "MobileNetworkSettingsTab"

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v2, "onTabChanged() : mActiveSimId["
    ...
    :cond_0
    const-string/jumbo v0, "tab_slot1"
