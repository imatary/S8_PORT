...
# static fields
.field private static sAnswersMemoProjectionMap:Ljava/util/concurrent/ConcurrentHashMap;
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v1, "com.android.phone.answermemo"

    const-string/jumbo v2, "answer_memos"
    ...
    sput-object v0, Lcom/android/phone/AnswerMemoProvider;->sAnswersMemoProjectionMap:Ljava/util/concurrent/ConcurrentHashMap;

    sget-object v0, Lcom/android/phone/AnswerMemoProvider;->sAnswersMemoProjectionMap:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    const-string/jumbo v2, "memo_contact_name"

    invoke-virtual {v0, v1, v2}, Ljava/util/concurrent/ConcurrentHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, Lcom/android/phone/AnswerMemoProvider;->sAnswersMemoProjectionMap:Ljava/util/concurrent/ConcurrentHashMap;

    const-string/jumbo v1, "memo_display_name"
    ...
    const-string/jumbo v1, "memo_create_time"

    const-string/jumbo v2, "memo_create_time"

    invoke-virtual {v0, v1, v2}, Ljava/util/concurrent/ConcurrentHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, Lcom/android/phone/AnswerMemoProvider;->sAnswersMemoProjectionMap:Ljava/util/concurrent/ConcurrentHashMap;

    const-string/jumbo v1, "memo_duration"

    const-string/jumbo v2, "memo_duration"

    invoke-virtual {v0, v1, v2}, Ljava/util/concurrent/ConcurrentHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, Lcom/android/phone/AnswerMemoProvider;->sAnswersMemoProjectionMap:Ljava/util/concurrent/ConcurrentHashMap;

    const-string/jumbo v1, "memo_heard"
    ...
    const-string/jumbo v1, "memo_priority"

    const-string/jumbo v2, "memo_priority"
    ...
    const-string/jumbo v1, "memo_mime_type"
    ...
    const-string/jumbo v1, "memo_size"

    const-string/jumbo v2, "memo_size"

    invoke-virtual {v0, v1, v2}, Ljava/util/concurrent/ConcurrentHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, Lcom/android/phone/AnswerMemoProvider;->sAnswersMemoProjectionMap:Ljava/util/concurrent/ConcurrentHashMap;

    const-string/jumbo v1, "memo_expiry"

    const-string/jumbo v2, "memo_expiry"

    invoke-virtual {v0, v1, v2}, Ljava/util/concurrent/ConcurrentHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, Lcom/android/phone/AnswerMemoProvider;->sAnswersMemoProjectionMap:Ljava/util/concurrent/ConcurrentHashMap;

    const-string/jumbo v1, "memo_deleted"

    const-string/jumbo v2, "memo_deleted"
...
.method public delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    :pswitch_0
    const-string/jumbo v3, "answer_memo"
...
.method public getType(Landroid/net/Uri;)Ljava/lang/String;
    ...
    :pswitch_0
    const-string/jumbo v0, "vnd.android.cursor.dir/vnd.google.answer_memo"

    return-object v0

    :pswitch_1
    const-string/jumbo v0, "vnd.android.cursor.item/vnd.google.answer_memo"
...
.method public insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    const-string/jumbo v6, "memo_create_time"
    ...
    const-string/jumbo v6, "answer_memo"
    ...
    const-string/jumbo v8, "Failed to insert row into "
...
.method public onCreate()Z
    ...
    const-string/jumbo v0, "AnswerMemoProvider"
...
.method public query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    const-string/jumbo v2, "answer_memo"
    ...
    :pswitch_0
    sget-object v2, Lcom/android/phone/AnswerMemoProvider;->sAnswersMemoProjectionMap:Ljava/util/concurrent/ConcurrentHashMap;
