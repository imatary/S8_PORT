...
# direct methods
.method static synthetic -get0(Lcom/android/phone/OtaUtils;)Landroid/content/Context;
    .locals 1
...
.method static synthetic -wrap1(Lcom/android/phone/OtaUtils;)V
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    const-string/jumbo v0, "OtaUtils constructor..."
...
.method public static checkForOtaspCall(Lcom/android/internal/telephony/Phone;Landroid/net/Uri;)Z
    .locals 4

    invoke-static {p0, p1}, Lcom/android/phone/OtaUtils;->isOtaspCallUri(Lcom/android/internal/telephony/Phone;Landroid/net/Uri;)Z

    move-result v0

    if-eqz v0, :cond_0

    const-string/jumbo v1, "OtaUtils"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v3, "checkForOtaspCall: handling OTASP uri! "
    ...
    invoke-static {p1}, Lcom/android/phone/OtaUtils;->setupOtaspCall(Landroid/net/Uri;)V

    :goto_0
    return v0

    :cond_0
    const-string/jumbo v1, "checkForOtaspCall: not an OTASP call."
...
.method private getOtaSpcDisplayTime()I
    ...
    const-string/jumbo v5, "getOtaSpcDisplayTime()..."
    ...
    const-string/jumbo v6, "getOtaSpcDisplayTime(), time for SPC error notice: "
...
.method private initOtaInCallScreen()V
    ...
    const-string/jumbo v0, "initOtaInCallScreen()..."

    invoke-static {v0}, Lcom/android/phone/OtaUtils;->log(Ljava/lang/String;)V

    iget-object v1, p0, Lcom/android/phone/OtaUtils;->mOtaWidgetData:Lcom/android/phone/OtaUtils$OtaWidgetData;

    iget-object v0, p0, Lcom/android/phone/OtaUtils;->mInCallScreen:Lcom/android/phone/ota/OtaInCallScreen;
    ...
    iget-object v1, p0, Lcom/android/phone/OtaUtils;->mInCallScreen:Lcom/android/phone/ota/OtaInCallScreen;
    ...
    const-string/jumbo v4, "ota_next"
    ...
    const-string/jumbo v1, "initOtaInCallScreen: couldn\'t find otaDtmfDialerView"
...
.method public static isOtaspCallIntent(Landroid/content/Intent;)Z
    ...
    const-string/jumbo v6, "isOtaspCallIntent("
    ...
    iget-object v5, v1, Lcom/android/phone/PhoneGlobals;->mCM:Lcom/android/internal/telephony/CallManager;
    ...
    const-string/jumbo v6, "isOtaspCallIntent: not a CALL action: \'"
    ...
    const-string/jumbo v6, "\' ==> not OTASP"
    ...
    :cond_3
    iget-object v5, v1, Lcom/android/phone/PhoneGlobals;->cdmaOtaScreenState:Lcom/android/phone/OtaUtils$CdmaOtaScreenState;

    if-eqz v5, :cond_4

    iget-object v5, v1, Lcom/android/phone/PhoneGlobals;->cdmaOtaProvisionData:Lcom/android/phone/OtaUtils$CdmaOtaProvisionData;
    ...
    const-string/jumbo v6, "isOtaspCallIntent: app.cdmaOta* objects(s) not initialized"
    ...
    invoke-virtual {v4, v3}, Lcom/android/internal/telephony/Phone;->isOtaSpNumber(Ljava/lang/String;)Z
    ...
    const-string/jumbo v6, "isOtaSpNumber: ACTION_CALL to \'"
    ...
    const-string/jumbo v6, "\' ==> OTASP call!"
    ...
    const-string/jumbo v5, "isOtaspCallIntent: VoiceMailNumberMissingException => not OTASP"
...
.method private static isOtaspCallUri(Lcom/android/internal/telephony/Phone;Landroid/net/Uri;)Z
    .locals 5

    const/4 v4, 0x0

    const-string/jumbo v3, "isOtaspCallUri()..."
    ...
    :cond_0
    invoke-static {p0}, Lcom/android/internal/telephony/TelephonyCapabilities;->supportsOtasp(Lcom/android/internal/telephony/Phone;)Z
    ...
    :cond_2
    iget-object v3, v0, Lcom/android/phone/PhoneGlobals;->cdmaOtaScreenState:Lcom/android/phone/OtaUtils$CdmaOtaScreenState;

    if-eqz v3, :cond_3

    iget-object v3, v0, Lcom/android/phone/PhoneGlobals;->cdmaOtaProvisionData:Lcom/android/phone/OtaUtils$CdmaOtaProvisionData;
    ...
    const-string/jumbo v4, "isOtaspCallUri: app.cdmaOta* objects(s) not initialized"
    ...
    :cond_5
    const-string/jumbo v3, "isOtaspCallUri: VoiceMailNumberMissingException => not OTASP"
    ...
    :cond_6
    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/Phone;->isOtaSpNumber(Ljava/lang/String;)Z
    ...
    const-string/jumbo v4, "isOtaSpNumber: ACTION_CALL to \'"
    ...
    const-string/jumbo v4, "\' ==> OTASP call!"
...
.method private static log(Ljava/lang/String;)V
    ...
    const-string/jumbo v0, "OtaUtils"
...
.method public static maybeDoOtaCall(Landroid/content/Context;Landroid/os/Handler;I)Z
    ...
    const-string/jumbo v6, "OtaUtils"

    const-string/jumbo v7, "Don\'t run provisioning when in test harness"
    ...
    const-string/jumbo v6, "maybeDoOtaCall: OTASP not supported on this device"
    ...
    :cond_1
    invoke-virtual {v4}, Lcom/android/internal/telephony/Phone;->isMinInfoReady()Z

    move-result v6

    if-nez v6, :cond_2

    const-string/jumbo v6, "MIN is not ready. Registering to receive notification."

    invoke-static {v6}, Lcom/android/phone/OtaUtils;->log(Ljava/lang/String;)V

    const/4 v6, 0x0

    invoke-virtual {v4, p1, p2, v6}, Lcom/android/internal/telephony/Phone;->registerForSubscriptionInfoReady(Landroid/os/Handler;ILjava/lang/Object;)V

    return v8

    :cond_2
    invoke-virtual {v4, p1}, Lcom/android/internal/telephony/Phone;->unregisterForSubscriptionInfoReady(Landroid/os/Handler;)V
    ...
    const-string/jumbo v6, "maybeDoOtaCall: LTE state still unknown: retrying"
    ...
    const-string/jumbo v7, "maybeDoOtaCall: LTE state still unknown: giving up"
    ...
    :cond_4
    invoke-virtual {v4}, Lcom/android/internal/telephony/Phone;->needsOtaServiceProvisioning()Z
    ...
    const-string/jumbo v7, "phoneNeedsActivation is set to "
    ...
    const-string/jumbo v6, "not_ota_ui_display"
    ...
    const-string/jumbo v7, "otaShowActivationScreen: "
    ...
    iget-object v6, v0, Lcom/android/phone/PhoneGlobals;->cdmaOtaProvisionData:Lcom/android/phone/OtaUtils$CdmaOtaProvisionData;

    iput-boolean v8, v6, Lcom/android/phone/OtaUtils$CdmaOtaProvisionData;->isOtaCallIntentProcessed:Z

    sput-boolean v8, Lcom/android/phone/OtaUtils;->sIsWizardMode:Z

    const-string/jumbo v6, "OtaUtils"

    const-string/jumbo v7, "==> Starting interactive CDMA provisioning..."

    invoke-static {v6, v7}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-static {p0}, Lcom/android/phone/OtaUtils;->startInteractiveOtasp(Landroid/content/Context;)V

    const-string/jumbo v6, "maybeDoOtaCall: voice capable; activation started."
    ...
    :cond_6
    const-string/jumbo v6, "maybeDoOtaCall: voice capable; activation NOT started."
    ...
    const-string/jumbo v6, "com.android.phone.PERFORM_VOICELESS_CDMA_PROVISIONING"
    ...
    const-string/jumbo v6, "com.android.phone.VOICELESS_PROVISIONING_OFFER_DONTSHOW"

    invoke-virtual {v2, v6, v9}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string/jumbo v6, "show_ota_popup"
    ...
    const-string/jumbo v6, "shows alertdialog for USCC tablet"
    ...
    invoke-static {v6}, Lcom/android/phone/operator/usa/OtaUtilsAlertDialog;->show(Landroid/content/Context;)V
    ...
    const-string/jumbo v6, "maybeDoOtaCall: non-interactive; activation intent sent."
    ...
    const-string/jumbo v6, "No activity Handling PERFORM_VOICELESS_CDMA_PROVISIONING!"
    ...
    :cond_9
    const-string/jumbo v6, "maybeDoOtaCall: non-interactive, no need for OTASP."
...
.method private onClickOtaActivateButton()V
    ...
    const-string/jumbo v0, "Call Activation Clicked!"
...
.method private onClickOtaActivateNextButton()V
    ...
    const-string/jumbo v0, "Dialog Next Clicked!"
    ...
    const-string/jumbo v0, "reboot_after_ota_success"
...
.method private onClickOtaActivateSkipButton()V
    ...
    const-string/jumbo v1, "Activation Skip Clicked!"
    ...
    iget-object v3, p0, Lcom/android/phone/OtaUtils;->mInCallScreen:Lcom/android/phone/ota/OtaInCallScreen;
    ...
    new-instance v3, Lcom/android/phone/OtaUtils$3;

    invoke-direct {v3, p0}, Lcom/android/phone/OtaUtils$3;-><init>(Lcom/android/phone/OtaUtils;)V
...
.method private onClickOtaEndButton()V
    ...
    const-string/jumbo v0, "Activation End Call Button Clicked!"
...
.method private onClickOtaSpeakerButton()V
    ...
    const-string/jumbo v1, "OTA Speaker button Clicked!"
...
.method private onClickOtaTryAgainButton()V
    ...
    const-string/jumbo v0, "Activation Try Again Clicked!"
...
.method private otaScreenInitialize()V
    ...
    const-string/jumbo v0, "otaScreenInitialize()..."
    ...
    const-string/jumbo v1, "otaScreenInitialize: not interactive!"
    ...
    const-string/jumbo v0, "mOtaWidgetData is null"

    invoke-static {v0}, Lcom/android/phone/OtaUtils;->log(Ljava/lang/String;)V

    new-instance v0, Lcom/android/phone/OtaUtils$OtaWidgetData;

    invoke-direct {v0, p0, v1}, Lcom/android/phone/OtaUtils$OtaWidgetData;-><init>(Lcom/android/phone/OtaUtils;Lcom/android/phone/OtaUtils$OtaWidgetData;)V
...
.method private otaShowHome()V
    ...
    const-string/jumbo v1, "otaShowHome()..."
...
.method private otaShowInProgressScreen()V
    ...
    const-string/jumbo v1, "otaShowInProgressScreen()..."
    ...
    const-string/jumbo v2, "otaShowInProgressScreen: not interactive!"
    ...
    const-string/jumbo v2, "otaShowInProgressScreen: UI widgets not set up yet!"
...
.method private otaShowListeningScreen()V
    ...
    const-string/jumbo v1, "otaShowListeningScreen()..."
    ...
    const-string/jumbo v2, "otaShowListeningScreen: not interactive!"
    ...
    const-string/jumbo v1, "otaShowListeningScreen(): show listening screen"
    ...
    :cond_2
    const-string/jumbo v1, "otaShowListeningScreen(): show progress screen"
...
.method private otaShowProgramFailure(I)V
    ...
    const-string/jumbo v0, "otaShowProgramFailure()..."
    ...
    const-string/jumbo v1, "otaShowProgramFailure(): activationCount"
    ...
    const-string/jumbo v0, "otaShowProgramFailure(): show failure notice"
    ...
    :cond_0
    const-string/jumbo v0, "otaShowProgramFailure(): show failure dialog"
...
.method private otaShowProgramFailureDialog()V
    ...
    const-string/jumbo v0, "otaShowProgramFailureDialog()..."
...
.method private otaShowProgramFailureNotice(I)V
    ...
    const-string/jumbo v2, "otaShowProgramFailureNotice()..."
    ...
    iget-object v4, p0, Lcom/android/phone/OtaUtils;->mInCallScreen:Lcom/android/phone/ota/OtaInCallScreen;
    ...
    iget-object v2, p0, Lcom/android/phone/OtaUtils;->mInCallScreen:Lcom/android/phone/ota/OtaInCallScreen;
...
.method private otaShowProgramSuccessDialog()V
    ...
    const-string/jumbo v0, "otaShowProgramSuccessDialog()..."
...
.method private otaShowSpcErrorNotice(I)V
    ...
    const-string/jumbo v1, "otaShowSpcErrorNotice()..."
    ...
    iget-object v5, p0, Lcom/android/phone/OtaUtils;->mInCallScreen:Lcom/android/phone/ota/OtaInCallScreen;
    ...
    const-string/jumbo v4, "otaShowSpcErrorNotice(), remaining SPC noticeTime"
...
.method private otaSkipActivation()V
    ...
    const-string/jumbo v0, "otaSkipActivation()..."
...
.method private readXmlSettings()V
    ...
    const-string/jumbo v4, "readXmlSettings()..."
    ...
    const-string/jumbo v5, "readXmlSettings(), otaShowActivationScreen = "
    ...
    const-string/jumbo v5, "readXmlSettings(), otaShowListeningScreen = "
    ...
    const-string/jumbo v5, "readXmlSettings(), otaShowActivateFailTimes = "
    ...
    const-string/jumbo v5, "readXmlSettings(), otaPlaySuccessFailureTone = "
...
.method private sendOtaspResult(I)V
    ...
    const-string/jumbo v3, "sendOtaspResult: resultCode = "
    ...
    const-string/jumbo v2, "otasp_result_code"
    ...
    const-string/jumbo v2, "OtaUtils"

    const-string/jumbo v3, "updateNonInteractiveOtaSuccessFailure: no cdmaOtaScreenState object!"
    ...
    const-string/jumbo v3, "updateNonInteractiveOtaSuccessFailure: null otaspResultCodePendingIntent!"
    ...
    const-string/jumbo v3, "- sendOtaspResult:  SENDING PENDING INTENT: "
    ...
    const-string/jumbo v4, "PendingIntent send() failed: "
...
.method private setSpeaker(Z)V
    ...
    const-string/jumbo v1, "setSpeaker : "
    ...
    const-string/jumbo v0, "non-interactive mode, ignoring setSpeaker."
    ...
    const-string/jumbo v0, "no change. returning"
...
.method public static setupOtaspCall(Landroid/content/Intent;)V
    ...
    const-string/jumbo v2, "setupOtaspCall(): preparing for OTASP call to "
    ...
    const-string/jumbo v2, "setupOtaspCall: OtaUtils already exists; replacing with new instance..."
    ...
    const-string/jumbo v2, "- created OtaUtils: "
...
.method private static setupOtaspCall(Landroid/net/Uri;)V
    .locals 5
    ...
    const-string/jumbo v3, "setupOtaspCall(): preparing for OTASP call to "
    ...
    const-string/jumbo v3, "com.android.phone.DISPLAY_ACTIVATION_SCREEN"
    ...
    const-string/jumbo v4, "setupOtaspCall: launching InCallScreen in \'activate\' state: "
    ...
    const-string/jumbo v3, "setupOtaspCall: OtaUtils already exists; replacing with new instance..."
    ...
    invoke-direct {v2, v3, v4}, Lcom/android/phone/OtaUtils;-><init>(Landroid/content/Context;Z)V
    ...
    const-string/jumbo v3, "- created OtaUtils: "
    ...
    const-string/jumbo v3, "- inCallUiState.inCallScreenMode = "
    ...
    const-string/jumbo v2, "==>  OTA_NORMAL note: switching to OTA_STATUS_LISTENING."
...
.method public static startInteractiveOtasp(Landroid/content/Context;)V
    ...
    const-string/jumbo v2, "startInteractiveOtasp()..."
    ...
    const-string/jumbo v2, "feature_vzw"
    ...
    const-string/jumbo v4, "startInteractiveOtasp: launching InCallScreen in \'activate\' state: "
...
.method public static startNonInteractiveOtasp(Landroid/content/Context;)I
    ...
    const-string/jumbo v4, "startNonInteractiveOtasp()..."
    ...
    const-string/jumbo v4, "OtaUtils"

    const-string/jumbo v5, "startNonInteractiveOtasp: OtaUtils already exists; nuking the old one and starting again..."
    ...
    invoke-direct {v4, p0, v7}, Lcom/android/phone/OtaUtils;-><init>(Landroid/content/Context;Z)V
    ...
    const-string/jumbo v5, "- created OtaUtils: "
    ...
    const-string/jumbo v6, "startNonInteractiveOtasp: placing call to \'"
    ...
    invoke-static {p0, v3, v2, v8, v7}, Lcom/android/phone/PhoneUtils;->placeCall(Landroid/content/Context;Lcom/android/internal/telephony/Phone;Ljava/lang/String;Landroid/net/Uri;Z)I
    ...
    const-string/jumbo v5, "  ==> successful return from placeCall(): callStatus = "
    ...
    const-string/jumbo v6, "Failure from placeCall() for OTA number \'"
...
.method private updateNonInteractiveOtaSuccessFailure()V
    ...
    const-string/jumbo v2, "updateNonInteractiveOtaSuccessFailure(): isOtaCallCommitted = "
...
.method private updateOtaspProgress()V
    ...
    const-string/jumbo v1, "updateOtaspProgress()...  mInteractive = "
...
.method public cleanOtaScreen(Z)V
    ...
    const-string/jumbo v0, "OTA ends, cleanOtaScreen!"
...
.method public clearUiWidgets()V
    ...
    iput-object v0, p0, Lcom/android/phone/OtaUtils;->mInCallScreen:Lcom/android/phone/ota/OtaInCallScreen;
...
.method public dismissAllOtaDialogs()V
    ...
    const-string/jumbo v0, "- DISMISSING mSpcErrorDialog."
    ...
    const-string/jumbo v0, "- DISMISSING mOtaFailureDialog."
...
.method public getCdmaOtaInCallScreenUiState()Lcom/android/phone/OtaUtils$CdmaOtaInCallScreenUiState$State;
    ...
    const-string/jumbo v1, "getCdmaOtaInCallScreenState: "
...
.method public isDialerOpened()Z
    ...
    const-string/jumbo v2, "- isDialerOpened() ==> "
...
.method public onClickHandler(I)V
    ...
    :pswitch_0
    const-string/jumbo v0, "onClickHandler: received a click event for unrecognized id"
...
.method public onOtaCloseFailureNotice()V
    ...
    const-string/jumbo v0, "onOtaCloseFailureNotice()..."
...
.method public onOtaCloseSpcNotice()V
    ...
    const-string/jumbo v2, "onOtaCloseSpcNotice(), send shutdown intent"
...
.method public onOtaProvisionStatusChanged(Landroid/os/AsyncResult;)V
    ...
    const-string/jumbo v1, "Provision status event!"
    ...
    const-string/jumbo v2, "onOtaProvisionStatusChanged(): status = "
    ...
    const-string/jumbo v2, "onOtaProvisionStatusChanged(): Ignoring OtaStatus "
    ...
    :pswitch_0
    const-string/jumbo v1, "onOtaProvisionStatusChanged(): RETRIES EXCEEDED"
    ...
    :pswitch_1
    const-string/jumbo v1, "onOtaProvisionStatusChanged(): DONE, isOtaCallCommitted set to true"
    ...
    const-string/jumbo v1, "onOtaProvisionStatusChanged(): change to ProgressScreen"
...
.method public onOtaspDisconnect()V
    ...
    const-string/jumbo v0, "onOtaspDisconnect()..."
...
.method public otaPlaceCall(Z)V
    ...
    const-string/jumbo v1, "otaPlaceCall()..."
    ...
    const-string/jumbo v2, "otaPlaceCall: not interactive!"
...
.method public otaShowActivateScreen()V
    ...
    const-string/jumbo v0, "otaShowActivateScreen()..."
    ...
    const-string/jumbo v0, "otaShowActivateScreen(): show activation screen"
    ...
    :cond_2
    const-string/jumbo v0, "otaShowActivateScreen(): show home screen"
...
.method public otaShowProperScreen()V
    ...
    const-string/jumbo v0, "otaShowProperScreen()..."
    ...
    const-string/jumbo v1, "otaShowProperScreen: not interactive!"
    ...
    const-string/jumbo v1, "otaShowProperScreen(): InCallScreen in foreground, currentstate = "
...
.method public otaShowSuccessFailure()V
    ...
    const-string/jumbo v0, "otaShowSuccessFailure()..."
    ...
    const-string/jumbo v1, "otaShowSuccessFailure: not interactive!"
    ...
    const-string/jumbo v1, "otaShowSuccessFailure(): isOtaCallCommitted"
    ...
    const-string/jumbo v0, "otaShowSuccessFailure(), show success dialog"
    ...
    :cond_1
    const-string/jumbo v0, "otaShowSuccessFailure(), show failure dialog"
...
.method public setCdmaOtaInCallScreenUiState(Lcom/android/phone/OtaUtils$CdmaOtaInCallScreenUiState$State;)V
    ...
    const-string/jumbo v1, "setCdmaOtaInCallScreenState: "
...
.method public updateUiWidgets(Lcom/android/phone/ota/OtaInCallScreen;)V
    ...
    const-string/jumbo v2, "updateUiWidgets()...  mInCallScreen = "
    ...
    const-string/jumbo v2, "updateUiWidgets() called in non-interactive mode"
    ...
    const-string/jumbo v1, "updateUiWidgets(): widgets already set up, nothing to do..."
    ...
    :cond_1
    iput-object p1, p0, Lcom/android/phone/OtaUtils;->mInCallScreen:Lcom/android/phone/ota/OtaInCallScreen;

    new-instance v1, Lcom/android/phone/OtaUtils$OtaWidgetData;

    invoke-direct {v1, p0, v3}, Lcom/android/phone/OtaUtils$OtaWidgetData;-><init>(Lcom/android/phone/OtaUtils;Lcom/android/phone/OtaUtils$OtaWidgetData;)V
