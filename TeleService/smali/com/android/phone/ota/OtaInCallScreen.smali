...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/phone/ota/OtaInCallScreen$1;
    }
.end annotation


# static fields
.field private static final synthetic -com-android-phone-ota-InCallUiState$InCallScreenModeSwitchesValues:[I
...
# direct methods
.method static synthetic -get0(Lcom/android/phone/ota/OtaInCallScreen;)Lcom/android/phone/PhoneGlobals;
    .locals 1
...
.method private static synthetic -getcom-android-phone-ota-InCallUiState$InCallScreenModeSwitchesValues()[I
    .locals 3

    sget-object v0, Lcom/android/phone/ota/OtaInCallScreen;->-com-android-phone-ota-InCallUiState$InCallScreenModeSwitchesValues:[I
    ...
    :goto_5
    sput-object v0, Lcom/android/phone/ota/OtaInCallScreen;->-com-android-phone-ota-InCallUiState$InCallScreenModeSwitchesValues:[I
...
.method static synthetic -wrap0(Lcom/android/phone/ota/OtaInCallScreen;Ljava/lang/String;)V
    .locals 0
...
.method static synthetic -wrap1(Lcom/android/phone/ota/OtaInCallScreen;Landroid/os/AsyncResult;)V
    .locals 0
...
.method static synthetic -wrap2(Lcom/android/phone/ota/OtaInCallScreen;)V
    .locals 0
...
.method static synthetic -wrap3(Lcom/android/phone/ota/OtaInCallScreen;)V
    .locals 0
...
.method private checkOtaspStateOnResume()Z
    ...
    const-string/jumbo v3, "checkOtaspStateOnResume: no OtaUtils instance; nothing to do."
    ...
    const-string/jumbo v3, "checkOtaspStateOnResume: app.cdmaOta* objects(s) not initialized"
    ...
    const-string/jumbo v2, "checkOtaspStateOnResume - in OTA Normal mode"
    ...
    const-string/jumbo v2, "checkOtaspStateOnResume - in OTA END mode"
    ...
    :cond_7
    const-string/jumbo v3, "checkOtaspStateOnResume - Set OTA NORMAL Mode"
...
.method private endInCallScreenSession(Z)V
    ...
    const-string/jumbo v1, "endInCallScreenSession("
    ...
    const-string/jumbo v0, "OtaInCallScreen"

    const-string/jumbo v1, "endInCallScreenSession(): FORCING a call to super.finish()!"
...
.method private initInCallScreen()V
    ...
    const-string/jumbo v0, "initInCallScreen()..."
...
.method private internalResolveIntent(Landroid/content/Intent;)V
    ...
    const-string/jumbo v2, "internalResolveIntent: action="
    ...
    const-string/jumbo v1, "com.android.phone.DISPLAY_ACTIVATION_SCREEN"
    ...
    const-string/jumbo v3, "Received ACTION_DISPLAY_ACTIVATION_SCREEN intent on non-OTASP-capable device: "
    ...
    :cond_5
    const-string/jumbo v1, "com.android.phone.PERFORM_CDMA_PROVISIONING"
    ...
    const-string/jumbo v3, "Unexpected ACTION_PERFORM_CDMA_PROVISIONING received by InCallScreen: "
    ...
    :cond_6
    const-string/jumbo v1, "OtaInCallScreen"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v3, "internalResolveIntent: unexpected intent action: "
...
.method private onDisconnect(Landroid/os/AsyncResult;)V
    ...
    :cond_1
    const-string/jumbo v3, "onDisconnect: OTA Call end already handled"
    ...
    invoke-virtual {v3, v2}, Lcom/android/internal/telephony/Phone;->isOtaSpNumber(Ljava/lang/String;)Z

    move-result v3

    if-eqz v3, :cond_4

    const-string/jumbo v3, "onDisconnect: this was an OTASP call!"
...
.method private onPhoneStateChanged()V
    ...
    const-string/jumbo v2, "onPhoneStateChanged: current state = "
    ...
    const-string/jumbo v1, "onPhoneStateChanged: Activity not in foreground! Bailing out..."
...
.method private setInCallScreenMode(Lcom/android/phone/ota/InCallUiState$InCallScreenMode;)V
    ...
    const-string/jumbo v1, "setInCallScreenMode: "
    ...
    invoke-static {}, Lcom/android/phone/ota/OtaInCallScreen;->-getcom-android-phone-ota-InCallUiState$InCallScreenModeSwitchesValues()[I
    ...
    const-string/jumbo v1, "com.android.phone.InCallScreen.UNDEFINED"
    ...
    :cond_1
    const-string/jumbo v0, "WARNING: Setting mode to UNDEFINED but phone is OFFHOOK, skip cleanOtaScreen."
...
.method private updateScreen()V
    ...
    const-string/jumbo v3, "  - inCallScreenMode = "
    ...
    const-string/jumbo v2, "- updateScreen: not the foreground Activity! Bailing out..."
    ...
    const-string/jumbo v2, "- updateScreen: OTA call state NORMAL (NOT updating in-call UI)..."
    ...
    :cond_1
    const-string/jumbo v2, "OtaInCallScreen"

    const-string/jumbo v3, "OtaUtils object is null, not showing any screen for that."
    ...
    const-string/jumbo v2, "- updateScreen: OTA call ended state (NOT updating in-call UI)..."
    ...
    const-string/jumbo v2, "- updateScreen: OTA_STATUS_ACTIVATION"
    ...
    const-string/jumbo v2, "- updateScreen: mApp.otaUtils is not null, call otaShowActivationScreen"
    ...
    :cond_4
    const-string/jumbo v2, "- updateScreen: OTA Call end state for Dialogs"
    ...
    const-string/jumbo v2, "- updateScreen: Show OTA Success Failure dialog"
    ...
    const-string/jumbo v2, "- updateScreen: call ended state..."

    invoke-direct {p0, v2}, Lcom/android/phone/ota/OtaInCallScreen;->log(Ljava/lang/String;)V

    :cond_6
    const-string/jumbo v2, "- updateScreen: updating the in-call UI..."
...
.method public endInCallScreenSession()V
    ...
    const-string/jumbo v1, "endInCallScreenSession()... phone state = "
...
.method public handleOtaCallEnd()V
    ...
    const-string/jumbo v0, "handleOtaCallEnd entering"
    ...
    :cond_2
    const-string/jumbo v0, "handleOtaCallEnd - Set OTA Call End stater"
...
.method public okToDialDTMFTones()Z
    ...
    const-string/jumbo v4, "[okToDialDTMFTones] foreground state: "
    ...
    const-string/jumbo v4, ", ringing state: "
    ...
    const-string/jumbo v4, ", call screen mode: "
...
.method public onClick(Landroid/view/View;)V
    ...
    const-string/jumbo v3, "onClick: unexpected click from ID "
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    const-string/jumbo v0, "onCreate(): this is our very first launch, checking intent..."
    ...
    const-string/jumbo v0, "start_ota_screen_directly"
...
.method protected onStop()V
    ...
    const-string/jumbo v2, "onStop: state = "
    ...
    :cond_1
    const-string/jumbo v1, "- onStop: calling finish() to clear activity history..."
...
.method public requestCloseOtaFailureNotice(J)V
    ...
    const-string/jumbo v1, "requestCloseOtaFailureNotice() with timeout: "
...
.method public requestCloseSpcErrorNotice(J)V
    ...
    const-string/jumbo v1, "requestCloseSpcErrorNotice() with timeout: "
...
.method public requestUpdateScreen()V
    ...
    const-string/jumbo v0, "requestUpdateScreen()..."
