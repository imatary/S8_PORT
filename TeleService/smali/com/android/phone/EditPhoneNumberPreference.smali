...
.field private mCFNRyText:Landroid/widget/EditText;

.field private mCFNRytimeLayout:Landroid/widget/LinearLayout;
...
.field private mMeterialContactPickButton:Landroid/widget/ImageButton;
...
# direct methods
.method static synthetic -get0(Lcom/android/phone/EditPhoneNumberPreference;)Landroid/widget/EditText;
    .locals 1
...
.method static synthetic -get1(Lcom/android/phone/EditPhoneNumberPreference;)Landroid/view/inputmethod/InputMethodManager;
    .locals 1
...
.method static synthetic -get2(Lcom/android/phone/EditPhoneNumberPreference;)Z
    .locals 1
...
.method static synthetic -get3(Lcom/android/phone/EditPhoneNumberPreference;)Landroid/widget/EditText;
    .locals 1

    iget-object v0, p0, Lcom/android/phone/EditPhoneNumberPreference;->mCFNRyText:Landroid/widget/EditText;

    return-object v0
.end method

.method static synthetic -get4(Lcom/android/phone/EditPhoneNumberPreference;)Landroid/content/Intent;
    .locals 1
...
.method static synthetic -get5(Lcom/android/phone/EditPhoneNumberPreference;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lcom/android/phone/EditPhoneNumberPreference;->mContext:Landroid/content/Context;

    return-object v0
.end method

.method static synthetic -get6(Lcom/android/phone/EditPhoneNumberPreference;)Landroid/app/AlertDialog;
    .locals 1
...
.method static synthetic -get7(Lcom/android/phone/EditPhoneNumberPreference;)Landroid/app/Activity;
    .locals 1
...
.method static synthetic -get8(Lcom/android/phone/EditPhoneNumberPreference;)Landroid/app/Fragment;
    .locals 1
...
.method static synthetic -get9(Lcom/android/phone/EditPhoneNumberPreference;)I
    .locals 1
...
.method static synthetic -set0(Lcom/android/phone/EditPhoneNumberPreference;I)I
    .locals 0
...
.method static synthetic -wrap0(Lcom/android/phone/EditPhoneNumberPreference;Ljava/lang/String;)V
    .locals 0
...
.method public getRawTimeSeconds()I
    .locals 1
...
.method public isValidNumber(Ljava/lang/CharSequence;)Z
    .locals 2

    const-string/jumbo v1, "[0-9+ *#(/).,;N-]"
...
.method public makeInputFilter()V
    .locals 4
    ...
    new-instance v2, Lcom/android/phone/EditPhoneNumberPreference$7;

    const/16 v3, 0x64

    invoke-direct {v2, p0, v3}, Lcom/android/phone/EditPhoneNumberPreference$7;-><init>(Lcom/android/phone/EditPhoneNumberPreference;I)V
...
.method protected onBindDialogView(Landroid/view/View;)V
    ...
    iput-object v1, p0, Lcom/android/phone/EditPhoneNumberPreference;->mErrorText:Landroid/widget/TextView;
    ...
    const-string/jumbo v1, "support_callforward_cfnry_timer"
    ...
    iput-object v1, p0, Lcom/android/phone/EditPhoneNumberPreference;->mCFNRytimeLayout:Landroid/widget/LinearLayout;
    ...
    iput-object v1, p0, Lcom/android/phone/EditPhoneNumberPreference;->mCFNRyText:Landroid/widget/EditText;

    iget-object v1, p0, Lcom/android/phone/EditPhoneNumberPreference;->mCFNRyText:Landroid/widget/EditText;
    ...
    :cond_0
    iget-object v1, p0, Lcom/android/phone/EditPhoneNumberPreference;->mCFNRytimeLayout:Landroid/widget/LinearLayout;
    ...
    iput-object v1, p0, Lcom/android/phone/EditPhoneNumberPreference;->mMeterialContactPickButton:Landroid/widget/ImageButton;

    iget-object v1, p0, Lcom/android/phone/EditPhoneNumberPreference;->mMeterialContactPickButton:Landroid/widget/ImageButton;

    if-eqz v1, :cond_3

    iget-object v1, p0, Lcom/android/phone/EditPhoneNumberPreference;->mMeterialContactPickButton:Landroid/widget/ImageButton;

    invoke-virtual {v1, v6}, Landroid/widget/ImageButton;->semSetHoverPopupType(I)V
    ...
    const-string/jumbo v1, "default_vm_in_callforwarding"
    ...
    const-string/jumbo v3, "onBindDialogView mPhoneNumber is "
    ...
    const-string/jumbo v2, "starts with +81, replace to 0"
    ...
    invoke-virtual {p0}, Lcom/android/phone/EditPhoneNumberPreference;->makeInputFilter()V
    ...
    invoke-virtual {p0}, Lcom/android/phone/EditPhoneNumberPreference;->getDialogTitle()Ljava/lang/CharSequence;
...
.method protected onBindView(Landroid/view/View;)V
    ...
    :cond_0
    iget-object v3, p0, Lcom/android/phone/EditPhoneNumberPreference;->mContext:Landroid/content/Context;
...
.method protected onDialogClosed(Z)V
    ...
    :goto_0
    invoke-static {v2, v0}, Lcom/android/phone/utils/SALogging;->sendSAEventLog(Ljava/lang/String;Ljava/lang/String;)V

    iget v0, p0, Lcom/android/phone/EditPhoneNumberPreference;->mConfirmationMode:I

    if-ne v0, v1, :cond_0

    iget-boolean v0, p0, Lcom/android/phone/EditPhoneNumberPreference;->isPositiveButtonClicked:Z
    ...
    invoke-virtual {p0}, Lcom/android/phone/EditPhoneNumberPreference;->setCFNRytime()V
...
.method public setCFNRytime()V
    ...
    iput v0, p0, Lcom/android/phone/EditPhoneNumberPreference;->mTimeSeconds:I

    :goto_0
    const-string/jumbo v0, "EditPhoneNumberPreference"

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v2, "setCFNRytime. mTimeSeconds = "
    ...
    :cond_1
    iput v1, p0, Lcom/android/phone/EditPhoneNumberPreference;->mTimeSeconds:I
...
.method public setEditeBoxCFtimeKDDI(Landroid/view/View;I)V
    ...
    new-instance v5, Lcom/android/phone/EditPhoneNumberPreference$8;

    invoke-direct {v5, p0}, Lcom/android/phone/EditPhoneNumberPreference$8;-><init>(Lcom/android/phone/EditPhoneNumberPreference;)V
    ...
    const-string/jumbo v4, "EditPhoneNumberPreference"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v6, "setEditeBoxCFtimeKDDI() mCFtimeSpinner is set to "
...
.method protected setEnableCFPhoneNumber(ZZ)V
    ...
    iget-object v0, p0, Lcom/android/phone/EditPhoneNumberPreference;->mMeterialContactPickButton:Landroid/widget/ImageButton;
    ...
    const-string/jumbo v2, "setEnableCFPhoneNumber number is voicemail, oldNumber is "
    ...
    const-string/jumbo v1, "setEnableCFPhoneNumber getRawPhoneNumber is voicemail, oldNumber is null"
    ...
    const-string/jumbo v1, "setEnableCFPhoneNumber oldNumber is voicemail"
    ...
    :goto_2
    iput-object v2, p0, Lcom/android/phone/EditPhoneNumberPreference;->oldNumber:Ljava/lang/String;
...
.method public setTimeSeconds(I)Lcom/android/phone/EditPhoneNumberPreference;
    ...
    const-string/jumbo v2, "setTimeSeconds mPrefId : "
    ...
    const-string/jumbo v2, "setTimeSeconds() mCFtimeSpinner is set to "
    ...
    const-string/jumbo v2, "setTimeSeconds mCFtimeSpinner is null, mTimeSeconds is "
...
.method public setToggled(Z)Lcom/android/phone/EditPhoneNumberPreference;
    ...
    invoke-virtual {p0, v1}, Lcom/android/phone/EditPhoneNumberPreference;->setText(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/phone/EditPhoneNumberPreference;->showDialog(Landroid/os/Bundle;)V
...
.method protected showDialog(Landroid/os/Bundle;)V
    ...
    new-instance v2, Lcom/android/phone/EditPhoneNumberPreference$6;

    invoke-direct {v2, p0}, Lcom/android/phone/EditPhoneNumberPreference$6;-><init>(Lcom/android/phone/EditPhoneNumberPreference;)V
...
.method public showErrorText(Ljava/lang/String;Z)V
    .locals 3
    ...
    iget-object v0, p0, Lcom/android/phone/EditPhoneNumberPreference;->mErrorText:Landroid/widget/TextView;
