...
.method private handleGetPreferredNetworkTypeResponse(Landroid/os/Message;I)V
    ...
    iget-object v2, p0, Lcom/android/phone/EmergencyModeManager$2;->this$0:Lcom/android/phone/EmergencyModeManager;

    invoke-static {v2, v1, p2}, Lcom/android/phone/EmergencyModeManager;->-wrap0(Lcom/android/phone/EmergencyModeManager;II)V
...
.method private handleSetPreferredNetworkTypeResponse(Landroid/os/Message;I)V
    ...
    invoke-static {v1, v4}, Lcom/android/phone/EmergencyModeManager;->-wrap4(Lcom/android/phone/EmergencyModeManager;Z)V
    ...
    const-string/jumbo v3, "set default vale, mIsDisconnectingData = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/android/phone/EmergencyModeManager$2;->this$0:Lcom/android/phone/EmergencyModeManager;
    ...
    const-string/jumbo v3, "set preferred network type done - slotId:"
    ...
    invoke-static {v1, p2}, Lcom/android/phone/EmergencyModeManager;->-wrap5(Lcom/android/phone/EmergencyModeManager;I)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/phone/EmergencyModeManager$2;->handleGetPreferredNetworkTypeResponse(Landroid/os/Message;I)V

    goto :goto_0

    :cond_0
    invoke-direct {p0, p1, v2}, Lcom/android/phone/EmergencyModeManager$2;->handleGetPreferredNetworkTypeResponse(Landroid/os/Message;I)V
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/phone/EmergencyModeManager$2;->handleSetPreferredNetworkTypeResponse(Landroid/os/Message;I)V

    goto :goto_0

    :cond_1
    invoke-direct {p0, p1, v2}, Lcom/android/phone/EmergencyModeManager$2;->handleSetPreferredNetworkTypeResponse(Landroid/os/Message;I)V
