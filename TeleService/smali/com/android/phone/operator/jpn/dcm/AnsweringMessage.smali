...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/phone/operator/jpn/dcm/AnsweringMessage$1;,
        Lcom/android/phone/operator/jpn/dcm/AnsweringMessage$2;,
...
.method static synthetic -wrap0(Lcom/android/phone/operator/jpn/dcm/AnsweringMessage;Ljava/lang/String;)Ljava/lang/String;
    .locals 1
...
.method static synthetic -wrap1(Lcom/android/phone/operator/jpn/dcm/AnsweringMessage;)V
    .locals 0
...
.method private registerForAMSettingsChange()V
    ...
    new-instance v2, Lcom/android/phone/operator/jpn/dcm/AnsweringMessage$AMSettingsChangeObserver;

    new-instance v3, Landroid/os/Handler;

    invoke-direct {v3}, Landroid/os/Handler;-><init>()V

    invoke-direct {v2, p0, v3}, Lcom/android/phone/operator/jpn/dcm/AnsweringMessage$AMSettingsChangeObserver;-><init>(Lcom/android/phone/operator/jpn/dcm/AnsweringMessage;Landroid/os/Handler;)V
...
.method public cancelAnswerMsgNotification()V
    ...
    const-string/jumbo v2, "cancelAnswerMsgNotification"
...
.method public checkAvailableStorage()Z
    .locals 4

    invoke-virtual {p0}, Lcom/android/phone/operator/jpn/dcm/AnsweringMessage;->getAvailableStorage()J
...
.method public checkPhoneVibrateOrSilentMode()Z
    ...
    const-string/jumbo v4, "checkPhoneVibrateOrSilentMode "
    ...
    const-string/jumbo v5, "checkPhoneVibrateOrSilentMode "
...
.method public displayAnswerMessageToast(I)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lcom/android/phone/PhoneGlobals;->getString(I)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/android/phone/operator/jpn/dcm/AnsweringMessage;->displayAnswerMessageToast(Ljava/lang/String;)V
...
.method public getAvailableStorage()J
    ...
    const-string/jumbo v3, "Available Storage = "
...
.method public isCallInAnsweringMessage()Z
    ...
    const-string/jumbo v0, "isAutoAnswered"

    const/4 v1, 0x0

    sget-object v4, Lcom/android/phone/operator/jpn/dcm/AnsweringMessage;->mContext:Landroid/content/Context;
    ...
    const-string/jumbo v5, "isCallInAnsweringMessage() isAutoAnswered = "
...
.method notifyAnswerMemo()V
    ...
    const-string/jumbo v2, "notifyAnswerMemo()"
    ...
    const-string/jumbo v4, "memo_heard = 0"
    ...
    const-string/jumbo v1, "com.samsung.phone.Answermemo.SHOW_MEMO_LIST"
    ...
    :try_start_1
    const-string/jumbo v1, "memo_contact_name"
...
.method public onGoingAnswerMemo(Z)V
    ...
    const-string/jumbo v1, "onGoingAnswerMemo "
...
.method onGoingAnswerMemoNotification(Z)V
    ...
    const-string/jumbo v9, "onGoingAnswerMemoNotification "
    ...
    const-string/jumbo v7, "com.samsung.phone.Answermemo.SHOW_ANSWERING_MEMO_SETTINGS"
...
.method public updateAMNotificationAtStartUp()V
    ...
    :cond_5
    invoke-virtual {p0, v5}, Lcom/android/phone/operator/jpn/dcm/AnsweringMessage;->onGoingAnswerMemoNotification(Z)V
