...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    const-string/jumbo v0, "ipcall_sim2.db"
...
.method public onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string/jumbo v1, "CREATE TABLE ip_call_sim2 (_id INTEGER PRIMARY KEY AUTOINCREMENT, ipcall_number TEXT NOT NULL,edit_checked INTEGER NOT NULL);"

    invoke-virtual {p1, v1}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v1, "IpCallDBSim2"

    const-string/jumbo v2, "CREATE TABLE ip_call_sim2 (_id INTEGER PRIMARY KEY AUTOINCREMENT, ipcall_number TEXT NOT NULL,edit_checked INTEGER NOT NULL);"
    ...
    const-string/jumbo v2, "INSERT INTO ip_call_sim2 (\'IPCALL_NUMBER\', \'EDIT_CHECKED\') values (\'"
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    const-string/jumbo v0, "IpCallDBSim2"

    const-string/jumbo v1, "onUpgrade"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    const-string/jumbo v0, "DROP TABLE IF EXISTS ip_call_sim2"
