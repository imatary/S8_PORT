.class public Lcom/android/services/utils/SecCapabilitiesBuilderVoice;
.super Ljava/lang/Object;
.source "SecCapabilitiesBuilderVoice.java"
...
.method public constructor <init>(ILcom/android/internal/telephony/Phone;Lcom/android/internal/telephony/Connection;Ljava/util/List;Z)V
    ...
    const-string/jumbo v4, "SecCapabilitiesBuilderVoice"

    iput-object v4, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->TAG:Ljava/lang/String;

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v5, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->TAG:Ljava/lang/String;
    ...
    iput p1, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mType:I

    iput-object p2, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mPhone:Lcom/android/internal/telephony/Phone;

    iput-object p3, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mConnection:Lcom/android/internal/telephony/Connection;

    iput-object p4, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mConnections:Ljava/util/List;

    iput-boolean p5, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mIsEmergency:Z

    iget-object v4, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mConnections:Ljava/util/List;
    ...
    iput-boolean v6, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mHasActiveCall:Z
    ...
    iget v4, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mConferenceCount:I

    add-int/lit8 v4, v4, 0x1

    iput v4, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mConferenceCount:I

    goto :goto_0

    :cond_2
    iput-boolean v6, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mHasHoldingCall:Z

    goto :goto_1

    :cond_3
    iget v4, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mNonConferenceCount:I

    add-int/lit8 v4, v4, 0x1

    iput v4, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mNonConferenceCount:I

    goto :goto_0

    :cond_4
    iget-object v4, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->TAG:Ljava/lang/String;
    ...
    iget-boolean v6, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mHasActiveCall:Z
    ...
    iget-boolean v6, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mHasHoldingCall:Z
    ...
    iget v6, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mConferenceCount:I
    ...
    iget v6, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mNonConferenceCount:I
...
.method private applyCapability(II)I
    ...
    iget-object v0, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->TAG:Ljava/lang/String;
...
.method private buildCapabilityMergeConferenceForVZW(I)I
    ...
    iget-object v6, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mConnections:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->TAG:Ljava/lang/String;

    const-string/jumbo v7, "buildCapabilityMergeConferenceForVZW: epdg & vt"

    invoke-static {v6, v7}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-direct {p0, p1, v8}, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->removeCapability(II)I
    ...
    iget-object v6, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mConnection:Lcom/android/internal/telephony/Connection;
...
.method private notAllowMergeConferenceForJansky()Z
    ...
    iget-object v8, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mPhone:Lcom/android/internal/telephony/Phone;
    ...
    iget-boolean v8, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mIsEmergency:Z

    invoke-static {v5, v8}, Lcom/android/services/telephony/operator/usa/JanskyCallerInfo;->isNativeLine(Ljava/lang/String;Z)Z

    move-result v7

    iget-object v8, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->TAG:Ljava/lang/String;
...
.method public buildCapabilityCallTransfer(I)I
    ...
    iget-object v1, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->TAG:Ljava/lang/String;

    const-string/jumbo v2, "buildCapabilityCallTransfer..."

    invoke-static {v1, v2}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget v1, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mType:I
    ...
    iget-object v1, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mPhone:Lcom/android/internal/telephony/Phone;
    ...
    invoke-direct {p0, p1, v4}, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->applyCapability(II)I
    ...
    iget-object v1, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mConnections:Ljava/util/List;
...
.method public buildCapabilityControlWaitingCall(I)I
    ...
    iget v0, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mType:I

    const/4 v1, 0x1

    if-ne v0, v1, :cond_1

    invoke-direct {p0, p1, v2}, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->removeCapability(II)I
    ...
    :cond_2
    invoke-direct {p0, p1, v2}, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->applyCapability(II)I
...
.method public buildCapabilityHold(I)I
    ...
    invoke-direct {p0, p1, v3}, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->removeCapability(II)I
    ...
    iget-boolean v0, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mIsEmergency:Z
    ...
    iget v0, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mConferenceCount:I

    if-lez v0, :cond_2

    iget-object v0, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mPhone:Lcom/android/internal/telephony/Phone;
    ...
    invoke-direct {p0, p1, v3}, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->applyCapability(II)I
    ...
    iget-boolean v0, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mHasActiveCall:Z

    if-eqz v0, :cond_5

    iget-boolean v0, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mHasHoldingCall:Z
    ...
    iget-object v0, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mConnection:Lcom/android/internal/telephony/Connection;
...
.method public buildCapabilityManageConference(I)I
    ...
    const-string/jumbo v1, "buildCapabilityManageConference: isTWAPT isTWTWM & existPSCall"
...
.method public buildCapabilityMergeConference(I)I
    ...
    const-string/jumbo v2, "buildCapabilityMergeConference..."

    invoke-static {v1, v2}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    const-string/jumbo v1, "support_merge_call"
    ...
    invoke-direct {p0, p1, v4}, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->removeCapability(II)I
    ...
    invoke-virtual {v1}, Lcom/android/services/telephony/cdma/CdmaPhoneCallStateManager;->isCurrentMergeCapableState()Z

    move-result v1

    if-eqz v1, :cond_1

    iget-object v1, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mConnection:Lcom/android/internal/telephony/Connection;
    ...
    const-string/jumbo v3, "mPhone.canConference() => "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mPhone:Lcom/android/internal/telephony/Phone;

    invoke-virtual {v3}, Lcom/android/internal/telephony/Phone;->canConference()Z
    ...
    iget-boolean v1, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mHasHoldingCall:Z

    if-eqz v1, :cond_3

    iget-boolean v1, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mHasActiveCall:Z
    ...
    iget v1, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mConferenceCount:I
    ...
    :cond_4
    const-string/jumbo v1, "emergency_call_active_always"
    ...
    iget-boolean v1, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mIsEmergency:Z

    if-eqz v1, :cond_5

    iget-object v1, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->TAG:Ljava/lang/String;

    const-string/jumbo v2, "buildCapabilityMergeConference: EMERGENCY_CALL_ACTIVE_ALWAYS"
    ...
    invoke-static {v1}, Lcom/android/services/utils/SecCapabilitiesBuilder;->hasGroupMtConnection(Ljava/util/List;)Z
    ...
    invoke-static {v1}, Lcom/android/services/utils/SecCapabilitiesBuilder;->hasMtConference(Ljava/util/List;)Z
    ...
    :cond_7
    const-string/jumbo v1, "support_merge"
    ...
    const-string/jumbo v2, "buildCapabilityMergeConference: SUPPORT_MERGE, secondary call is video call"
    ...
    invoke-static {}, Lcom/android/phone/TelephonyConfig;->isTurkTelekomSIM()Z
    ...
    invoke-static {v1}, Lcom/android/services/utils/SecCapabilitiesBuilder;->hasVolteCall(Ljava/util/List;)Z
    ...
    const-string/jumbo v2, "buildCapabilityMergeConference: from operator."
    ...
    const-string/jumbo v2, "buildCapabilityMergeConference: FEATURE_LGT & phoneIsCdma"
    ...
    invoke-static {v1}, Lcom/android/services/utils/SecCapabilitiesBuilder;->hasGroupConnection(Ljava/util/List;)Z
    ...
    invoke-direct {p0}, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->notAllowMergeConferenceForJansky()Z
    ...
    invoke-direct {p0, p1}, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->buildCapabilityMergeConferenceForVZW(I)I
...
.method public buildCapabilityMute(I)I
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->removeCapability(II)I
...
.method public buildCapabilitySessionModify(I)I
    ...
    iget-object v3, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->TAG:Ljava/lang/String;

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v5, "buildCapabilitySessionModify..."

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mType:I
    ...
    iget v3, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mType:I
    ...
    iget-object v3, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mConnections:Ljava/util/List;
    ...
    invoke-direct {p0, p1, v6}, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->applyCapability(II)I
    ...
    :cond_3
    invoke-direct {p0, p1, v6}, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->removeCapability(II)I
...
.method public buildCapabilitySwapConference(I)I
    ...
    iget v0, p0, Lcom/android/services/utils/SecCapabilitiesBuilderVoice;->mNonConferenceCount:I
