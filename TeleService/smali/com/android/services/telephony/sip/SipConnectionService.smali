...
# direct methods
.method static synthetic -get0(Lcom/android/services/telephony/sip/SipConnectionService;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic -get1(Lcom/android/services/telephony/sip/SipConnectionService;)Lcom/android/services/telephony/sip/SipProfileDb;
    .locals 1
...
.method static synthetic -wrap0(Lcom/android/services/telephony/sip/SipConnectionService;Landroid/net/sip/SipProfile;Landroid/telecom/ConnectionRequest;)Lcom/android/internal/telephony/Connection;
    .locals 1
...
.method private static log(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "[SipConnectionService] "
...
.method private startCallWithPhone(Lcom/android/internal/telephony/sip/SipPhone;Landroid/telecom/ConnectionRequest;)Lcom/android/internal/telephony/Connection;
    ...
    const-string/jumbo v4, "startCallWithPhone, exception: "
...
.method public onCreateIncomingConnection(Landroid/telecom/PhoneAccountHandle;Landroid/telecom/ConnectionRequest;)Landroid/telecom/Connection;
    ...
    const-string/jumbo v6, "No extras on request."
    ...
    const-string/jumbo v7, "com.android.services.telephony.sip.incoming_call_intent"
    ...
    const-string/jumbo v6, "No SIP intent."
    ...
    const-string/jumbo v7, "onCreateIncomingConnection, takeAudioCall exception: "
...
.method public onCreateOutgoingConnection(Landroid/telecom/PhoneAccountHandle;Landroid/telecom/ConnectionRequest;)Landroid/telecom/Connection;
    ...
    const-string/jumbo v8, "android.telecom.extra.GATEWAY_PROVIDER_PACKAGE"
    ...
    const-string/jumbo v8, "Cannot make a SIP call with a gateway number."

    const/16 v9, 0x14

    invoke-static {v9, v8}, Lcom/android/services/telephony/DisconnectCauseUtil;->toTelecomDisconnectCause(ILjava/lang/String;)Landroid/telecom/DisconnectCause;
    ...
    const-string/jumbo v8, "Did not match service connection"
    ...
    invoke-virtual {v2, v8, v11}, Lcom/android/services/telephony/sip/SipConnection;->setAddress(Landroid/net/Uri;I)V
    ...
    const-string/jumbo v9, "VoIP unsupported"

    invoke-direct {v8, v11, v10, v3, v9}, Landroid/telecom/DisconnectCause;-><init>(ILjava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/String;)V
    ...
    const-string/jumbo v9, "Network not connected"
