...
.method public recalculateConferenceable(Ljava/util/List;)V
    ...
    const-string/jumbo v6, "recalculateConferenceable : %d"
    ...
    const-string/jumbo v6, "recalc - %s"
    ...
    :cond_0
    const-string/jumbo v6, "active: %d, holding: %d"
    ...
    invoke-virtual {v2}, Lcom/android/services/telephony/CdmaConnection;->getConnectionCapabilities()I

    move-result v6

    or-int/lit8 v6, v6, 0x4

    invoke-virtual {v2, v6}, Lcom/android/services/telephony/CdmaConnection;->setConnectionCapabilities(I)V
    ...
    check-cast v4, Lcom/android/services/telephony/CdmaConnection;

    invoke-virtual {v4}, Lcom/android/services/telephony/CdmaConnection;->resetStateForConference()Z
