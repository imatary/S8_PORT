...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, v0}, Lcom/amap/api/mapcore2d/ds;->a(Landroid/content/Context;)Lcom/amap/api/mapcore2d/dn;

    move-result-object v0

    iput-object v0, p0, Lcom/amap/api/mapcore2d/ds;->a:Lcom/amap/api/mapcore2d/dn;
...
.method public a()Ljava/util/List;
    ...
    :try_start_0
    new-instance v1, Lcom/amap/api/mapcore2d/dt;

    invoke-direct {v1}, Lcom/amap/api/mapcore2d/dt;-><init>()V

    invoke-static {}, Lcom/amap/api/mapcore2d/dt;->c()Ljava/lang/String;

    move-result-object v2

    iget-object v3, p0, Lcom/amap/api/mapcore2d/ds;->a:Lcom/amap/api/mapcore2d/dn;
...
.method public a(Lcom/amap/api/mapcore2d/dh;)V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lcom/amap/api/mapcore2d/ds;->a:Lcom/amap/api/mapcore2d/dn;
    ...
    invoke-direct {v0}, Lcom/amap/api/mapcore2d/dt;-><init>()V
    ...
    invoke-static {v1}, Lcom/amap/api/mapcore2d/dt;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lcom/amap/api/mapcore2d/ds;->a:Lcom/amap/api/mapcore2d/dn;

    new-instance v3, Lcom/amap/api/mapcore2d/dt;

    invoke-direct {v3}, Lcom/amap/api/mapcore2d/dt;-><init>()V
    ...
    :cond_2
    iget-object v1, p0, Lcom/amap/api/mapcore2d/ds;->a:Lcom/amap/api/mapcore2d/dn;
