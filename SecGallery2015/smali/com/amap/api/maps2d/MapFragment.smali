...
.field private b:Lcom/amap/api/mapcore2d/aj;
...
.method public getMap()Lcom/amap/api/maps2d/AMap;
    ...
    const-string/jumbo v1, "getMap"

    invoke-virtual {p0}, Lcom/amap/api/maps2d/MapFragment;->getMapFragmentDelegate()Lcom/amap/api/mapcore2d/aj;
    ...
    :cond_1
    :try_start_0
    invoke-interface {v2}, Lcom/amap/api/mapcore2d/aj;->a()Lcom/amap/api/mapcore2d/ag;
    :try_end_0
    ...
    invoke-direct {v0, v1}, Lcom/amap/api/maps2d/AMap;-><init>(Lcom/amap/api/mapcore2d/ag;)V
...
.method protected getMapFragmentDelegate()Lcom/amap/api/mapcore2d/aj;
    ...
    iget-object v0, p0, Lcom/amap/api/maps2d/MapFragment;->b:Lcom/amap/api/mapcore2d/aj;

    if-nez v0, :cond_0

    new-instance v0, Lcom/amap/api/mapcore2d/bc;

    invoke-direct {v0}, Lcom/amap/api/mapcore2d/bc;-><init>()V

    iput-object v0, p0, Lcom/amap/api/maps2d/MapFragment;->b:Lcom/amap/api/mapcore2d/aj;
    ...
    invoke-interface {v0, v1}, Lcom/amap/api/mapcore2d/aj;->a(Landroid/content/Context;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1}, Lcom/amap/api/mapcore2d/aj;->a(Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/amap/api/mapcore2d/aj;->a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onDestroy()V
    ...
    invoke-interface {v0}, Lcom/amap/api/mapcore2d/aj;->e()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onDestroyView()V
    ...
    invoke-interface {v0}, Lcom/amap/api/mapcore2d/aj;->d()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onInflate(Landroid/app/Activity;Landroid/util/AttributeSet;Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1, v2, p3}, Lcom/amap/api/mapcore2d/aj;->a(Landroid/app/Activity;Lcom/amap/api/maps2d/AMapOptions;Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onLowMemory()V
    ...
    invoke-interface {v0}, Lcom/amap/api/mapcore2d/aj;->f()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onPause()V
    ...
    invoke-interface {v0}, Lcom/amap/api/mapcore2d/aj;->c()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1}, Lcom/amap/api/mapcore2d/aj;->b(Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
