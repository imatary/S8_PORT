.class Lcom/sec/samsung/gallery/util/AddItemToChannel$8;
...
.method constructor <init>(Lcom/sec/samsung/gallery/util/AddItemToChannel;I[Landroid/net/Uri;ZLcom/sec/android/gallery3d/data/ChannelAlbum;Ljava/util/List;)V
    ...
    iput-object p1, p0, Lcom/sec/samsung/gallery/util/AddItemToChannel$8;->this$0:Lcom/sec/samsung/gallery/util/AddItemToChannel;

    iput p2, p0, Lcom/sec/samsung/gallery/util/AddItemToChannel$8;->val$channelID:I

    iput-object p3, p0, Lcom/sec/samsung/gallery/util/AddItemToChannel$8;->val$selectionArgs:[Landroid/net/Uri;

    iput-boolean p4, p0, Lcom/sec/samsung/gallery/util/AddItemToChannel$8;->val$newShare:Z

    iput-object p5, p0, Lcom/sec/samsung/gallery/util/AddItemToChannel$8;->val$channelAlbum:Lcom/sec/android/gallery3d/data/ChannelAlbum;

    iput-object p6, p0, Lcom/sec/samsung/gallery/util/AddItemToChannel$8;->val$mediaItemList:Ljava/util/List;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    iget v1, p0, Lcom/sec/samsung/gallery/util/AddItemToChannel$8;->val$channelID:I

    iget-object v2, p0, Lcom/sec/samsung/gallery/util/AddItemToChannel$8;->val$selectionArgs:[Landroid/net/Uri;

    iget-boolean v3, p0, Lcom/sec/samsung/gallery/util/AddItemToChannel$8;->val$newShare:Z

    const/4 v4, 0x1

    iget-object v5, p0, Lcom/sec/samsung/gallery/util/AddItemToChannel$8;->val$channelAlbum:Lcom/sec/android/gallery3d/data/ChannelAlbum;
