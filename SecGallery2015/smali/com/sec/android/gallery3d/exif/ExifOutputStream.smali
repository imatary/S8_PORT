...
.method private calculateOffsetOfIfd(Lcom/sec/android/gallery3d/exif/IfdData;I)I
    ...
    invoke-virtual {v0, p2}, Lcom/sec/android/gallery3d/exif/ExifTag;->setOffset(I)V
...
.method private stripNullValueTags(Lcom/sec/android/gallery3d/exif/ExifData;)Ljava/util/ArrayList;
    ...
    check-cast v1, Lcom/sec/android/gallery3d/exif/ExifTag;

    invoke-virtual {v1}, Lcom/sec/android/gallery3d/exif/ExifTag;->getValue()Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Lcom/sec/android/gallery3d/exif/ExifTag;->getIfd()I
...
.method private writeExifData()V
    ...
    iget-object v4, p0, Lcom/sec/android/gallery3d/exif/ExifOutputStream;->mExifData:Lcom/sec/android/gallery3d/exif/ExifData;
    ...
    invoke-direct {p0, v4}, Lcom/sec/android/gallery3d/exif/ExifOutputStream;->stripNullValueTags(Lcom/sec/android/gallery3d/exif/ExifData;)Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v4}, Lcom/sec/android/gallery3d/exif/OrderedDataOutputStream;-><init>(Ljava/io/OutputStream;)V

    sget-object v4, Ljava/nio/ByteOrder;->BIG_ENDIAN:Ljava/nio/ByteOrder;

    invoke-virtual {v0, v4}, Lcom/sec/android/gallery3d/exif/OrderedDataOutputStream;->setByteOrder(Ljava/nio/ByteOrder;)Lcom/sec/android/gallery3d/exif/OrderedDataOutputStream;

    const/16 v4, -0x1f

    invoke-virtual {v0, v4}, Lcom/sec/android/gallery3d/exif/OrderedDataOutputStream;->writeShort(S)Lcom/sec/android/gallery3d/exif/OrderedDataOutputStream;
    ...
    invoke-virtual {v0, v4}, Lcom/sec/android/gallery3d/exif/OrderedDataOutputStream;->writeInt(I)Lcom/sec/android/gallery3d/exif/OrderedDataOutputStream;
    ...
    invoke-virtual {v4}, Lcom/sec/android/gallery3d/exif/ExifData;->getByteOrder()Ljava/nio/ByteOrder;
    ...
    check-cast v3, Lcom/sec/android/gallery3d/exif/ExifTag;

    iget-object v5, p0, Lcom/sec/android/gallery3d/exif/ExifOutputStream;->mExifData:Lcom/sec/android/gallery3d/exif/ExifData;

    invoke-virtual {v5, v3}, Lcom/sec/android/gallery3d/exif/ExifData;->addTag(Lcom/sec/android/gallery3d/exif/ExifTag;)Lcom/sec/android/gallery3d/exif/ExifTag;
...
.method private writeIfd(Lcom/sec/android/gallery3d/exif/IfdData;Lcom/sec/android/gallery3d/exif/OrderedDataOutputStream;)V
    ...
    invoke-virtual {p2, v5}, Lcom/sec/android/gallery3d/exif/OrderedDataOutputStream;->writeShort(S)Lcom/sec/android/gallery3d/exif/OrderedDataOutputStream;
    ...
    invoke-virtual {v2}, Lcom/sec/android/gallery3d/exif/ExifTag;->getDataType()S

    move-result v7

    invoke-virtual {p2, v7}, Lcom/sec/android/gallery3d/exif/OrderedDataOutputStream;->writeShort(S)Lcom/sec/android/gallery3d/exif/OrderedDataOutputStream;

    invoke-virtual {v2}, Lcom/sec/android/gallery3d/exif/ExifTag;->getComponentCount()I
    ...
    invoke-virtual {v2}, Lcom/sec/android/gallery3d/exif/ExifTag;->getDataSize()I

    move-result v7

    if-le v7, v8, :cond_3

    invoke-virtual {v2}, Lcom/sec/android/gallery3d/exif/ExifTag;->getOffset()I
    ...
    :cond_3
    invoke-static {v2, p2}, Lcom/sec/android/gallery3d/exif/ExifOutputStream;->writeTagValue(Lcom/sec/android/gallery3d/exif/ExifTag;Lcom/sec/android/gallery3d/exif/OrderedDataOutputStream;)V
    ...
    invoke-virtual {p2, v4}, Lcom/sec/android/gallery3d/exif/OrderedDataOutputStream;->write(I)V
    ...
    invoke-virtual {p2, v5}, Lcom/sec/android/gallery3d/exif/OrderedDataOutputStream;->writeInt(I)Lcom/sec/android/gallery3d/exif/OrderedDataOutputStream;
...
.method private static writeTagValue(Lcom/sec/android/gallery3d/exif/ExifTag;Lcom/sec/android/gallery3d/exif/OrderedDataOutputStream;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
