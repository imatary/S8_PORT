.class public Lcom/sec/android/gallery3d/eventshare/command/ResumeUploadCommand;
.super Lcom/sec/android/gallery3d/eventshare/command/UploadFolderCommand;
.source "ResumeUploadCommand.java"


# static fields
.field private static final TAG:Ljava/lang/String; = "ResumeUploadCommand"
...
.method public constructor <init>(Lcom/sec/android/gallery3d/eventshare/EventState;)V
    ...
    invoke-direct {p0, p1}, Lcom/sec/android/gallery3d/eventshare/command/UploadFolderCommand;-><init>(Lcom/sec/android/gallery3d/eventshare/EventState;)V
...
.method public excute()V
    ...
    iget-object v13, v0, Lcom/sec/android/gallery3d/eventshare/command/ResumeUploadCommand;->mSharedEvent:Lcom/sec/android/gallery3d/eventshare/SharedEvent;
    ...
    const-string/jumbo v13, "ResumeUploadCommand"
    ...
    iget-object v15, v0, Lcom/sec/android/gallery3d/eventshare/command/ResumeUploadCommand;->mSharedEvent:Lcom/sec/android/gallery3d/eventshare/SharedEvent;
    ...
    iput v13, v0, Lcom/sec/android/gallery3d/eventshare/command/ResumeUploadCommand;->mUploadedFileCount:I

    invoke-virtual/range {p0 .. p0}, Lcom/sec/android/gallery3d/eventshare/command/ResumeUploadCommand;->updateData()V
    ...
    iget-object v13, v0, Lcom/sec/android/gallery3d/eventshare/command/ResumeUploadCommand;->mFileLocalPathMap:Ljava/util/HashMap;
    ...
    iget-object v13, v0, Lcom/sec/android/gallery3d/eventshare/command/ResumeUploadCommand;->mFileCMHIdMap:Ljava/util/HashMap;
    ...
    iget-object v13, v0, Lcom/sec/android/gallery3d/eventshare/command/ResumeUploadCommand;->mFileMediaIdMap:Ljava/util/HashMap;
    ...
    iput v13, v0, Lcom/sec/android/gallery3d/eventshare/command/ResumeUploadCommand;->mTotalFileCount:I

    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/sec/android/gallery3d/eventshare/command/ResumeUploadCommand;->mSharedEvent:Lcom/sec/android/gallery3d/eventshare/SharedEvent;

    invoke-virtual {v13}, Lcom/sec/android/gallery3d/eventshare/SharedEvent;->getThumbnailItemList()Ljava/util/ArrayList;
    ...
    iput-object v13, v0, Lcom/sec/android/gallery3d/eventshare/command/ResumeUploadCommand;->mThumbnailItemList:Ljava/util/ArrayList;
    ...
    invoke-virtual {v13}, Lcom/sec/android/gallery3d/eventshare/SharedEvent;->getRemoveOriginalFileIdArray()Ljava/util/ArrayList;
    ...
    iput-object v13, v0, Lcom/sec/android/gallery3d/eventshare/command/ResumeUploadCommand;->mRemoveOriginalFileIdArray:Ljava/util/ArrayList;

    :cond_6
    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/sec/android/gallery3d/eventshare/command/ResumeUploadCommand;->mShareAgent:Lcom/sec/android/gallery3d/eventshare/ShareAgent;

    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/sec/android/gallery3d/eventshare/command/ResumeUploadCommand;->mSharedEvent:Lcom/sec/android/gallery3d/eventshare/SharedEvent;
    ...
    iget-object v13, v0, Lcom/sec/android/gallery3d/eventshare/command/ResumeUploadCommand;->mEventState:Lcom/sec/android/gallery3d/eventshare/EventState;
