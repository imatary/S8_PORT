.class Lcom/sec/android/gallery3d/data/UnionScloudViewAlbumSet;
.super Lcom/sec/android/gallery3d/data/UnionAlbumSet;
.source "UnionScloudViewAlbumSet.java"


# static fields
.field public static final PATH_SCLOUD_VIEW_IMAGE:Lcom/sec/android/gallery3d/data/Path;

.field public static final PATH_SCLOUD_VIEW_VIDEO:Lcom/sec/android/gallery3d/data/Path;
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v0, "/union/sclouditem/image"

    invoke-static {v0}, Lcom/sec/android/gallery3d/data/Path;->fromString(Ljava/lang/String;)Lcom/sec/android/gallery3d/data/Path;

    move-result-object v0

    sput-object v0, Lcom/sec/android/gallery3d/data/UnionScloudViewAlbumSet;->PATH_SCLOUD_VIEW_IMAGE:Lcom/sec/android/gallery3d/data/Path;

    const-string/jumbo v0, "/union/sclouditem/video"

    invoke-static {v0}, Lcom/sec/android/gallery3d/data/Path;->fromString(Ljava/lang/String;)Lcom/sec/android/gallery3d/data/Path;

    move-result-object v0

    sput-object v0, Lcom/sec/android/gallery3d/data/UnionScloudViewAlbumSet;->PATH_SCLOUD_VIEW_VIDEO:Lcom/sec/android/gallery3d/data/Path;
...
.method public constructor <init>(Lcom/sec/android/gallery3d/data/Path;Lcom/sec/android/gallery3d/app/GalleryApp;)V
    ...
    iput-object v0, p0, Lcom/sec/android/gallery3d/data/UnionScloudViewAlbumSet;->mNotifier:Lcom/sec/android/gallery3d/data/ChangeNotifier;
...
.method getTypeFromPath(Lcom/sec/android/gallery3d/data/Path;)I
    ...
    :goto_0
    invoke-static {v0}, Lcom/sec/android/gallery3d/data/UnionScloudViewAlbumSet;->getTypeFromString(Ljava/lang/String;)I
...
.method getUnionAlbum(Lcom/sec/android/gallery3d/data/DataManager;ILcom/sec/android/gallery3d/data/Path;ILjava/lang/String;Ljava/lang/String;)Lcom/sec/android/gallery3d/data/MediaSet;
    ...
    :pswitch_1
    new-instance v10, Lcom/sec/android/gallery3d/data/UnionScloudViewAlbum;

    iget-object v1, p0, Lcom/sec/android/gallery3d/data/UnionScloudViewAlbumSet;->mApplication:Lcom/sec/android/gallery3d/app/GalleryApp;

    const/4 v2, 0x1

    move/from16 v0, p4

    invoke-direct {v10, v11, v1, v0, v2}, Lcom/sec/android/gallery3d/data/UnionScloudViewAlbum;-><init>(Lcom/sec/android/gallery3d/data/Path;Lcom/sec/android/gallery3d/app/GalleryApp;IZ)V
    ...
    sget-object v4, Lcom/sec/android/gallery3d/data/UnionScloudViewAlbumSet;->PATH_SCLOUD_VIEW_IMAGE:Lcom/sec/android/gallery3d/data/Path;
    ...
    invoke-virtual/range {v1 .. v7}, Lcom/sec/android/gallery3d/data/UnionScloudViewAlbumSet;->getUnionAlbum(Lcom/sec/android/gallery3d/data/DataManager;ILcom/sec/android/gallery3d/data/Path;ILjava/lang/String;Ljava/lang/String;)Lcom/sec/android/gallery3d/data/MediaSet;

    move-result-object v9

    const/4 v3, 0x4

    sget-object v4, Lcom/sec/android/gallery3d/data/UnionScloudViewAlbumSet;->PATH_SCLOUD_VIEW_VIDEO:Lcom/sec/android/gallery3d/data/Path;
