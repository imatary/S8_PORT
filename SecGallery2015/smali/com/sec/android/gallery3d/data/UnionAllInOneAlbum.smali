.class public Lcom/sec/android/gallery3d/data/UnionAllInOneAlbum;
.super Lcom/sec/android/gallery3d/data/MediaSet;
.source "UnionAllInOneAlbum.java"
...
.method public constructor <init>(Lcom/sec/android/gallery3d/data/MediaSet;Lcom/sec/android/gallery3d/data/Path;)V
    ...
    invoke-static {}, Lcom/sec/android/gallery3d/data/UnionAllInOneAlbum;->nextVersionNumber()J
    ...
    iput-object v0, p0, Lcom/sec/android/gallery3d/data/UnionAllInOneAlbum;->mSubSets:Ljava/util/ArrayList;

    iput-object p1, p0, Lcom/sec/android/gallery3d/data/UnionAllInOneAlbum;->mBaseSet:Lcom/sec/android/gallery3d/data/MediaSet;
...
.method private addMediaSets(Lcom/sec/android/gallery3d/data/MediaSet;)V
    ...
    iget-object v1, p0, Lcom/sec/android/gallery3d/data/UnionAllInOneAlbum;->mSubSets:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v1}, Lcom/sec/android/gallery3d/data/UnionAllInOneAlbum;->addMediaSets(Lcom/sec/android/gallery3d/data/MediaSet;)V
...
.method public addContentListener(Lcom/sec/android/gallery3d/data/ContentListener;)V
    ...
    iget-object v0, p0, Lcom/sec/android/gallery3d/data/UnionAllInOneAlbum;->mBaseSet:Lcom/sec/android/gallery3d/data/MediaSet;
...
.method public getMediaItem(II)Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object v6, p0, Lcom/sec/android/gallery3d/data/UnionAllInOneAlbum;->mSubSets:Ljava/util/ArrayList;
...
.method public onContentDirty()V
    ...
    invoke-virtual {p0}, Lcom/sec/android/gallery3d/data/UnionAllInOneAlbum;->notifyContentChanged()V
...
.method public reload()J
    ...
    iget-wide v2, p0, Lcom/sec/android/gallery3d/data/UnionAllInOneAlbum;->mDataVersion:J
    ...
    iput-wide v0, p0, Lcom/sec/android/gallery3d/data/UnionAllInOneAlbum;->mDataVersion:J

    iget-object v0, p0, Lcom/sec/android/gallery3d/data/UnionAllInOneAlbum;->mSubSets:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    iget-object v0, p0, Lcom/sec/android/gallery3d/data/UnionAllInOneAlbum;->mBaseSet:Lcom/sec/android/gallery3d/data/MediaSet;

    invoke-direct {p0, v0}, Lcom/sec/android/gallery3d/data/UnionAllInOneAlbum;->addMediaSets(Lcom/sec/android/gallery3d/data/MediaSet;)V

    :cond_0
    :goto_0
    iget-wide v0, p0, Lcom/sec/android/gallery3d/data/UnionAllInOneAlbum;->mDataVersion:J
