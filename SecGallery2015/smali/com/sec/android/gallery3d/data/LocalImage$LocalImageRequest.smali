...
# direct methods
.method public constructor <init>(Lcom/sec/android/gallery3d/interfaces/DefaultAppContext;Lcom/sec/android/gallery3d/data/Path;JILjava/lang/String;)V
    .locals 11

    const/4 v8, 0x0

    sget-object v9, Lcom/sec/android/gallery3d/data/MediaItem$RequestAttributes;->WITH_ATTRIBUTES:Lcom/sec/android/gallery3d/data/MediaItem$RequestAttributes;
...
.method public constructor <init>(Lcom/sec/android/gallery3d/interfaces/DefaultAppContext;Lcom/sec/android/gallery3d/data/Path;JILjava/lang/String;ZLcom/sec/android/gallery3d/data/MediaItem$RequestAttributes;)V
    ...
    iput-object p1, p0, Lcom/sec/android/gallery3d/data/LocalImage$LocalImageRequest;->mApplication:Lcom/sec/android/gallery3d/interfaces/DefaultAppContext;
    ...
    iput-object v0, p0, Lcom/sec/android/gallery3d/data/LocalImage$LocalImageRequest;->mRequestAttributes:Lcom/sec/android/gallery3d/data/MediaItem$RequestAttributes;
...
.method public onDecodeOriginal(Lcom/sec/android/gallery3d/util/ThreadPool$JobContext;I)Landroid/graphics/Bitmap;
    ...
    iget-boolean v1, p0, Lcom/sec/android/gallery3d/data/LocalImage$LocalImageRequest;->mIsGolf:Z
    ...
    iget-object v4, p0, Lcom/sec/android/gallery3d/data/LocalImage$LocalImageRequest;->mLocalFilePath:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/sec/android/gallery3d/data/LocalImage$LocalImageRequest;->mLocalFilePath:Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/sec/android/gallery3d/data/LocalImage$LocalImageRequest;->mLocalFilePath:Ljava/lang/String;
...
.method public resizeDownAndCropCenterForNormal(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    iget v2, p0, Lcom/sec/android/gallery3d/data/LocalImage$LocalImageRequest;->mTargetSize:I
...
.method public resizeDownBySideLengthForNormal(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    sget-boolean v0, Lcom/sec/android/gallery3d/data/LocalImage$LocalImageRequest;->FeatureUseCropCenterPanoramaThumbnail:Z
    ...
    iget v0, p0, Lcom/sec/android/gallery3d/data/LocalImage$LocalImageRequest;->mType:I
    ...
    :cond_0
    iget v0, p0, Lcom/sec/android/gallery3d/data/LocalImage$LocalImageRequest;->mTargetSize:I
...
.method public run(Lcom/sec/android/gallery3d/util/ThreadPool$JobContext;)Landroid/graphics/Bitmap;
    ...
    iget-object v2, p0, Lcom/sec/android/gallery3d/data/LocalImage$LocalImageRequest;->mApplication:Lcom/sec/android/gallery3d/interfaces/DefaultAppContext;
    ...
    iget-object v3, p0, Lcom/sec/android/gallery3d/data/LocalImage$LocalImageRequest;->mApplication:Lcom/sec/android/gallery3d/interfaces/DefaultAppContext;
    ...
    :cond_4
    invoke-direct {p0}, Lcom/sec/android/gallery3d/data/LocalImage$LocalImageRequest;->updatePanoramaAttribute()Z

    move-result v1

    invoke-direct {p0, v1}, Lcom/sec/android/gallery3d/data/LocalImage$LocalImageRequest;->loadFaceRect(Z)V

    invoke-direct {p0}, Lcom/sec/android/gallery3d/data/LocalImage$LocalImageRequest;->updateBurstShotAttributes()V

    iget-object v2, p0, Lcom/sec/android/gallery3d/data/LocalImage$LocalImageRequest;->mRequestAttributes:Lcom/sec/android/gallery3d/data/MediaItem$RequestAttributes;
    ...
    invoke-direct {p0}, Lcom/sec/android/gallery3d/data/LocalImage$LocalImageRequest;->updatePendingAttribute()V
