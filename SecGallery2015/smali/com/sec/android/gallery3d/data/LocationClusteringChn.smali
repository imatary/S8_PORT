.class public Lcom/sec/android/gallery3d/data/LocationClusteringChn;
.super Lcom/sec/android/gallery3d/data/Clustering;
.source "LocationClusteringChn.java"


# annotations
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;
    }
.end annotation
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/sec/android/gallery3d/data/LocationClusteringChn;->mContext:Landroid/content/Context;

    iget-object v0, p0, Lcom/sec/android/gallery3d/data/LocationClusteringChn;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/sec/android/gallery3d/data/LocationClusteringChn;->mNoLocationString:Ljava/lang/String;
...
.method private getCluster(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Lcom/sec/android/gallery3d/data/LocationClusteringChn;->mHashMap:Ljava/util/HashMap;

    if-eqz v4, :cond_0

    iget-object v4, p0, Lcom/sec/android/gallery3d/data/LocationClusteringChn;->mNoLocationString:Ljava/lang/String;
...
.method private static kMeans([Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;[I)[I
    .locals 34
    ...
    new-array v14, v0, [Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;

    move/from16 v0, v25

    new-array v0, v0, [Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;
    ...
    new-instance v2, Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;

    invoke-direct {v2}, Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;-><init>()V
    ...
    iget-wide v4, v0, Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;->latRad:D

    iput-wide v4, v2, Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;->latRad:D

    aget-object v2, v14, v20

    move-object/from16 v0, v28

    iget-wide v4, v0, Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;->lngRad:D

    iput-wide v4, v2, Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;->lngRad:D
    ...
    iget-wide v2, v0, Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;->latRad:D
    ...
    iget-wide v6, v6, Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;->latRad:D

    aget-object v8, v14, v22

    iget-wide v8, v8, Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;->lngRad:D
    ...
    iget-wide v4, v2, Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;->latRad:D

    move-object/from16 v0, v28

    iget-wide v6, v0, Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;->latRad:D
    ...
    iget-wide v4, v2, Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;->lngRad:D

    move-object/from16 v0, v28

    iget-wide v6, v0, Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;->lngRad:D
    ...
    iget-wide v4, v3, Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;->latRad:D
    ...
    iget-wide v4, v3, Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;->lngRad:D
...
.method public getCluster(I)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Lcom/sec/android/gallery3d/data/LocationClusteringChn;->mNames:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v0}, Lcom/sec/android/gallery3d/data/LocationClusteringChn;->getCluster(Ljava/lang/String;)Ljava/util/ArrayList;
...
.method public getNumberOfClusters()I
    ...
    iget-object v0, p0, Lcom/sec/android/gallery3d/data/LocationClusteringChn;->mHashMap:Ljava/util/HashMap;
...
.method public run(Lcom/sec/android/gallery3d/data/MediaSet;)V
    ...
    invoke-virtual {v0, v1, v6, v2}, Lcom/sec/android/gallery3d/data/LocationClusteringChn;->enumerateTotalMediaItems(Lcom/sec/android/gallery3d/data/MediaSet;Ljava/util/ArrayList;Z)V
    ...
    new-instance v18, Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/sec/android/gallery3d/data/LocationClusteringChn$Point;-><init>(DD)V
    ...
    iget-object v0, v0, Lcom/sec/android/gallery3d/data/LocationClusteringChn;->mContext:Landroid/content/Context;
    ...
    iput-object v0, v1, Lcom/sec/android/gallery3d/data/LocationClusteringChn;->mNames:Ljava/util/ArrayList;
    ...
    iput-object v0, v1, Lcom/sec/android/gallery3d/data/LocationClusteringChn;->mHashMap:Ljava/util/HashMap;
    ...
    invoke-static {v7, v9}, Lcom/sec/android/gallery3d/data/LocationClusteringChn;->generateName(Ljava/util/ArrayList;Lcom/sec/android/gallery3d/util/ReverseGeocoder;)Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/sec/android/gallery3d/data/LocationClusteringChn;->mHashMap:Ljava/util/HashMap;
    ...
    iget-object v0, v0, Lcom/sec/android/gallery3d/data/LocationClusteringChn;->mNames:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Lcom/sec/android/gallery3d/data/LocationClusteringChn;->mNoLocationString:Ljava/lang/String;
