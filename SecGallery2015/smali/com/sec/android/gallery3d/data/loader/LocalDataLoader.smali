.class public Lcom/sec/android/gallery3d/data/loader/LocalDataLoader;
.super Lcom/sec/android/gallery3d/data/loader/ProgressiveLoader;
.source "LocalDataLoader.java"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/sec/android/gallery3d/data/loader/LocalDataLoader;->PROJECTION:[Ljava/lang/String;
...
.method private getPostPathFilter(Lcom/sec/android/gallery3d/data/Path;)Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lcom/sec/android/gallery3d/data/loader/LocalDataLoader;->mLoaderHelper:Lcom/sec/android/gallery3d/data/loader/LoaderHelper;
    ...
    iget-object v3, p0, Lcom/sec/android/gallery3d/data/loader/LocalDataLoader;->mLoaderHelper:Lcom/sec/android/gallery3d/data/loader/LoaderHelper;
...
.method protected getProjection(Lcom/sec/android/gallery3d/data/Path;)[Ljava/lang/String;
    ...
    const-string/jumbo v2, "%1$s, %2$s, %3$s\nfrom (\n        select %3$s, %1$s, %2$s, group_id\n        from %4$s\n        where group_id != 0 and device_id = 1 and (is_cloud = 1 or is_cloud = 3) %5$s)\ngroup by group_id\nhaving group_id not in (\n        select distinct group_id\n        from %4$s\n        where best_image = 1 and device_id = 1 and (is_cloud = 1 or is_cloud = 3) %5$s)\nunion\nselect %1$s, %2$s, %3$s"

    const/4 v3, 0x5

    new-array v3, v3, [Ljava/lang/Object;

    sget-object v4, Lcom/sec/android/gallery3d/data/loader/LocalDataLoader;->PROJECTION:[Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lcom/sec/android/gallery3d/data/loader/LocalDataLoader;->getPostPathFilter(Lcom/sec/android/gallery3d/data/Path;)Ljava/lang/String;
...
.method protected getWhere(Lcom/sec/android/gallery3d/data/Path;)Ljava/lang/String;
    ...
    const-string/jumbo v1, " ( ( ( best_image = 1 ) or ( group_id = 0) ) and (device_id = 1) and (is_cloud = 1 or is_cloud = 3) ) "
    ...
    invoke-virtual {p0, v1}, Lcom/sec/android/gallery3d/data/loader/LocalDataLoader;->hasFilter(I)Z
