...
.source "ShareContentsRequest.java"
...
.method public constructor <init>(Ljava/util/List;Ljava/lang/String;Ljava/util/ArrayList;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string/jumbo v1, " one of toList and toMulti(Groupid) is not null in OnnWayShare "
    ...
    const-string/jumbo v1, " can not have value both of toList and toMulti(Groupid) "
    ...
    const-string/jumbo v1, " toMulti(groupid) cannot be null or empty in FolderShare"
    ...
    const-string/jumbo v1, " toList have to be null or empty in FolderShare"
    ...
    const-string/jumbo v1, " cannot be null or empty in CloudShare"
    ...
    const-string/jumbo v1, " toList have to be null or empty in CloutShare"
    ...
    const-string/jumbo v2, " sharetype have to be defined( 0 - 3 ) this is "
    ...
    const-string/jumbo v1, "Max receiver number is 100"
    ...
    const-string/jumbo v1, "Contents is null or empty list"
