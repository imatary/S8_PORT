...
.method public compareTo(Lcom/android/volley/Request;)I
    ...
    iget-object v2, p0, Lcom/samsung/android/sdk/ssf/common/model/CommonRequest;->mPriorityInt:Ljava/lang/Integer;
    ...
    :goto_0
    instance-of v2, p1, Lcom/samsung/android/sdk/ssf/common/model/CommonRequest;

    if-eqz v2, :cond_1

    move-object v2, p1

    check-cast v2, Lcom/samsung/android/sdk/ssf/common/model/CommonRequest;

    invoke-virtual {v2}, Lcom/samsung/android/sdk/ssf/common/model/CommonRequest;->getPriorityInt()Ljava/lang/Integer;
...
.method public deliverProgress(IJ)V
    ...
    const-string/jumbo v0, "progress bytes %,d what = %d"
