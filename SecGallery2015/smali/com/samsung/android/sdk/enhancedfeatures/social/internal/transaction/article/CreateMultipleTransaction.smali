...
.method public start()V
    ...
    check-cast v8, Lcom/samsung/android/sdk/enhancedfeatures/social/apis/request/article/CreateArticleRequest;

    new-instance v7, Lcom/samsung/android/sdk/ssf/social/io/ArticleInfoRequest;

    invoke-direct {v7}, Lcom/samsung/android/sdk/ssf/social/io/ArticleInfoRequest;-><init>()V

    invoke-virtual {v8}, Lcom/samsung/android/sdk/enhancedfeatures/social/apis/request/article/CreateArticleRequest;->getName()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v7, v2}, Lcom/samsung/android/sdk/ssf/social/io/ArticleInfoRequest;->setName(Ljava/lang/String;)V

    invoke-virtual {v8}, Lcom/samsung/android/sdk/enhancedfeatures/social/apis/request/article/CreateArticleRequest;->getPermissionSetId()I

    move-result v2

    invoke-virtual {v7, v2}, Lcom/samsung/android/sdk/ssf/social/io/ArticleInfoRequest;->setPermissionSetId(I)V

    invoke-virtual {v8}, Lcom/samsung/android/sdk/enhancedfeatures/social/apis/request/article/CreateArticleRequest;->getDescription()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v7, v2}, Lcom/samsung/android/sdk/ssf/social/io/ArticleInfoRequest;->setDescription(Ljava/lang/String;)V

    invoke-virtual {v8}, Lcom/samsung/android/sdk/enhancedfeatures/social/apis/request/article/CreateArticleRequest;->getPushNotification()Ljava/lang/Boolean;

    move-result-object v2

    invoke-virtual {v7, v2}, Lcom/samsung/android/sdk/ssf/social/io/ArticleInfoRequest;->setPushNotification(Ljava/lang/Boolean;)V

    invoke-virtual {v8}, Lcom/samsung/android/sdk/enhancedfeatures/social/apis/request/article/CreateArticleRequest;->getMetaData()Lcom/samsung/android/sdk/enhancedfeatures/social/apis/request/MetaDataRequest;

    move-result-object v2

    if-eqz v2, :cond_0

    new-instance v10, Lcom/samsung/android/sdk/ssf/social/io/MetaData;

    invoke-direct {v10}, Lcom/samsung/android/sdk/ssf/social/io/MetaData;-><init>()V
    ...
    invoke-virtual {v10, v2}, Lcom/samsung/android/sdk/ssf/social/io/MetaData;->setValue(Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v2}, Lcom/samsung/android/sdk/ssf/social/io/MetaData;->setMetaKey(Ljava/lang/String;)V

    invoke-virtual {v7, v10}, Lcom/samsung/android/sdk/ssf/social/io/ArticleInfoRequest;->setMetaData(Lcom/samsung/android/sdk/ssf/social/io/MetaData;)V

    :cond_0
    invoke-virtual {v8}, Lcom/samsung/android/sdk/enhancedfeatures/social/apis/request/article/CreateArticleRequest;->getMetaCounter()Lcom/samsung/android/sdk/enhancedfeatures/social/apis/request/MetaCounterRequest;

    move-result-object v2

    if-eqz v2, :cond_1

    new-instance v9, Lcom/samsung/android/sdk/ssf/social/io/MetaCounter;

    invoke-direct {v9}, Lcom/samsung/android/sdk/ssf/social/io/MetaCounter;-><init>()V
    ...
    invoke-virtual {v9, v2}, Lcom/samsung/android/sdk/ssf/social/io/MetaCounter;->setMetaKey(Ljava/lang/String;)V
    ...
    invoke-virtual {v9, v2}, Lcom/samsung/android/sdk/ssf/social/io/MetaCounter;->setValue(I)V
    ...
    invoke-virtual {v9, v2}, Lcom/samsung/android/sdk/ssf/social/io/MetaCounter;->setOnlyOnce(Z)V

    invoke-virtual {v7, v9}, Lcom/samsung/android/sdk/ssf/social/io/ArticleInfoRequest;->setMetaCounter(Lcom/samsung/android/sdk/ssf/social/io/MetaCounter;)V
    ...
    :cond_2
    invoke-virtual {v1, v6}, Lcom/samsung/android/sdk/ssf/social/io/ArticlesInfoRequest;->setArticles(Ljava/util/List;)V
