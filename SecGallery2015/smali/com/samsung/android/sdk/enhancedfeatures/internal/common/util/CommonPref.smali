...
.method public static checkInitialDeviceId(Landroid/content/Context;)V
    ...
    invoke-static {v3, v4}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v1}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->putString(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3, v0}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->putString(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v4, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->TAG:Ljava/lang/String;
...
.method private static checkSecurelyEncrypted()Z
    ...
    const-string/jumbo v0, "crypto_secured"
...
.method public static declared-synchronized contains(Ljava/lang/String;)Z
    ...
    const-class v5, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;
    ...
    :cond_1
    :try_start_0
    sget-object v6, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->sCtx:Landroid/content/Context;

    const-string/jumbo v7, "coreapps_pref"
    ...
    invoke-static {p0, v6}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->isEncryptKey(Ljava/lang/String;Ljava/lang/String;)Z
    :try_end_0
...
.method private static convertInsecureKey(Landroid/content/SharedPreferences;Ljava/lang/String;)V
    ...
    const-string/jumbo v5, "convertInsecureKeys. convert "
    ...
    sget-object v5, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->TAG:Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/AESCryptoV02;->convertData(Ljava/lang/String;)Ljava/lang/String;
...
.method private static convertInsecureKeys(Landroid/content/Context;)V
    ...
    const-string/jumbo v1, "convertInsecureKeys. convert all "
    ...
    const-string/jumbo v1, "coreapps_pref"
    ...
    const-string/jumbo v1, "gcm_regId"
    ...
    const-string/jumbo v1, "spp_regId"
    ...
    const-string/jumbo v1, "esu_imsi"
    ...
    const-string/jumbo v2, "crypto_secured"
...
.method public static declared-synchronized getBoolean(Ljava/lang/String;Ljava/lang/Boolean;)Z
    ...
    const-string/jumbo v4, "coreapps_pref"
...
.method public static getDeviceId()Ljava/lang/String;
    ...
    const-class v2, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;

    monitor-enter v2

    :try_start_0
    sget-object v1, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->sCtx:Landroid/content/Context;

    invoke-static {v1}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->checkInitialDeviceId(Landroid/content/Context;)V

    const-string/jumbo v1, "device_id"

    const/4 v3, 0x0

    invoke-static {v1, v3}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v3}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/SDKLog;->d(Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v1, "device_based_seed"

    invoke-static {v1}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->contains(Ljava/lang/String;)Z
    ...
    invoke-static {v1}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->setPrefDeviceBasedSeed(Ljava/lang/String;)V
...
.method public static getGcmRegId()Ljava/lang/String;
    ...
    :cond_0
    const-string/jumbo v0, "gcm_regId"
    ...
    const-string/jumbo v1, "getGcmRegId = "
...
.method public static declared-synchronized getInt(Ljava/lang/String;Ljava/lang/Integer;)I
    ...
    const-string/jumbo v3, "coreapps_pref"
...
.method public static getPrefDeviceBasedSeed()Ljava/lang/String;
    ...
    const-string/jumbo v0, "device_based_seed"
...
.method public static getSppRegId()Ljava/lang/String;
    ...
    :cond_0
    const-string/jumbo v0, "spp_regId"
    ...
    const-string/jumbo v1, "getSppRegId = "
...
.method public static declared-synchronized getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-class v7, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;
    ...
    const-string/jumbo v8, "coreapps_pref"
    ...
    invoke-static {v4}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/AESCryptoV02;->decrypt(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_2
    const-string/jumbo v6, "Error occured while trying to get string from key"

    sget-object v8, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->TAG:Ljava/lang/String;

    invoke-static {v6, v8}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/SDKLog;->e(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public static declared-synchronized init(Landroid/content/Context;)V
    ...
    invoke-static {v2}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/SecureSHA1PRNGKeyDerivator;->deriveKeySecurely(Ljava/lang/String;)Ljavax/crypto/SecretKey;
    ...
    invoke-static {v2, v4}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->putString(Ljava/lang/String;Ljava/lang/String;)V
...
.method private static isEncryptKey(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string/jumbo v0, "esu_imsi"
    ...
    const-string/jumbo v1, "This is Encrypt Key : "
...
.method private static putBooleanInternal(Ljava/lang/String;Ljava/lang/Boolean;)V
    ...
    const-string/jumbo v2, "coreapps_pref"
...
.method public static declared-synchronized putString(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-class v4, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;
    ...
    invoke-static {v3, v5}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/SDKLog;->d(Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v3, "put"

    invoke-static {p0, v3}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->isEncryptKey(Ljava/lang/String;Ljava/lang/String;)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-static {v1, v2}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->putStringInternal(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2
...
.method public static remove(Ljava/lang/String;)V
    ...
    const-string/jumbo v4, "remove - key : "
    ...
    sget-object v3, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->sCtx:Landroid/content/Context;
