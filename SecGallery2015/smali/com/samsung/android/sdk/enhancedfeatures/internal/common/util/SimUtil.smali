...
.method public static getAccountIMSI(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string/jumbo v7, "0000000000000000"
    ...
    const-string/jumbo v3, "content://com.samsung.android.coreapps.easysignup"
...
.method public static getIMSI(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v1, v2}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->getBoolean(Ljava/lang/String;Ljava/lang/Boolean;)Z
    ...
    invoke-static {p0, v3}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/SimUtil;->getSubscriberId(Landroid/content/Context;I)Ljava/lang/String;
...
.method public static getImsiList(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    invoke-static {v5, v6}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->getBoolean(Ljava/lang/String;Ljava/lang/Boolean;)Z
    ...
    invoke-static {p0, v2}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/SimUtil;->getImsiUsingSlotId(Landroid/content/Context;I)Ljava/lang/String;
...
.method public static getImsiUsingSlotId(Landroid/content/Context;I)Ljava/lang/String;
    ...
    const-string/jumbo v2, "get x UsingSlotId("
...
.method static getSimMSISDN()Ljava/lang/String;
    ...
    const-string/jumbo v3, "getSimMSIS.. :"
...
.method public static getSimMSISDN(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v1}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/apiInterface/MultiSimManagerRef;->getLine1Number(Landroid/content/Context;I)Ljava/lang/String;
...
.method private static getSimOperator()Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/apiInterface/SystemPropertiesRef;->get(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v2, "CTC carrier case"
    ...
    const-string/jumbo v3, "getSimOperator(). simOperator:"
    ...
    :cond_1
    const-string/jumbo v2, "getSimOperator(). sim not ready"
...
.method private static getSimOperator(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/apiInterface/SystemPropertiesRef;->get(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v4}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/apiInterface/MultiSimManagerRef;->getSlotId(Landroid/content/Context;I)I
    ...
    const-string/jumbo v4, "sim operator array null"

    const-string/jumbo v5, "SimUtil"
    ...
    const-string/jumbo v4, "CTC carrier case"
    ...
    const-string/jumbo v5, "getSimOperator(). simOperator:"
    ...
    const-string/jumbo v5, "no sim operator for slotId("
    ...
    :cond_5
    invoke-static {p0, v3}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/apiInterface/MultiSimManagerRef;->getSimOperator(Landroid/content/Context;I)Ljava/lang/String;
...
.method public static getSubIdUsingImsi(Landroid/content/Context;Ljava/lang/String;)I
    ...
    invoke-static {p0, v5}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/apiInterface/MultiSimManagerRef;->getSubscriberId(Landroid/content/Context;I)Ljava/lang/String;
...
.method public static getSubscriberId(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {p0, v1}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/apiInterface/MultiSimManagerRef;->getSubscriberId(Landroid/content/Context;I)Ljava/lang/String;
    ...
    const-string/jumbo v5, "MultiSimManagerRef.getDefaultSubId("
    ...
    const-string/jumbo v5, "getSubscriberId - immsi = "
...
.method public static isReady(Landroid/content/Context;)Z
    ...
    const-string/jumbo v3, "is_anonymous"
    ...
    invoke-static {p0, v1}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/apiInterface/MultiSimManagerRef;->getSimState(Landroid/content/Context;I)I
    ...
    const-string/jumbo v4, "isReady - result : "
...
.method public static isSimAbsent(Landroid/content/Context;)Z
    ...
    const-string/jumbo v3, "isSimAbsent result = "
