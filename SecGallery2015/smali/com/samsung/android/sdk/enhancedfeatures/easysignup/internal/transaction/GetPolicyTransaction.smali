...
.method private checkPermission()Z
    ...
    :cond_1
    const-string/jumbo v0, "checkPermission. PERMISSION_DENIED "

    const-string/jumbo v1, "GetPolicyTransaction"
    ...
    const-string/jumbo v0, "last_policy_check_time"
...
.method private needGetPolicy()Z
    ...
    const-string/jumbo v5, "last_policy_check_time"

    invoke-static {v5, v6, v7}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/util/EPref;->getLong(Ljava/lang/String;J)J
    ...
    sget-wide v6, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/GetPolicyTransaction;->GET_POLICY_INTERVAL:J
    ...
    const-string/jumbo v6, "needGetPolicy : "
    ...
    const-string/jumbo v6, "GetPolicyTransaction"
...
.method public static registerAlarm(Landroid/content/Context;J)V
    ...
    const-class v10, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/GetPolicyJob;
    ...
    invoke-virtual {v2, v6}, Landroid/app/job/JobScheduler;->schedule(Landroid/app/job/JobInfo;)I
    ...
    const-string/jumbo v7, "Policy Job scheduled.."
    ...
    const-string/jumbo v7, "GetPolicyTransaction"
...
.method public onCreate()V
    ...
    const-string/jumbo v2, "GetPolicyTransaction"
...
.method public onDestroy()V
    ...
    const-string/jumbo v1, "Wake lock is released "
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    iput-object v2, p0, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/GetPolicyTransaction;->mContext:Landroid/content/Context;
    ...
    invoke-static {v2, v4, v5}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/GetPolicyTransaction;->registerAlarm(Landroid/content/Context;J)V
    ...
    const-string/jumbo v2, "is_anonymous"
    ...
    invoke-static {v2, v3}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->getBoolean(Ljava/lang/String;Ljava/lang/Boolean;)Z
    ...
    :cond_4
    const-string/jumbo v2, "last_policy_check_time"

    const-wide/16 v4, 0x0

    invoke-static {v2, v4, v5}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/util/EPref;->getLong(Ljava/lang/String;J)J
    ...
    invoke-static {v2}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/GetPolicyTransaction;->cancel(Landroid/content/Context;)V
