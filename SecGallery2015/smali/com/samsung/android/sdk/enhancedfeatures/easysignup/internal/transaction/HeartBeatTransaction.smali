...
.method public static cancel(Landroid/content/Context;)V
    ...
    sget-object v3, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/HeartBeatTransaction;->TAG:Ljava/lang/String;
...
.method private checkPermission()V
    ...
    invoke-static {v1}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/util/EPref;->init(Landroid/content/Context;)V

    iget-object v1, p0, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/HeartBeatTransaction;->mContext:Landroid/content/Context;

    sget-object v2, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/HeartBeatTransaction;->READ_PHONE_STATE:[Ljava/lang/String;

    invoke-static {v1, v2}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/PermissionUtils;->checkPermission(Landroid/content/Context;[Ljava/lang/String;)Z
    ...
    sget-object v2, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/HeartBeatTransaction;->READ_PRIVILEGED_PHONE_STATE:[Ljava/lang/String;
    ...
    :cond_0
    const-string/jumbo v1, "checkPermission. PERMISSION_GRANTED "
    ...
    :cond_1
    const-string/jumbo v1, "checkPermission. PERMISSION_DENIED "
    ...
    const-string/jumbo v4, "heart_beat_interval"
    ...
    invoke-static {v1, v2, v3}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/HeartBeatTransaction;->registerAlarm(Landroid/content/Context;J)V
...
.method private static getPendingIntent(Landroid/content/Context;)Landroid/app/PendingIntent;
    ...
    const-string/jumbo v1, "com.samsung.android.sdk.enhancedfeatures.easysignup.ACTION_HEART_BEAT"
...
.method public static registerAlarm(Landroid/content/Context;J)V
    ...
    sget-object v7, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/HeartBeatTransaction;->TAG:Ljava/lang/String;
    ...
    const-class v9, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/HeartBeatJob;
    ...
    invoke-virtual {v1, v10}, Landroid/app/job/JobInfo$Builder;->setPersisted(Z)Landroid/app/job/JobInfo$Builder;
    ...
    invoke-virtual {v4, v6}, Landroid/app/job/JobScheduler;->schedule(Landroid/app/job/JobInfo;)I
    ...
    const-string/jumbo v7, "Heart beat Job scheduled.."
    ...
    const-string/jumbo v7, "registerAlarm - time = "
    ...
    invoke-virtual {v0, v6, p1, p2, v7}, Landroid/app/AlarmManager;->set(IJLandroid/app/PendingIntent;)V
...
.method checkAvailableHearbeat()Z
    ...
    const-string/jumbo v6, "last_heart_beat_time"

    invoke-static {v6, v8, v9}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/util/EPref;->getLong(Ljava/lang/String;J)J
    ...
    const-string/jumbo v6, "heart_beat_interval"

    invoke-static {v6, v2, v3}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/util/EPref;->getLong(Ljava/lang/String;J)J
    ...
    iput-wide v6, p0, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/HeartBeatTransaction;->mInterval:J

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v7, "Heartbeat isn\'t available  for "
...
.method protected notifyResult()V
    ...
    iget-wide v4, p0, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/HeartBeatTransaction;->mInterval:J

    cmp-long v3, v4, v6

    if-ltz v3, :cond_4

    const-string/jumbo v3, "heartbeat is ok"

    sget-object v4, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/HeartBeatTransaction;->TAG:Ljava/lang/String;
    ...
    const-string/jumbo v3, "last_heart_beat_time"

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v4

    invoke-static {v3, v4, v5}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/util/EPref;->getLong(Ljava/lang/String;J)J
    ...
    const-string/jumbo v3, "heart_beat_interval"
    ...
    :cond_0
    iget-object v3, p0, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/HeartBeatTransaction;->mContext:Landroid/content/Context;

    const-string/jumbo v4, "heart_beat_interval"

    invoke-static {v4, v10, v11}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/util/EPref;->getLong(Ljava/lang/String;J)J

    move-result-wide v4

    add-long/2addr v4, v0

    invoke-static {v3, v4, v5}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/HeartBeatTransaction;->registerAlarm(Landroid/content/Context;J)V
    ...
    invoke-static {v4, v8, v9}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/util/EPref;->getLong(Ljava/lang/String;J)J
    ...
    :cond_4
    const-string/jumbo v3, "heartbeat is not ok"
...
.method public onCreate()V
    ...
    const-string/jumbo v0, "SERVICE CREATED"
    ...
    const-string/jumbo v1, "Wake lock is acquired "
...
.method public onDestroy()V
    ...
    const-string/jumbo v1, "Wake lock relesed "
...
.method protected startHeartBeat()V
    ...
    iget-object v5, p0, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/HeartBeatTransaction;->mContext:Landroid/content/Context;

    invoke-static {v5}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/PackageUtils;->disableComponents(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, v5}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/HeartBeatTransaction;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v5}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/SimUtil;->isImsiAvailable(Landroid/content/Context;)Z

    move-result v5

    if-nez v5, :cond_1

    const-string/jumbo v5, "No Sim Present.."

    sget-object v6, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/HeartBeatTransaction;->TAG:Ljava/lang/String;
    ...
    const-string/jumbo v5, "No Heartbeat time"
    ...
    invoke-static {v5}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/ConnectivityUtils;->isNetworkAvailable(Landroid/content/Context;)Z
    ...
    iput-wide v8, p0, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/HeartBeatTransaction;->mInterval:J

    iget-object v5, p0, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/HeartBeatTransaction;->mContext:Landroid/content/Context;

    invoke-static {v5}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/PackageUtils;->enableComponents(Landroid/content/Context;)V
    ...
    invoke-static {v5}, Lcom/samsung/android/sdk/enhancedfeatures/internal/EasySignUpInterface;->getDuid(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Lcom/samsung/android/sdk/ssf/account/io/AliveReqInfo$AliveParam;->setDeviceUniqueId(Ljava/lang/String;)V

    new-instance v4, Ljava/util/ArrayList;

    invoke-direct {v4}, Ljava/util/ArrayList;-><init>()V

    invoke-static {}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/PackageUtils;->getServiceID()I
    ...
    invoke-static {v4}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonUtils;->convertToIntArray(Ljava/util/List;)[I

    move-result-object v5

    invoke-virtual {v2, v5}, Lcom/samsung/android/sdk/ssf/account/io/AliveReqInfo$AliveParam;->setServiceIDs([I)V
    ...
    const-string/jumbo v6, "Heartbeat is available   sidList : "
    ...
    new-instance v5, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/accountinterface/EasySignUpServiceManager;

    invoke-direct {v5}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/accountinterface/EasySignUpServiceManager;-><init>()V

    const/16 v6, 0x82

    iget-object v7, p0, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/HeartBeatTransaction;->mSsfListener:Lcom/samsung/android/sdk/ssf/SsfListener;

    invoke-virtual {v5, v6, v3, v7}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/accountinterface/EasySignUpServiceManager;->heartBeat(ILjava/util/ArrayList;Lcom/samsung/android/sdk/ssf/SsfListener;)V

    goto/16 :goto_0

    :cond_4
    const-string/jumbo v5, "Device not authenticated..."
