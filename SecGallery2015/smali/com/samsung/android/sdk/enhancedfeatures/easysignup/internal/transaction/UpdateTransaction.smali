...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    const-string/jumbo v0, "UpdateTransaction"
...
.method private obtainEventMessage(Landroid/content/Intent;)V
    ...
    const-string/jumbo v0, "com.samsung.android.coreapps.easysignup.ACTION_JOIN"
    ...
    const-string/jumbo v0, "service_id_list"
...
.method private updateService()V
    ...
    new-instance v6, Lcom/samsung/android/sdk/ssf/account/io/PushInfo;
    ...
    invoke-direct {v6, v0, v1}, Lcom/samsung/android/sdk/ssf/account/io/PushInfo;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public onPushRegCompleted()V
    ...
    const-string/jumbo v0, "Got push tokens.."

    const-string/jumbo v1, "UpdateTransaction"
...
.method public onResponse(ILjava/lang/Object;Lcom/samsung/android/sdk/ssf/SsfResult;Ljava/lang/Object;)V
    ...
    const-string/jumbo v2, "UpdateTransaction"
    ...
    invoke-virtual {p0, v1, v3}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/UpdateTransaction;->notifyError(Lcom/samsung/android/sdk/enhancedfeatures/easysignup/apis/listener/BaseListener;I)V
    ...
    instance-of v1, p2, Lcom/samsung/android/sdk/ssf/account/io/UpdateResponse;

    if-eqz v1, :cond_0

    move-object v0, p2

    check-cast v0, Lcom/samsung/android/sdk/ssf/account/io/UpdateResponse;

    iget-object v1, p0, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/UpdateTransaction;->mImsi:Ljava/lang/String;

    invoke-virtual {v0}, Lcom/samsung/android/sdk/ssf/account/io/UpdateResponse;->getServicesInfo()[Lcom/samsung/android/sdk/ssf/account/io/ServiceInfo;

    move-result-object v2

    invoke-static {v1, v2}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/db/AccountDBMgr;->setJoinSIDs(Ljava/lang/String;[Lcom/samsung/android/sdk/ssf/account/io/ServiceInfo;)V

    const-string/jumbo v1, "Successfully updated Services"
    ...
    invoke-interface {v1, v4}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/apis/listener/EnhancedAccountListener;->onSuccess(Lcom/samsung/android/sdk/enhancedfeatures/easysignup/apis/response/EnhancedAccountResponseInfo;)V

    goto :goto_0

    :cond_0
    const-string/jumbo v1, "get OK but no response"
    ...
    invoke-virtual {p0, v1, v2}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/UpdateTransaction;->notifyError(Lcom/samsung/android/sdk/enhancedfeatures/easysignup/apis/listener/BaseListener;I)V
    ...
    const-string/jumbo v1, "Successfully updated GCM ID"

    const-string/jumbo v2, "UpdateTransaction"

    invoke-static {v1, v2}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/util/ELog;->d(Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v1, "gcm_registered_app_version"
    ...
    invoke-static {v1, v2}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->putInt(Ljava/lang/String;Ljava/lang/Integer;)V
    ...
    :cond_1
    const-string/jumbo v1, "Failed to update GCM ID"
    ...
    invoke-static {v1}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/JoinTransaction;->unregisterGcm(Landroid/content/Context;)V
...
.method public updateGCMID(Landroid/content/Intent;Lcom/samsung/android/sdk/enhancedfeatures/easysignup/apis/listener/EnhancedAccountListener;)V
    ...
    invoke-virtual {p0, v1}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/UpdateTransaction;->checkAuthentication(Ljava/lang/String;)I
    ...
    const-string/jumbo v2, "AuthErrorCode: "
    ...
    iget-boolean v1, p0, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/UpdateTransaction;->mUpdateService:Z
...
.method public updateState()V
    ...
    invoke-direct {v0, v3, v4}, Lcom/samsung/android/sdk/ssf/account/io/PushInfo;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-array v3, v3, [Lcom/samsung/android/sdk/ssf/account/io/PushInfo;

    invoke-virtual {v2, v3}, Ljava/util/ArrayList;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;

    move-result-object v1

    check-cast v1, [Lcom/samsung/android/sdk/ssf/account/io/PushInfo;

    new-instance v3, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/accountinterface/EasySignUpUserManager;

    invoke-direct {v3}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/accountinterface/EasySignUpUserManager;-><init>()V

    iget-object v4, p0, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/UpdateTransaction;->mImsi:Ljava/lang/String;

    const/16 v5, 0xbe

    invoke-virtual {v3, v4, v1, v5, p0}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/accountinterface/EasySignUpUserManager;->updateUser(Ljava/lang/String;[Lcom/samsung/android/sdk/ssf/account/io/PushInfo;ILcom/samsung/android/sdk/ssf/SsfListener;)V
