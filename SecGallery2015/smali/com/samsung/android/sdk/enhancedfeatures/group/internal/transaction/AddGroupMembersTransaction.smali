...
.method public start()V
    ...
    check-cast v8, Lcom/samsung/android/sdk/enhancedfeatures/group/apis/request/MemberRequest;

    new-instance v9, Lcom/samsung/android/sdk/ssf/group/io/MemberRequest;

    invoke-direct {v9}, Lcom/samsung/android/sdk/ssf/group/io/MemberRequest;-><init>()V

    invoke-virtual {v8}, Lcom/samsung/android/sdk/enhancedfeatures/group/apis/request/MemberRequest;->getId()Ljava/lang/String;

    move-result-object v1

    iput-object v1, v9, Lcom/samsung/android/sdk/ssf/group/io/MemberRequest;->id:Ljava/lang/String;

    invoke-virtual {v8}, Lcom/samsung/android/sdk/enhancedfeatures/group/apis/request/MemberRequest;->getOptionalId()Ljava/lang/String;

    move-result-object v1

    iput-object v1, v9, Lcom/samsung/android/sdk/ssf/group/io/MemberRequest;->optional_id:Ljava/lang/String;

    invoke-virtual {v8}, Lcom/samsung/android/sdk/enhancedfeatures/group/apis/request/MemberRequest;->getPermission()I

    move-result v1

    iput v1, v9, Lcom/samsung/android/sdk/ssf/group/io/MemberRequest;->permission:I
    ...
    :cond_0
    invoke-virtual {v4, v10}, Lcom/samsung/android/sdk/ssf/group/io/GroupListRequest;->setMembersList(Ljava/util/List;)V
