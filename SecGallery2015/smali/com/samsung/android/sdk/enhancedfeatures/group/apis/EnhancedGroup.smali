...
.method public static declared-synchronized getInstance(Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures;Ljava/lang/String;Ljava/lang/String;)Lcom/samsung/android/sdk/enhancedfeatures/group/apis/EnhancedGroup;
    ...
    const-string/jumbo v2, "EnhancedGroup is not available for anonymous type"
...
.method private isNotAuth(Lcom/samsung/android/sdk/enhancedfeatures/group/apis/listener/GroupListener;)Z
    ...
    const-string/jumbo v0, "Device was not authenticated."
...
.method public requestGroupPushInfo()V
    ...
    iget-object v2, p0, Lcom/samsung/android/sdk/enhancedfeatures/group/apis/EnhancedGroup;->mListener:Lcom/samsung/android/sdk/enhancedfeatures/group/apis/listener/EnhancedGroupPushListener;

    if-nez v2, :cond_1

    const-string/jumbo v2, "PushListener is not added!"

    sget-object v3, Lcom/samsung/android/sdk/enhancedfeatures/group/apis/EnhancedGroup;->TAG:Ljava/lang/String;

    invoke-static {v2, v3}, Lcom/samsung/android/sdk/enhancedfeatures/group/internal/util/GLog;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v2, Lcom/samsung/android/sdk/enhancedfeatures/group/apis/request/BaseRequest$Builder;

    invoke-direct {v2}, Lcom/samsung/android/sdk/enhancedfeatures/group/apis/request/BaseRequest$Builder;-><init>()V
    ...
    invoke-virtual {v2, v3}, Lcom/samsung/android/sdk/enhancedfeatures/group/apis/request/BaseRequest$Builder;->setReqId(I)Lcom/samsung/android/sdk/enhancedfeatures/group/apis/request/BaseRequest$Builder;

    move-result-object v2

    const/4 v3, 0x0

    invoke-virtual {v2, v3}, Lcom/samsung/android/sdk/enhancedfeatures/group/apis/request/BaseRequest$Builder;->setUserData(Ljava/lang/Object;)Lcom/samsung/android/sdk/enhancedfeatures/group/apis/request/BaseRequest$Builder;

    move-result-object v2

    invoke-virtual {v2}, Lcom/samsung/android/sdk/enhancedfeatures/group/apis/request/BaseRequest$Builder;->build()Lcom/samsung/android/sdk/enhancedfeatures/group/apis/request/BaseRequest;
