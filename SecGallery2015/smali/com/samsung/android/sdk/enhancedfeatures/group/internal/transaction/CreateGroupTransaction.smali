...
.method public start()V
    ...
    check-cast v6, Lcom/samsung/android/sdk/enhancedfeatures/group/apis/request/MemberRequest;

    if-eqz v6, :cond_0

    new-instance v7, Lcom/samsung/android/sdk/ssf/group/io/MemberRequest;

    invoke-direct {v7}, Lcom/samsung/android/sdk/ssf/group/io/MemberRequest;-><init>()V

    invoke-virtual {v6}, Lcom/samsung/android/sdk/enhancedfeatures/group/apis/request/MemberRequest;->getId()Ljava/lang/String;

    move-result-object v1

    iput-object v1, v7, Lcom/samsung/android/sdk/ssf/group/io/MemberRequest;->id:Ljava/lang/String;

    invoke-virtual {v6}, Lcom/samsung/android/sdk/enhancedfeatures/group/apis/request/MemberRequest;->getOptionalId()Ljava/lang/String;

    move-result-object v1

    iput-object v1, v7, Lcom/samsung/android/sdk/ssf/group/io/MemberRequest;->optional_id:Ljava/lang/String;

    invoke-virtual {v6}, Lcom/samsung/android/sdk/enhancedfeatures/group/apis/request/MemberRequest;->getPermission()I

    move-result v1

    iput v1, v7, Lcom/samsung/android/sdk/ssf/group/io/MemberRequest;->permission:I
    ...
    :cond_1
    iput-object v8, v3, Lcom/samsung/android/sdk/ssf/group/io/GroupInfoRequest;->members:Ljava/util/List;
