...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v1, "recipient_indexes"
    ...
    const-string/jumbo v2, "content_count"
    ...
    const-string/jumbo v2, "content_status"
    ...
    const-string/jumbo v2, "duration_time"

    aput-object v2, v0, v1

    const/16 v1, 0xf

    const-string/jumbo v2, "silence_push"
    ...
    const-string/jumbo v1, "gcm_type"

    aput-object v1, v0, v3

    const-string/jumbo v1, "req_token"
...
.method public constructor <init>(Landroid/content/Context;JLcom/samsung/android/sdk/enhancedfeatures/rshare/apis/listener/UploadShareContentsListener;Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/TransactionMap;Landroid/os/PowerManager$WakeLock;Z)V
    ...
    iput-object v1, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mPref:Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/Pref;

    iput-boolean v5, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mPaused:Z

    iput v5, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mMediaSize:I

    iput v5, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mContentCount:I

    const-wide/16 v2, 0x0

    iput-wide v2, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mExpireDate:J

    iput-boolean v5, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mRestored:Z

    iput-object v4, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mTzStr:Ljava/lang/String;

    iput-object v4, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mShareApiId:Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mConnectionTimeout:Lcom/samsung/android/sdk/ssf/common/ConnectTimeout;

    iput-boolean v5, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->isGroupShare:Z

    iput v5, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mGCMType:I

    iput-boolean v5, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mSilencePush:Z

    new-instance v1, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction$1;

    invoke-direct {v1, p0}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction$1;-><init>(Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;)V

    iput-object v1, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mSsfListener:Lcom/samsung/android/sdk/ssf/SsfListener;
    ...
    iput-wide v2, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mTag:J
    :try_end_0
...
.method private getSharedItem(Landroid/database/Cursor;)Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/response/data/ShareItem;
    ...
    invoke-virtual {v0, v2}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/response/data/ShareItem;->setWebUrl(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/response/data/ShareItem;->setStatus(I)V
    ...
    invoke-virtual {v0, v2}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/response/data/ShareItem;->setFileName(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/response/data/ShareItem;->setLocalUrl(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/response/data/ShareItem;->setToken(Ljava/lang/String;)V
...
.method private markErrorOnMedia(I)V
    ...
    invoke-direct {p0, p1, v1}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->markErrorOnMedia(ILjava/lang/String;)V
...
.method private markErrorOnMedia(ILjava/lang/String;)V
    ...
    const-string/jumbo v0, "error_detail"
    ...
    iget-wide v8, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mMediaId:J
    ...
    const-string/jumbo v0, "Failed to share , r=%d, %s, tz=[%s] %s"
    ...
    iget-object v5, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mTzStr:Ljava/lang/String;

    aput-object v5, v1, v2

    const/4 v2, 0x3

    iget-object v5, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mShareApiId:Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/Pref;->getOrcaDuid()Ljava/lang/String;

    move-result-object v0

    invoke-static {v7, v0}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/RLog;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method private restoreQuota()V
    ...
    iget-boolean v1, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mRestored:Z
    ...
    :cond_1
    iput-boolean v11, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mRestored:Z
    ...
    iget v1, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mMediaSize:I
    ...
    sget-object v8, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->TAG:Ljava/lang/String;
...
.method private startWithoutDBQuery()V
    ...
    iput v3, v0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mGCMType:I

    sget-object v3, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mRequest:Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;

    invoke-virtual {v3}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;->getRequestToken()J

    move-result-wide v12

    move-object/from16 v0, p0

    iput-wide v12, v0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mReqToken:J

    sget-object v3, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mRequest:Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;

    invoke-virtual {v3}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;->getUploadDirectory()Ljava/lang/String;

    move-result-object v3

    move-object/from16 v0, p0

    iput-object v3, v0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mDirectory:Ljava/lang/String;

    sget-object v3, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mRequest:Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;

    invoke-virtual {v3}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;->getRecipientList()Ljava/util/ArrayList;

    move-result-object v20

    sget-object v3, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mRequest:Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;

    invoke-virtual {v3}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;->getGroupID()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;->getShareType()I
    ...
    sget-object v4, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->TAG:Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;->getMediaSize()I
    ...
    invoke-virtual {v3}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;->getDescription()Ljava/lang/String;

    move-result-object v6

    sget-object v3, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mRequest:Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;

    invoke-virtual {v3}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;->getDurationTime()Ljava/lang/String;

    move-result-object v9

    sget-object v3, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mRequest:Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;

    invoke-virtual {v3}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;->getContentCount()I

    move-result v3

    move-object/from16 v0, p0

    iput v3, v0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mContentCount:I

    sget-object v3, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mRequest:Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;

    invoke-virtual {v3}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;->getAppName()Ljava/lang/String;

    move-result-object v3

    move-object/from16 v0, p0

    iput-object v3, v0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mApp:Ljava/lang/String;

    sget-object v3, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mRequest:Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;

    invoke-virtual {v3}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;->isSilencePush()Z

    move-result v3

    move-object/from16 v0, p0

    iput-boolean v3, v0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mSilencePush:Z

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mUploadShareContentsResponse:Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/response/UploadShareContentsResponse;

    sget-object v4, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mRequest:Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;

    invoke-virtual {v4}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;->getShareItems()Ljava/util/ArrayList;
    ...
    invoke-virtual {v3}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/request/ShareRequest;->getContentItems()Ljava/util/ArrayList;
    ...
    check-cast v19, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/response/data/ContentItem;

    new-instance v18, Lcom/samsung/android/sdk/ssf/share/io/ContentForShare;

    invoke-virtual/range {v19 .. v19}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/response/data/ContentItem;->getOriginal()Ljava/lang/String;

    move-result-object v4

    invoke-virtual/range {v19 .. v19}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/apis/response/data/ContentItem;->getContentType()Ljava/lang/String;

    move-result-object v10

    move-object/from16 v0, v18

    invoke-direct {v0, v4, v10}, Lcom/samsung/android/sdk/ssf/share/io/ContentForShare;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-boolean v3, v0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->isGroupShare:Z
    ...
    iget-object v4, v0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mApp:Ljava/lang/String;
    ...
    iget-object v3, v0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mPref:Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/Pref;

    invoke-virtual {v3}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/Pref;->generateTdkApiId()Ljava/lang/String;

    move-result-object v3

    move-object/from16 v0, p0

    iput-object v3, v0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mShareApiId:Ljava/lang/String;

    new-instance v21, Lcom/samsung/android/sdk/ssf/share/io/GenerateShareContentsRequest;

    invoke-direct/range {v21 .. v21}, Lcom/samsung/android/sdk/ssf/share/io/GenerateShareContentsRequest;-><init>()V
    ...
    iget-object v3, v0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mSsfListener:Lcom/samsung/android/sdk/ssf/SsfListener;
    ...
    iget v3, v0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mGCMType:I

    move-object/from16 v0, p0

    invoke-direct {v0, v3}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->getGCMValue(I)Ljava/lang/String;
    ...
    iget-wide v12, v0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mTag:J
    ...
    iget-object v3, v0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mConnectionTimeout:Lcom/samsung/android/sdk/ssf/common/ConnectTimeout;
    ...
    iget-boolean v3, v0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mSilencePush:Z

    move-object/from16 v0, v21

    invoke-virtual {v0, v3}, Lcom/samsung/android/sdk/ssf/share/io/GenerateShareContentsRequest;->setSilencePush(Z)V

    invoke-static/range {v21 .. v21}, Lcom/samsung/android/sdk/ssf/share/ShareManager;->shareContents(Lcom/samsung/android/sdk/ssf/share/io/GenerateShareContentsRequest;)V

    :goto_3
    return-void

    :cond_3
    invoke-static/range {v20 .. v20}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/ContactUtil;->convertSharingListForServer(Ljava/util/ArrayList;)Ljava/util/List;
    ...
    const-string/jumbo v4, "Requested with wrong numbers"

    move-object/from16 v0, p0

    invoke-direct {v0, v3, v4}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->markErrorOnMedia(ILjava/lang/String;)V
    ...
    iget-object v12, v0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mApp:Ljava/lang/String;
...
.method private stopForcedWithoutPause(ILjava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mTrBusyMap:Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/TransactionMap;

    iget-wide v2, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mMediaId:J

    invoke-virtual {v1, v2, v3}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/util/TransactionMap;->remove(J)Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/Transaction;

    iget-object v1, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    const-string/jumbo v1, "[WakeLock] release pm lock"
...
.method public start()V
    ...
    new-instance v0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction$QueryHandler;

    iget-object v1, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mContext:Landroid/content/Context;

    invoke-virtual {v1}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction$QueryHandler;-><init>(Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;Landroid/content/ContentResolver;)V

    iput-object v0, p0, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction;->mQueryHandler:Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/transaction/ShareTransaction$QueryHandler;
    ...
    const-string/jumbo v1, "Failed to get timezone info"
...
.method public token2str(I)Ljava/lang/String;
    ...
    :sswitch_1
    const-string/jumbo v0, "TOKEN_GET_MEDIA_TO_SHARE"
    ...
    :sswitch_4
    const-string/jumbo v0, "TOKEN_MOVE_MEDIA_TO_SENT_BOX"
