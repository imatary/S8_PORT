...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    const-string/jumbo v0, "rshare.db"
...
.method private convertGroupInfoColumns(Ljava/util/List;)V
    ...
    :cond_1
    const-string/jumbo v2, "folder_ors_url"
...
.method private static copyShareDatabase()V
    ...
    sget-object v7, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/db/DBHelper;->mContext:Landroid/content/Context;

    const-string/jumbo v8, "rshare.db"
    ...
    const-string/jumbo v8, "rshare_copy.db"
    ...
    const-string/jumbo v7, "db copy error exception."

    sget-object v8, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/db/DBHelper;->TAG:Ljava/lang/String;
...
.method private createChunkTable(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string/jumbo v2, "chunk_status"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v2, " INTEGER NOT NULL DEFAULT -1, "
...
.method private createContentTable(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string/jumbo v2, "thumbnail_small_uri"
    ...
    const-string/jumbo v2, " INTEGER NOT NULL DEFAULT 0,"
...
.method private createContentTriggers(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string/jumbo v0, "CREATE TRIGGER update_completed_content_count_on_update_content_complete AFTER UPDATE OF status ON content  WHEN new.status= 3 BEGIN     UPDATE media    SET complete_count=complete_count+1 WHERE _id=old.media_id;END;"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "CREATE TRIGGER update_progress_on_update_content_progress AFTER UPDATE OF progress ON content  BEGIN     UPDATE media    SET media_progress=media_progress + (new.progress- old.progress)  WHERE _id=old.media_id;END;"
...
.method private createContentsView(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string/jumbo v2, "A._id AS _id"
    ...
    const-string/jumbo v2, "B._id AS media_id"
    ...
    const-string/jumbo v2, "B.status AS media_status"
    ...
    const-string/jumbo v2, "A.status AS content_status"
    ...
    const-string/jumbo v2, "recipient_indexes"
    ...
    const-string/jumbo v2, "media_box"
    ...
    const-string/jumbo v2, " AS A"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v2, " LEFT JOIN "
...
.method private createGroupInfoTable(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string/jumbo v2, "group_folder_token"
...
.method private createMediaTable(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string/jumbo v2, "sender_imsi"
    ...
    const-string/jumbo v2, " INTEGER DEFAULT 2,"
    ...
    const-string/jumbo v2, "gcm_type"
...
.method private createMediaTriggers(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string/jumbo v0, "CREATE TRIGGER delete_contents_on_delete_media AFTER DELETE ON media BEGIN    DELETE FROM content   WHERE media_id=old._id;END;"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "CREATE TRIGGER update_chunks_on_cancel_media AFTER UPDATE OF status ON media  WHEN new.status= 201 BEGIN     UPDATE content    SET status=0 WHERE media_id=old._id;END;"
...
.method private createQuotaTable(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string/jumbo v2, "byte_sending"
...
.method private createSettingGlobalTable(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string/jumbo v2, " TEXT UNIQUE ON CONFLICT REPLACE,"
    ...
    const-string/jumbo v1, "CREATE INDEX globalIndex1 ON global (name);"
...
.method private dropTables(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string/jumbo v0, "DROP TABLE IF EXISTS send_result"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "DROP TABLE IF EXISTS block"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "DROP TABLE IF EXISTS recent_share_contacts"
    ...
    const-string/jumbo v0, "DROP TABLE IF EXISTS content"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "DROP TABLE IF EXISTS chunk"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "DROP VIEW IF EXISTS view_contents"
...
.method private insertInitialSettingGlobalValue(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string/jumbo v21, "setting_file_noti_screen_on"
    ...
    const-string/jumbo v21, "setting_file_noti_screen_off"
    ...
    const-string/jumbo v21, "setting_rshare_noti_sound"
    ...
    const-string/jumbo v21, "setting_rshare_noti_vibrate"
    ...
    const-string/jumbo v21, "setting_rshare_noti_led"
    ...
    const-string/jumbo v21, "setting_send_via_mms"
    ...
    const-string/jumbo v21, "feature_debug_mode"
    ...
    sget-boolean v21, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/Feature;->sUseDebugMode:Z
    ...
    const-string/jumbo v21, "feature_first_chunk_enabled"
    ...
    sget-boolean v21, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/Feature;->sFirstSmallChunkEnabled:Z
    ...
    const-string/jumbo v21, "feature_multi_download"
    ...
    sget-boolean v21, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/Feature;->sMultipleDownloadEnabled:Z
    ...
    const-string/jumbo v21, "feature_setting_permission_check"
    ...
    sget-boolean v21, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/Feature;->sEnableSettingPermissionCheck:Z
    ...
    const-string/jumbo v21, "feature_tdk_log_enabled"
    ...
    sget-boolean v21, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/Feature;->sTdkLogEnabled:Z
    ...
    const-string/jumbo v21, "chunk_size"
    ...
    const-string/jumbo v21, "multi_upload_size"
    ...
    sget v21, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/Config;->MULTI_UPLOAD_SIZE:I
    ...
    const-string/jumbo v21, "setting_noti_timestamp"
    ...
    const-string/jumbo v21, "setting_download_folder"
    ...
    const-string/jumbo v22, "Download"
...
.method private migrationGroupInfoTable(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string/jumbo v6, " INTEGER UNIQUE,"

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string/jumbo v6, "folder_token"

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string/jumbo v6, " TEXT UNIQUE,"
    ...
    const-string/jumbo v6, "ors_region_url"
    ...
    const-string/jumbo v5, "group_folder_token"

    invoke-direct {p0, v5, p1}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/db/DBHelper;->isExistTable(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase;)Z

    move-result v5

    if-eqz v5, :cond_0

    const-string/jumbo v5, "ALTER TABLE group_folder_token RENAME TO group_folder_token_backup;"

    invoke-virtual {p1, v5}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v5, "group_folder_token_backup"

    invoke-direct {p0, v5, p1}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/db/DBHelper;->getTableColumns(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/List;
    ...
    invoke-direct {p0, v4}, Lcom/samsung/android/sdk/enhancedfeatures/rshare/internal/db/DBHelper;->convertGroupInfoColumns(Ljava/util/List;)V
    ...
    const-string/jumbo v6, " FROM group_folder_token_backup"
    ...
    const-string/jumbo v5, "DROP TABLE group_folder_token_backup;"
...
.method private upgradeDatabase(ILandroid/database/sqlite/SQLiteDatabase;)V
    ...
    :try_start_0
    const-string/jumbo v0, "ALTER TABLE quota ADD COLUMN last_reset_time TEXT"
    ...
    const-string/jumbo v0, "ALTER TABLE quota ADD COLUMN uploaded_file_count INTEGER DEFAULT 0"
