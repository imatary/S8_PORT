...
.source "ContactAgentDbHelper.java"
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    const-string/jumbo v0, "contactagent.db"
...
.method private createContactsTable(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string/jumbo v0, "DROP TABLE IF EXISTS sync_raw_contacts;"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "DROP TABLE IF EXISTS sync_data;"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "CREATE TABLE contacts ( contacts_id INTEGER, conatct_number TEXT NOT NULL, conatct_display_number TEXT, contacts_name TEXT, contacts_version INTEGER, contacts_starred INTEGER NOT NULL DEFAULT 0, UNIQUE (contacts_id) ON CONFLICT REPLACE )"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "CREATE TABLE profile ( _id  INTEGER,data_version  INTEGER, mimetype TEXT, data1 TEXT, data2 TEXT, data3 TEXT, data4 TEXT, data5 TEXT, data6 TEXT, data7 TEXT, data8 TEXT, data9 TEXT, data10 TEXT, data11 TEXT, data12 TEXT, data13 TEXT, data14 TEXT, data15 TEXT, UNIQUE (_id ) ON CONFLICT REPLACE)"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "CREATE TABLE sync_raw_contacts(_id INTEGER PRIMARY KEY, raw_contact_number TEXT NOT NULL, raw_contact_duid TEXT NOT NULL) "

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "CREATE TABLE sync_data ( _id INTEGER PRIMARY KEY, contact_id INTEGER, mimetype INTEGER, timestamp LONG NOT NULL DEFAULT 0, data1 TEXT, data2 TEXT, data3 TEXT, data4 TEXT, data5 TEXT, data6 TEXT, data7 TEXT, data8 TEXT, data9 TEXT, data10 TEXT, data11 TEXT, data12 TEXT, data13 TEXT, data14 TEXT, data15 TEXT) "
...
.method private upgradeDatabase(Landroid/database/sqlite/SQLiteDatabase;IZ)V
    ...
    const-string/jumbo v0, "----migrate Contact agent DB"
    ...
    const-string/jumbo v0, "DROP TABLE IF EXISTS contact_images;"
    ...
    const-string/jumbo v0, "ALTER TABLE profile ADD COLUMN data1"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "ALTER TABLE profile ADD COLUMN data2"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "ALTER TABLE profile ADD COLUMN data3"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "ALTER TABLE profile ADD COLUMN data4"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "ALTER TABLE profile ADD COLUMN data5"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "ALTER TABLE profile ADD COLUMN data6"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "ALTER TABLE profile ADD COLUMN data7"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "ALTER TABLE profile ADD COLUMN data8"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "ALTER TABLE profile ADD COLUMN data9"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "ALTER TABLE profile ADD COLUMN data10"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "ALTER TABLE profile ADD COLUMN data11"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "ALTER TABLE profile ADD COLUMN data12"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "ALTER TABLE profile ADD COLUMN data13"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "ALTER TABLE profile ADD COLUMN data14"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "ALTER TABLE profile ADD COLUMN data15"
    ...
    const-string/jumbo v0, "ALTER TABLE contacts ADD COLUMN conatct_display_number"
    ...
    const-string/jumbo v0, "ALTER TABLE sync_data ADD COLUMN timestamp"
