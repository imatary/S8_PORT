.class public Lcom/samsung/android/devicecog/gallery/viewstatehandler/SlideShowViewDCHandler;
.super Lcom/samsung/android/devicecog/gallery/viewstatehandler/ActivityStateDCHandler;
.source "SlideShowViewDCHandler.java"
...
.method public startCommand(Ljava/lang/String;Ljava/util/List;)V
    ...
    const-string/jumbo v0, "SlideShowViewDCH"
    ...
    sget v1, Lcom/sec/samsung/gallery/core/Event;->EVENT_DC_CMD_SLIDESHOW_RESUME:I

    invoke-virtual {v0, v1}, Lcom/sec/samsung/gallery/core/Event;->setType(I)Lcom/sec/samsung/gallery/core/Event;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/samsung/android/devicecog/gallery/viewstatehandler/SlideShowViewDCHandler;->notifyObservers(Ljava/lang/Object;)V

    return-void

    :pswitch_data_0
    .packed-switch -0x6e4d4bb3
        :pswitch_0
    .end packed-switch
