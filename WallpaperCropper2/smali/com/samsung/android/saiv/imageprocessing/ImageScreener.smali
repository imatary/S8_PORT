...
.method public getQualityFactorScores([BIII)Lcom/samsung/android/saiv/imageprocessing/ImageScreener$QualityFactorScores;
    ...
    new-instance v1, Lcom/samsung/android/saiv/imageprocessing/ImageScreener$QualityFactorScores;

    invoke-direct {v1, p0}, Lcom/samsung/android/saiv/imageprocessing/ImageScreener$QualityFactorScores;-><init>(Lcom/samsung/android/saiv/imageprocessing/ImageScreener;)V

    const/4 v0, 0x0

    aget v0, v8, v0

    iput v0, v1, Lcom/samsung/android/saiv/imageprocessing/ImageScreener$QualityFactorScores;->contrast:F

    const/16 v0, 0xa

    aget v0, v8, v0

    iput v0, v1, Lcom/samsung/android/saiv/imageprocessing/ImageScreener$QualityFactorScores;->brightnessMean:F
    ...
    iput v0, v1, Lcom/samsung/android/saiv/imageprocessing/ImageScreener$QualityFactorScores;->blur:F

    iget v0, v1, Lcom/samsung/android/saiv/imageprocessing/ImageScreener$QualityFactorScores;->blur:F

    iget v2, v1, Lcom/samsung/android/saiv/imageprocessing/ImageScreener$QualityFactorScores;->blur:F
    ...
    iput v0, v1, Lcom/samsung/android/saiv/imageprocessing/ImageScreener$QualityFactorScores;->motionBlur:F
    ...
    iput v0, v1, Lcom/samsung/android/saiv/imageprocessing/ImageScreener$QualityFactorScores;->outFocusBackground:F

    const-string/jumbo v0, "ImageScreening"

    new-instance v2, Ljava/lang/StringBuilder;

    const-string/jumbo v3, "rawFactors[FACTOR_BLURPER]"
    ...
    const-string/jumbo v3, "rawFactors[FACTOR_CROPBLURPER]"
    ...
    const-string/jumbo v3, "rawFactors[FACTOR_BLUREXTENT]"
    ...
    iget v0, v1, Lcom/samsung/android/saiv/imageprocessing/ImageScreener$QualityFactorScores;->outFocusBackground:F

    iget v2, v1, Lcom/samsung/android/saiv/imageprocessing/ImageScreener$QualityFactorScores;->outFocusBackground:F
    ...
    iput v0, v1, Lcom/samsung/android/saiv/imageprocessing/ImageScreener$QualityFactorScores;->overExposure:F

    const/4 v0, 0x4

    aget v0, v8, v0

    iput v0, v1, Lcom/samsung/android/saiv/imageprocessing/ImageScreener$QualityFactorScores;->underExposure:F

    const/4 v0, 0x5

    aget v0, v8, v0

    iput v0, v1, Lcom/samsung/android/saiv/imageprocessing/ImageScreener$QualityFactorScores;->featureNumber:F

    const/4 v0, 0x6

    aget v0, v8, v0

    iput v0, v1, Lcom/samsung/android/saiv/imageprocessing/ImageScreener$QualityFactorScores;->featurePointDistribution:F

    const/4 v0, 0x7

    aget v0, v8, v0

    iput v0, v1, Lcom/samsung/android/saiv/imageprocessing/ImageScreener$QualityFactorScores;->skylineIncline:F
    ...
    :goto_0
    iput-boolean v0, v1, Lcom/samsung/android/saiv/imageprocessing/ImageScreener$QualityFactorScores;->isLowQuality:Z

    const/16 v0, 0xd

    aget v0, v8, v0

    iput v0, v1, Lcom/samsung/android/saiv/imageprocessing/ImageScreener$QualityFactorScores;->totalQuality:F
...
.method public release()I
    ...
    invoke-direct {p0, v0, v1}, Lcom/samsung/android/saiv/imageprocessing/ImageScreener;->release(J)I
