...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v1, v0}, Lcom/android/keyguard/KeyguardWidgetFrame;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mGradientPaint:Landroid/graphics/Paint;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mLeftToRight:Z

    const/4 v0, 0x0

    iput v0, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mOverScrollAmount:F

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mForegroundRect:Landroid/graphics/Rect;

    iput v1, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mForegroundAlpha:I

    iput-boolean v1, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mIsSmall:Z

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mBackgroundAlphaMultiplier:F

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mBackgroundRect:Landroid/graphics/Rect;

    iput-boolean v1, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mWidgetLockedSmall:Z

    const/4 v0, -0x1

    iput v0, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mMaxChallengeTop:I

    new-instance v0, Lcom/android/keyguard/KeyguardWidgetFrame$1;

    invoke-direct {v0, p0}, Lcom/android/keyguard/KeyguardWidgetFrame$1;-><init>(Lcom/android/keyguard/KeyguardWidgetFrame;)V

    iput-object v0, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mUpdateMonitorCallbacks:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;

    new-instance v0, Lcom/android/keyguard/CheckLongPressHelper;

    invoke-direct {v0, p0}, Lcom/android/keyguard/CheckLongPressHelper;-><init>(Landroid/view/View;)V

    iput-object v0, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mLongPressHelper:Lcom/android/keyguard/CheckLongPressHelper;
    ...
    invoke-virtual {p0, v2, v2, v2, v2}, Lcom/android/keyguard/KeyguardWidgetFrame;->setPadding(IIII)V
    ...
    iput v1, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mFrameStrokeAdjustment:I

    sget v1, Lcom/android/keyguard/R$dimen;->kg_small_widget_height:I
    ...
    sget v1, Lcom/android/keyguard/R$drawable;->kg_widget_bg_padded:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    iput-object v1, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mBackgroundDrawable:Landroid/graphics/drawable/Drawable;

    sget v1, Lcom/android/keyguard/R$color;->kg_widget_pager_gradient:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getColor(I)I

    move-result v0

    iput v0, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mGradientColor:I

    iget-object v0, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mGradientPaint:Landroid/graphics/Paint;

    sget-object v1, Lcom/android/keyguard/KeyguardWidgetFrame;->sAddBlendMode:Landroid/graphics/PorterDuffXfermode;
...
.method public fadeFrame(Ljava/lang/Object;ZFI)V
    ...
    :goto_0
    iget-object v0, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mBgAlphaController:Ljava/lang/Object;

    if-ne v0, p1, :cond_2

    :cond_0
    iget-object v0, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mFrameFade:Landroid/animation/Animator;
    ...
    iput-object v0, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mFrameFade:Landroid/animation/Animator;
...
.method public hideFrame(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, v2, v0, v1}, Lcom/android/keyguard/KeyguardWidgetFrame;->fadeFrame(Ljava/lang/Object;ZFI)V
...
.method setIsHoveringOverDeleteDropTarget(Z)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/keyguard/KeyguardWidgetFrame;->announceForAccessibility(Ljava/lang/CharSequence;)V
...
.method setOverScrollAmount(FZ)V
    ...
    iget v0, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mOverScrollAmount:F
    ...
    iget-object v0, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mRightToLeftGradient:Landroid/graphics/LinearGradient;

    :goto_1
    iput-object v0, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mForegroundGradient:Landroid/graphics/LinearGradient;
    ...
    iput v0, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mForegroundAlpha:I
    ...
    :cond_1
    iget-object v0, p0, Lcom/android/keyguard/KeyguardWidgetFrame;->mLeftToRightGradient:Landroid/graphics/LinearGradient;
