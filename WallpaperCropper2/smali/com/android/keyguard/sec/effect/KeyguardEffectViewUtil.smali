...
.method private static checkWallpaperDrawableAndReturn(Landroid/content/Context;Landroid/graphics/drawable/BitmapDrawable;)Landroid/graphics/drawable/BitmapDrawable;
    ...
    :goto_0
    invoke-static {p0, v0}, Lcom/android/keyguard/sec/effect/KeyguardEffectViewUtil;->writeWallpaperInfoAndReturn(Landroid/content/Context;Landroid/graphics/drawable/BitmapDrawable;)Landroid/graphics/drawable/BitmapDrawable;
...
.method private static checkWhiteLockscreenWallpaper(Landroid/graphics/drawable/BitmapDrawable;)Z
    ...
    :cond_3
    invoke-virtual {v7, v5, v1}, Landroid/graphics/Bitmap;->getPixel(II)I
    ...
    :cond_8
    invoke-virtual {v7, v6, v1}, Landroid/graphics/Bitmap;->getPixel(II)I

    move-result v11

    invoke-static {v11, v8}, Landroid/graphics/Color;->colorToHSV(I[F)V
...
.method public static getCurrentWallpaper(Landroid/content/Context;)Landroid/graphics/drawable/BitmapDrawable;
    ...
    invoke-static {p0, v2}, Lcom/android/keyguard/sec/effect/KeyguardEffectViewUtil;->getCurrentWallpaper(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/drawable/BitmapDrawable;
    ...
    :cond_0
    const-string/jumbo v2, "KeyguardEffectViewUtil"

    const-string/jumbo v4, "checkWhiteLockscreenWallpaper() start"

    invoke-static {v2, v4}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-static {v3}, Lcom/android/keyguard/sec/effect/KeyguardEffectViewUtil;->checkWhiteLockscreenWallpaper(Landroid/graphics/drawable/BitmapDrawable;)Z

    move-result v4

    const-string/jumbo v2, "KeyguardEffectViewUtil"

    const-string/jumbo v5, "checkWhiteLockscreenWallpaper() end"
    ...
    :goto_2
    invoke-static {v2, v5, v0}, Landroid/provider/Settings$Global;->putInt(Landroid/content/ContentResolver;Ljava/lang/String;I)Z

    const-string/jumbo v0, "KeyguardEffectViewUtil"

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v2, "whiteLockscreenWallpaper : "
...
.method public static getCurrentWallpaper(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/drawable/BitmapDrawable;
    ...
    const-string/jumbo v1, "KeyguardEffectViewUtil"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v3, "getCurrentWallpaper() mWallpaperPath : "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    sget-object v3, Lcom/android/keyguard/sec/effect/KeyguardEffectViewUtil;->mWallpaperPath:Ljava/lang/String;
    ...
    :goto_0
    sget-object v0, Lcom/android/keyguard/sec/effect/KeyguardEffectViewUtil;->mWallpaperPath:Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/keyguard/sec/effect/KeyguardEffectViewUtil;->mWallpaperPath:Ljava/lang/String;
    ...
    :goto_2
    invoke-static {p0, v0}, Lcom/android/keyguard/sec/effect/KeyguardEffectViewUtil;->checkWallpaperDrawableAndReturn(Landroid/content/Context;Landroid/graphics/drawable/BitmapDrawable;)Landroid/graphics/drawable/BitmapDrawable;
    ...
    sput-object v1, Lcom/android/keyguard/sec/effect/KeyguardEffectViewUtil;->mWallpaperPath:Ljava/lang/String;
    ...
    sput v2, Lcom/android/keyguard/sec/effect/KeyguardEffectViewUtil;->mWallpaperType:I

    invoke-static {p0, v1}, Lcom/android/keyguard/sec/effect/KeyguardEffectViewUtil;->checkWallpaperDrawableAndReturn(Landroid/content/Context;Landroid/graphics/drawable/BitmapDrawable;)Landroid/graphics/drawable/BitmapDrawable;
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1
    ...
    const-string/jumbo v4, "Loading Admin wallpaper EX:"
    ...
    sput v5, Lcom/android/keyguard/sec/effect/KeyguardEffectViewUtil;->mWallpaperType:I
    ...
    :cond_7
    const-string/jumbo v0, "/data/data/com.sec.android.gallery3d/lockscreen_wallpaper.jpg"
...
.method public static getDefaultWallpaper(Landroid/content/Context;)Landroid/graphics/drawable/BitmapDrawable;
    ...
    const-string/jumbo v0, "//system/wallpaper/lockscreen_default_wallpaper.jpg"

    invoke-direct {v3, v0}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    new-instance v4, Ljava/io/File;

    const-string/jumbo v0, "//system/csc_contents/lockscreen_default_wallpaper.jpg"

    invoke-direct {v4, v0}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    new-instance v5, Ljava/io/File;

    const-string/jumbo v0, "//system/wallpaper/lockscreen_default_wallpaper.png"

    invoke-direct {v5, v0}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    new-instance v6, Ljava/io/File;

    const-string/jumbo v0, "//system/csc_contents/lockscreen_default_wallpaper.png"
    ...
    const-string/jumbo v3, "//system/csc_contents/lockscreen_default_wallpaper.png"
    ...
    sput-object v3, Lcom/android/keyguard/sec/effect/KeyguardEffectViewUtil;->mWallpaperPath:Ljava/lang/String;

    const/4 v3, 0x1

    sput v3, Lcom/android/keyguard/sec/effect/KeyguardEffectViewUtil;->mWallpaperType:I
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v3, "//system/csc_contents/lockscreen_default_wallpaper.jpg"
    ...
    const-string/jumbo v3, "//system/wallpaper/lockscreen_default_wallpaper.png"
    ...
    const-string/jumbo v3, "//system/wallpaper/lockscreen_default_wallpaper.jpg"
...
.method public static getPreferredConfigBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    const-string/jumbo v1, "start to convert album art"
...
.method public static isZoomPanningEffectEnabled(Landroid/content/Context;)Z
    ...
    const-string/jumbo v3, "lockscreen_zoom_panning_effect"
...
.method public static writeKeyguardCurrentWallpaperInfo(Landroid/content/Context;)V
    ...
    const-string/jumbo v1, "set current wallpaper info"
    ...
    const-string/jumbo v1, "keyguard_current_wallpaper_type"
    ...
    const-string/jumbo v1, "keyguard_current_wallpaper_file_path"
    ...
    const-string/jumbo v1, "keyguard_current_wallpaper_res_id"
...
.method public static writeKeyguardDefaultWallpaperResId(Landroid/content/Context;)V
    ...
    const-string/jumbo v1, "set resource id"
    ...
    const-string/jumbo v1, "keyguard_default_wallpaper_res_id"
