...
.field private mHelpTextCountdownTimer:Landroid/os/CountDownTimer;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean v2, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->mHelpTextEnabled:Z
    ...
    iput-boolean v1, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->isSupportMobileKeyboard:Z

    iput v1, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->mCurrentMobileKeyboard:I

    iput-object v6, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->mCountdownTimer:Landroid/os/CountDownTimer;

    iput-object v6, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->mHelpTextCountdownTimer:Landroid/os/CountDownTimer;
    ...
    invoke-direct {v0, p0, v3, v6, v2}, Lcom/android/keyguard/sec/KeyguardSPassUnlockView$4;-><init>(Lcom/android/keyguard/sec/KeyguardSPassUnlockView;Landroid/os/Looper;Landroid/os/Handler$Callback;Z)V

    iput-object v0, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->mHandler:Landroid/os/Handler;

    iput-boolean v2, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->mHasWindowFocus:Z
...
.method static synthetic access$600(Lcom/android/keyguard/sec/KeyguardSPassUnlockView;)V
    ...
    invoke-direct {p0}, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->handleShowFingerPrintInstruction()V
...
.method private handleShowAutoWipePopup()V
    ...
    const-string/jumbo v1, "handleShowAutoWipePopup()"
    ...
    const-string/jumbo v1, "KeyguardSPassUnlockView"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v3, "handleShowAutoWipePopup( attempt = "
    ...
    sget v3, Lcom/android/keyguard/R$string;->kg_failed_5_attempts_to_show_backup_password_with_auto_wipe:I
...
.method private handleShowBackupPasswordButton()V
    ...
    const-string/jumbo v1, "fade in backupView."
...
.method private handleShowErrorMessage(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "handleShowErrorMessage( errorMessage = "
    ...
    const-string/jumbo v1, "handleShowErrorMessage( mBackupPasswordButton )"
    ...
    invoke-virtual {v0, p1, v4, v3}, Landroid/speech/tts/TextToSpeech;->speak(Ljava/lang/String;ILjava/util/HashMap;)I
...
.method private handleShowErrorPopup(I)V
    ...
    const-string/jumbo v2, "handleShowErrorPopup( resid = "
    ...
    const-string/jumbo v2, ", Dialog is already showing. )"
...
.method private handleShowFingerPrintInstruction()V
    .locals 4
    ...
    :cond_3
    iget-boolean v0, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->mHelpTextEnabled:Z
    ...
    invoke-virtual {v0}, Lcom/android/keyguard/KeyguardUpdateMonitor;->isCoverState()Z
    ...
    const-string/jumbo v1, "handleShowFingerPrintInstruction( show finger pirnt instructions )"
    ...
    sget v2, Lcom/android/keyguard/R$string;->kg_fingerprints_instructions:I
...
.method private isDeviceDisabledForMaxFailedAttempt()Z
    ...
    const-string/jumbo v3, "KeyguardSPassUnlockView"
...
.method public checkTalkBackEnabled()V
    ...
    :cond_0
    const-string/jumbo v1, "(?i).*com.google.android.marvin.talkback.TalkBackService.*"

    invoke-virtual {v0, v1}, Ljava/lang/String;->matches(Ljava/lang/String;)Z

    move-result v0

    iput-boolean v0, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->mTalkbackEnabled:Z
...
.method public hideBouncer(I)V
    ...
    invoke-static {v3, v0, v1, p1}, Lcom/android/keyguard/KeyguardSecurityViewHelper;->hideBouncer(Lcom/android/keyguard/SecurityMessageDisplay;Landroid/view/View;Landroid/graphics/drawable/Drawable;I)V
...
.method protected onAttachedToWindow()V
    ...
    iget-object v2, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->mWhiteWallpaperObserver:Landroid/database/ContentObserver;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget v1, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->mCurrentMobileKeyboard:I
    ...
    :cond_2
    iget-boolean v1, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->isSupportMobileKeyboard:Z
...
.method protected onFinishInflate()V
    ...
    sget v0, Lcom/android/keyguard/R$id;->kg_spass_bouncer_status:I
    ...
    iput-object v0, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->mBouncerStatusText:Landroid/widget/TextView;
    ...
    :cond_0
    :goto_0
    sget v0, Lcom/android/keyguard/R$id;->kg_spass_backup_password:I
    ...
    sget v1, Lcom/android/keyguard/R$dimen;->kg_spass_unlock_animation_margin_bottom_attribution:I
    ...
    sget v1, Lcom/android/keyguard/R$dimen;->kg_spass_unlock_animation_margin_bottom_normal:I
    ...
    iput-object v0, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->mBouncerFrame:Landroid/graphics/drawable/Drawable;

    iget-object v0, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->mBouncerFrame:Landroid/graphics/drawable/Drawable;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->mTouchEnabled:Z
    ...
    const-string/jumbo v2, "onInterceptTouchEvent( ev.getActionMasked = "
...
.method public onPause()V
    ...
    :goto_2
    iget-object v0, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->mHelpTextCountdownTimer:Landroid/os/CountDownTimer;
    ...
    iput-object v2, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->mHelpTextCountdownTimer:Landroid/os/CountDownTimer;
...
.method public onResume(I)V
    ...
    const-string/jumbo v2, "KeyguardSPassUnlockView"
    ...
    iput-wide v0, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->mResumedTimeMillis:J
    ...
    invoke-virtual {p0, v2, v3}, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->handleAttemptLockoutForChina(J)V
    ...
    const-string/jumbo v2, "onResume(setPermanentlyLocked -- false)"
    ...
    invoke-static {v0, v1, v8, v9}, Landroid/provider/Settings$Global;->putLong(Landroid/content/ContentResolver;Ljava/lang/String;J)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/keyguard/sec/KeyguardSpassUnlockThread;->onResume(I)V
...
.method public onWindowFocusChanged(Z)V
    ...
    const-string/jumbo v1, "onWindowFocusChanged - loosing focus"
    ...
    const-string/jumbo v1, "onWindowFocusChanged - get focus"
...
.method public setAttributionViewEnabled(Z)V
    ...
    const-string/jumbo v2, "setAttributionViewEnabled( enable = "
...
.method public showAutoWipePopup()V
    ...
    const-string/jumbo v1, "showAutoWipePopup()"
...
.method public showErrorMessage(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "showErrorMessage( errorMessage = "
...
.method public showErrorPopup(I)V
    ...
    const-string/jumbo v2, "showErrorPopup( resid = "
...
.method public showHideBouncerKeyguardMessageArea(Z)V
    ...
    :cond_2
    iget-object v3, p0, Lcom/android/keyguard/sec/KeyguardSPassUnlockView;->mBouncerStatusText:Landroid/widget/TextView;
    ...
    sget v0, Lcom/android/keyguard/R$string;->kg_fingerprints_instructions:I
    ...
    :cond_5
    sget v0, Lcom/android/keyguard/R$string;->kg_fingerprints_instructions_with_mobile_keyboard:I
