...
.method private checkBackupPin(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/widget/LockPatternUtils;->checkBackupPin(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/widget/LockPatternUtils;->checkSignatureBackupPin(Ljava/lang/String;)Z
...
.method protected onDetachedFromWindow()V
    ...
    :cond_1
    const-string/jumbo v0, "KeyguardBackupPINView"

    const-string/jumbo v1, "mCallback is null"
    ...
    iput-object v2, p0, Lcom/android/keyguard/sec/KeyguardBackupPINView;->mFailedTextTimer:Landroid/os/CountDownTimer;
...
.method protected onFinishInflate()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/keyguard/sec/KeyguardBackupPINView;->findViewById(I)Landroid/view/View;

    move-result-object v0

    check-cast v0, Landroid/view/ViewGroup;

    iput-object v0, p0, Lcom/android/keyguard/sec/KeyguardBackupPINView;->mKeyguardBouncerFrame:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Lcom/android/keyguard/sec/KeyguardBackupPINView;->mRow0:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Lcom/android/keyguard/sec/KeyguardBackupPINView;->mRow1:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Lcom/android/keyguard/sec/KeyguardBackupPINView;->mRow2:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Lcom/android/keyguard/sec/KeyguardBackupPINView;->mRow3:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Lcom/android/keyguard/sec/KeyguardBackupPINView;->mDivider:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/keyguard/sec/KeyguardBackupPINView;->mPowerManager:Landroid/os/PowerManager;

    iget-object v0, p0, Lcom/android/keyguard/sec/KeyguardBackupPINView;->mPowerManager:Landroid/os/PowerManager;
    ...
    invoke-virtual {p0, v1}, Lcom/android/keyguard/sec/KeyguardBackupPINView;->findViewById(I)Landroid/view/View;
    ...
    invoke-direct {v2, v0}, Lcom/android/keyguard/KeyguardMessageArea$Helper;-><init>(Landroid/view/View;)V
...
.method protected resetState()V
    ...
    invoke-virtual {p0, v0, v3, v2}, Lcom/android/keyguard/sec/KeyguardBackupPINView;->setHintOrMessageText(Ljava/lang/CharSequence;ZI)V
...
.method protected verifyPasswordAndUnlock()V
    ...
    invoke-virtual {p0, v1, v0}, Lcom/android/keyguard/sec/KeyguardBackupPINView;->getFailedAttemptMessage(II)Ljava/lang/CharSequence;

    move-result-object v0

    invoke-virtual {p0, v0, v6}, Lcom/android/keyguard/sec/KeyguardBackupPINView;->setHintOrMessageText(Ljava/lang/CharSequence;Z)V

    :cond_3
    :goto_1
    invoke-virtual {p0, v6}, Lcom/android/keyguard/sec/KeyguardBackupPINView;->resetPasswordText(Z)V

    return-void

    :cond_4
    invoke-direct {p0, v1}, Lcom/android/keyguard/sec/KeyguardBackupPINView;->checkBackupPin(Ljava/lang/String;)Z
    ...
    :cond_5
    :goto_2
    iput-boolean v6, p0, Lcom/android/keyguard/sec/KeyguardBackupPINView;->mIsUnlockSuccess:Z
    ...
    iget-object v4, p0, Lcom/android/keyguard/sec/KeyguardBackupPINView;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    const-string/jumbo v2, "KeyguardBackupPINView"
    ...
    invoke-virtual {p0, v0, v6}, Lcom/android/keyguard/sec/KeyguardBackupPINView;->setHintOrMessageText(IZ)V
