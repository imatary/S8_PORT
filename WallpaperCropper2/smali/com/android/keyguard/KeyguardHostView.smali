...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    new-instance v0, Lcom/android/keyguard/KeyguardHostView$7;

    invoke-direct {v0, p0}, Lcom/android/keyguard/KeyguardHostView$7;-><init>(Lcom/android/keyguard/KeyguardHostView;)V
    ...
    iget v5, p0, Lcom/android/keyguard/KeyguardHostView;->mUserId:I

    invoke-direct {v4, v5}, Landroid/os/UserHandle;-><init>(I)V

    invoke-virtual {v0, v2, v3, v4}, Landroid/content/Context;->createPackageContextAsUser(Ljava/lang/String;ILandroid/os/UserHandle;)Landroid/content/Context;
    :try_end_0
    ...
    invoke-direct {v0, p1, v2, v3, v4}, Landroid/appwidget/AppWidgetHost;-><init>(Landroid/content/Context;ILandroid/widget/RemoteViews$OnClickHandler;Landroid/os/Looper;)V
    ...
    :cond_0
    const-string/jumbo v0, "KeyguardHostView"
    ...
    iput v2, p0, Lcom/android/keyguard/KeyguardHostView;->mDisabledFeatures:I
    ...
    const-string/jumbo v1, "Keyguard widgets disabled by safe mode"
    ...
    const-string/jumbo v1, "Keyguard widgets disabled by DPM"
    ...
    const-string/jumbo v1, "Keyguard secure camera disabled by DPM"
...
.method private addDefaultStatusWidget(I)V
    ...
    sget v1, Lcom/android/keyguard/R$layout;->keyguard_status_view:I
...
.method private addDefaultWidgets()V
    ...
    sget v1, Lcom/android/keyguard/R$layout;->keyguard_add_widget:I
    ...
    invoke-virtual {v1, v0, v2}, Lcom/android/keyguard/KeyguardWidgetPager;->addWidget(Landroid/view/View;I)V

    sget v1, Lcom/android/keyguard/R$id;->keyguard_add_widget_view:I

    invoke-virtual {v0, v1}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v0

    new-instance v1, Lcom/android/keyguard/KeyguardHostView$5;

    invoke-direct {v1, p0}, Lcom/android/keyguard/KeyguardHostView$5;-><init>(Lcom/android/keyguard/KeyguardHostView;)V
    ...
    sget v1, Lcom/android/keyguard/R$bool;->kg_enable_camera_default_widget:I
...
.method private addWidget(IIZ)Z
    ...
    const-string/jumbo v2, "*** AppWidgetInfo for app widget id "
    ...
    const-string/jumbo v2, "  was null for user"
...
.method private addWidgetsFromSettings()V
    ...
    const-string/jumbo v1, "Problem reading widgets"
...
.method private allocateIdForDefaultAppWidget()I
    ...
    sget v1, Lcom/android/keyguard/R$string;->widget_default_package_name:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v1

    sget v3, Lcom/android/keyguard/R$string;->widget_default_class_name:I
    ...
    const-string/jumbo v4, "Error when trying to bind default AppWidget: "
...
.method private cameraDisabledByDpm()Z
    ...
    iget-boolean v1, p0, Lcom/android/keyguard/KeyguardHostView;->mCameraDisabled:Z
    ...
    :cond_1
    iget v1, p0, Lcom/android/keyguard/KeyguardHostView;->mDisabledFeatures:I
...
.method private cleanupAppWidgetIds()V
    ...
    invoke-virtual {v1}, Lcom/android/internal/widget/LockPatternUtils;->getAppWidgets()[I
    ...
    invoke-static {v1, v3}, Lcom/android/keyguard/KeyguardHostView;->contains([II)Z
    ...
    invoke-virtual {v4, v3}, Landroid/appwidget/AppWidgetHost;->deleteAppWidgetId(I)V
...
.method private enableUserSelectorIfNecessary()V
    ...
    sget v1, Lcom/android/keyguard/R$id;->keyguard_user_selector:I
    ...
    instance-of v2, v1, Lcom/android/keyguard/KeyguardMultiUserSelectorView;
    ...
    const-string/jumbo v2, "user_selector is the wrong type."
    ...
    const-string/jumbo v1, "MDM blocks multiuser mode"
    ...
    const-string/jumbo v2, "user service is null."
    ...
    const-string/jumbo v1, "can\'t find user_selector in layout."
    ...
    invoke-virtual {v1, v3}, Lcom/android/keyguard/KeyguardMultiUserSelectorView;->setVisibility(I)V
    ...
    invoke-virtual {v1, v0}, Lcom/android/keyguard/KeyguardMultiUserSelectorView;->addUsers(Ljava/util/Collection;)V
    ...
    invoke-virtual {v1, v0}, Lcom/android/keyguard/KeyguardMultiUserSelectorView;->setCallback(Lcom/android/keyguard/KeyguardHostView$UserSwitcherCallback;)V
    ...
    const-string/jumbo v2, "could not find the user_selector."
...
.method private ensureTransportPresentOrRemoved(I)Z
    ...
    const-string/jumbo v4, "add transport at "
    ...
    const-string/jumbo v2, "remove transport"
...
.method private getAppropriateWidgetPage(I)I
    ...
    invoke-virtual {v0, v1}, Lcom/android/keyguard/KeyguardWidgetPager;->getWidgetPageIndex(Landroid/view/View;)I
    ...
    const-string/jumbo v1, "Music playing, show transport"
    ...
    const-string/jumbo v3, "Show right-most page "
...
.method private getDisabledFeatures(Landroid/app/admin/DevicePolicyManager;)I
    ...
    invoke-virtual {p1, v1, v0}, Landroid/app/admin/DevicePolicyManager;->getKeyguardDisabledFeatures(Landroid/content/ComponentName;I)I
...
.method private getInitialTransportState()V
    ...
    iget-boolean v2, v1, Lcom/android/keyguard/KeyguardUpdateMonitor$DisplayClientState;->clearing:Z

    if-nez v2, :cond_0

    iget v0, v1, Lcom/android/keyguard/KeyguardUpdateMonitor$DisplayClientState;->playbackState:I

    invoke-static {v0}, Lcom/android/keyguard/KeyguardHostView;->isMusicPlaying(I)Z
    ...
    iget v1, v1, Lcom/android/keyguard/KeyguardUpdateMonitor$DisplayClientState;->playbackState:I
...
.method private getInsertPageIndex()I
    ...
    invoke-virtual {v1, v2}, Lcom/android/keyguard/KeyguardWidgetPager;->findViewById(I)Landroid/view/View;

    move-result-object v1

    iget-object v2, p0, Lcom/android/keyguard/KeyguardHostView;->mAppWidgetContainer:Lcom/android/keyguard/KeyguardWidgetPager;

    invoke-virtual {v2, v1}, Lcom/android/keyguard/KeyguardWidgetPager;->indexOfChild(Landroid/view/View;)I
...
.method private getOrCreateTransportControl()Lcom/android/keyguard/KeyguardTransportControlView;
    ...
    new-instance v1, Lcom/android/keyguard/KeyguardHostView$6;

    invoke-direct {v1, p0}, Lcom/android/keyguard/KeyguardHostView$6;-><init>(Lcom/android/keyguard/KeyguardHostView;)V

    invoke-virtual {v0, v1}, Lcom/android/keyguard/KeyguardTransportControlView;->setTransportControlCallback(Lcom/android/keyguard/KeyguardHostView$TransportControlCallback;)V
...
.method private getWidgetPosition(I)I
    ...
    :cond_0
    invoke-virtual {v1, v0}, Lcom/android/keyguard/KeyguardWidgetPager;->getWidgetPageAt(I)Lcom/android/keyguard/KeyguardWidgetFrame;
    ...
    const-string/jumbo v5, "*** Null content at i="
...
.method private setInsets(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Lcom/android/keyguard/KeyguardHostView;->mInsets:Landroid/graphics/Rect;
    ...
    invoke-virtual {v0, v1}, Lcom/android/keyguard/SlidingChallengeLayout;->setInsets(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/keyguard/MultiPaneChallengeLayout;->setInsets(Landroid/graphics/Rect;)V
...
.method private shouldEnableAddWidget()Z
    ...
    :cond_1
    iget-boolean v1, p0, Lcom/android/keyguard/KeyguardHostView;->mUserSetupCompleted:Z
...
.method private showAppropriateWidgetPage()V
    ...
    invoke-direct {p0, v0}, Lcom/android/keyguard/KeyguardHostView;->ensureTransportPresentOrRemoved(I)Z

    move-result v1

    invoke-direct {p0, v0}, Lcom/android/keyguard/KeyguardHostView;->getAppropriateWidgetPage(I)I
    ...
    invoke-virtual {v0, v2}, Lcom/android/keyguard/KeyguardWidgetPager;->setCurrentPage(I)V
    ...
    invoke-direct {v0, p0, v2}, Lcom/android/keyguard/KeyguardHostView$8;-><init>(Lcom/android/keyguard/KeyguardHostView;I)V
...
.method public checkAppWidgetConsistency()V
    ...
    invoke-virtual {v4, v0}, Lcom/android/keyguard/KeyguardWidgetPager;->isWidgetPage(I)Z
    ...
    invoke-virtual {v1, v4}, Lcom/android/keyguard/KeyguardWidgetPager;->getChildAt(I)Landroid/view/View;

    move-result-object v1

    invoke-virtual {v0, v1, v4}, Lcom/android/keyguard/KeyguardWidgetPager;->onAddView(Landroid/view/View;I)V
    ...
    invoke-virtual {v2}, Lcom/android/internal/widget/LockPatternUtils;->getFallbackAppWidgetId()I
    ...
    invoke-direct {p0, v3, v4, v1}, Lcom/android/keyguard/KeyguardHostView;->addWidget(IIZ)Z
    ...
    invoke-direct {p0, v3, v4, v2}, Lcom/android/keyguard/KeyguardHostView;->addWidget(IIZ)Z
    ...
    invoke-virtual {v3, v2}, Lcom/android/internal/widget/LockPatternUtils;->writeFallbackAppWidgetId(I)V

    goto :goto_6

    :cond_a
    iget-object v5, p0, Lcom/android/keyguard/KeyguardHostView;->mAppWidgetHost:Landroid/appwidget/AppWidgetHost;

    invoke-virtual {v5, v3}, Landroid/appwidget/AppWidgetHost;->deleteAppWidgetId(I)V

    iget-object v3, p0, Lcom/android/keyguard/KeyguardHostView;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    invoke-virtual {v3, v1}, Lcom/android/internal/widget/LockPatternUtils;->writeFallbackAppWidgetId(I)V
...
.method public cleanUp()V
    ...
    invoke-virtual {v2, v0}, Lcom/android/keyguard/KeyguardWidgetPager;->getWidgetPageAt(I)Lcom/android/keyguard/KeyguardWidgetFrame;

    move-result-object v2

    invoke-virtual {v2}, Lcom/android/keyguard/KeyguardWidgetFrame;->removeAllViews()V
...
.method public dismiss(Z)Z
    ...
    sget v5, Lcom/android/keyguard/R$bool;->kg_sim_puk_account_full_screen:I
    ...
    :goto_3
    invoke-virtual {v6, v3}, Lcom/android/keyguard/KeyguardWidgetPager;->setVisibility(I)V
...
.method isMusicPage(I)Z
    ...
    :cond_1
    sget v1, Lcom/android/keyguard/R$id;->keyguard_transport_control:I

    invoke-direct {p0, v1}, Lcom/android/keyguard/KeyguardHostView;->getWidgetPosition(I)I
...
.method protected onCreateOptions(Landroid/os/Bundle;)V
    ...
    :cond_1
    const-string/jumbo v0, "showappwidget"
...
.method protected onFinishInflate()V
    ...
    :goto_0
    sget v0, Lcom/android/keyguard/R$id;->keyguard_widget_pager_delete_target:I

    invoke-virtual {p0, v0}, Lcom/android/keyguard/KeyguardHostView;->findViewById(I)Landroid/view/View;

    move-result-object v1

    sget v0, Lcom/android/keyguard/R$id;->app_widget_container:I
    ...
    iget-object v2, p0, Lcom/android/keyguard/KeyguardHostView;->mWidgetCallbacks:Lcom/android/keyguard/KeyguardWidgetPager$Callbacks;

    invoke-virtual {v0, v2}, Lcom/android/keyguard/KeyguardWidgetPager;->setCallbacks(Lcom/android/keyguard/KeyguardWidgetPager$Callbacks;)V

    iget-object v0, p0, Lcom/android/keyguard/KeyguardHostView;->mAppWidgetContainer:Lcom/android/keyguard/KeyguardWidgetPager;

    invoke-virtual {v0, v1}, Lcom/android/keyguard/KeyguardWidgetPager;->setDeleteDropTarget(Landroid/view/View;)V

    iget-object v0, p0, Lcom/android/keyguard/KeyguardHostView;->mAppWidgetContainer:Lcom/android/keyguard/KeyguardWidgetPager;

    const/high16 v1, 0x3f000000    # 0.5f

    invoke-virtual {v0, v1}, Lcom/android/keyguard/KeyguardWidgetPager;->setMinScale(F)V

    sget v0, Lcom/android/keyguard/R$id;->sliding_layout:I
    ...
    invoke-virtual {v0, v1}, Lcom/android/keyguard/KeyguardWidgetPager;->setViewStateManager(Lcom/android/keyguard/KeyguardViewStateManager;)V

    iget-object v0, p0, Lcom/android/keyguard/KeyguardHostView;->mAppWidgetContainer:Lcom/android/keyguard/KeyguardWidgetPager;

    iget-object v1, p0, Lcom/android/keyguard/KeyguardHostView;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    invoke-virtual {v0, v1}, Lcom/android/keyguard/KeyguardWidgetPager;->setLockPatternUtils(Lcom/android/internal/widget/LockPatternUtils;)V

    sget v0, Lcom/android/keyguard/R$id;->multi_pane_challenge:I
    ...
    invoke-interface {v0, v1}, Lcom/android/keyguard/ChallengeLayout;->setOnBouncerStateChangedListener(Lcom/android/keyguard/ChallengeLayout$OnBouncerStateChangedListener;)V
    ...
    invoke-virtual {v1, v2}, Lcom/android/keyguard/KeyguardWidgetPager;->setBouncerAnimationDuration(I)V

    iget-object v1, p0, Lcom/android/keyguard/KeyguardHostView;->mViewStateManager:Lcom/android/keyguard/KeyguardViewStateManager;

    iget-object v2, p0, Lcom/android/keyguard/KeyguardHostView;->mAppWidgetContainer:Lcom/android/keyguard/KeyguardWidgetPager;

    invoke-virtual {v1, v2}, Lcom/android/keyguard/KeyguardViewStateManager;->setPagedView(Lcom/android/keyguard/KeyguardWidgetPager;)V

    iget-object v1, p0, Lcom/android/keyguard/KeyguardHostView;->mViewStateManager:Lcom/android/keyguard/KeyguardViewStateManager;

    invoke-virtual {v1, v0}, Lcom/android/keyguard/KeyguardViewStateManager;->setChallengeLayout(Lcom/android/keyguard/ChallengeLayout;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/keyguard/KeyguardViewStateManager;->setSecurityViewContainer(Lcom/android/keyguard/KeyguardSecurityView;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/keyguard/SlidingChallengeLayout;->setOnChallengeScrolledListener(Lcom/android/keyguard/SlidingChallengeLayout$OnChallengeScrolledListener;)V
    ...
    const-string/jumbo v3, "Lockscren Overlay creation fails: "
    ...
    const-string/jumbo v1, "Creating Lockscreen overlay"
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    const-string/jumbo v2, "onRestoreInstanceState, transport="
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    new-instance v2, Lcom/android/keyguard/KeyguardHostView$SavedState;

    invoke-direct {v2, v1}, Lcom/android/keyguard/KeyguardHostView$SavedState;-><init>(Landroid/os/Parcelable;)V
    ...
    :goto_2
    iput v0, v2, Lcom/android/keyguard/KeyguardHostView$SavedState;->transportState:I

    iget v0, p0, Lcom/android/keyguard/KeyguardHostView;->mAppWidgetToShow:I

    iput v0, v2, Lcom/android/keyguard/KeyguardHostView$SavedState;->appWidgetToShow:I

    iget-object v0, v2, Lcom/android/keyguard/KeyguardHostView$SavedState;->insets:Landroid/graphics/Rect;
    ...
    const-string/jumbo v3, "onSaveInstanceState, tstate="
    ...
    invoke-virtual {v1, v3}, Lcom/android/keyguard/KeyguardWidgetPager;->getWidgetPageIndex(Landroid/view/View;)I
...
.method public onWindowFocusChanged(Z)V
    ...
    :goto_3
    iput-boolean v3, p0, Lcom/android/keyguard/KeyguardHostView;->mShowSecurityWhenReturn:Z
