...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mChallengeShowing:Z

    iput-boolean v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mChallengeShowingTargetState:Z
    ...
    iput v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mFrameAnimationTarget:F

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mInsets:Landroid/graphics/Rect;

    iput-boolean v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mChallengeInteractiveExternal:Z

    iput-boolean v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mChallengeInteractiveInternal:Z

    new-instance v0, Lcom/android/keyguard/SlidingChallengeLayout$4;

    invoke-direct {v0, p0}, Lcom/android/keyguard/SlidingChallengeLayout$4;-><init>(Lcom/android/keyguard/SlidingChallengeLayout;)V

    iput-object v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mEndScrollRunnable:Ljava/lang/Runnable;

    new-instance v0, Lcom/android/keyguard/SlidingChallengeLayout$5;

    invoke-direct {v0, p0}, Lcom/android/keyguard/SlidingChallengeLayout$5;-><init>(Lcom/android/keyguard/SlidingChallengeLayout;)V

    iput-object v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mScrimClickListener:Landroid/view/View$OnClickListener;

    new-instance v0, Lcom/android/keyguard/SlidingChallengeLayout$6;

    invoke-direct {v0, p0}, Lcom/android/keyguard/SlidingChallengeLayout$6;-><init>(Lcom/android/keyguard/SlidingChallengeLayout;)V

    iput-object v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mExpandChallengeClickListener:Landroid/view/View$OnClickListener;

    new-instance v0, Landroid/widget/Scroller;

    sget-object v1, Lcom/android/keyguard/SlidingChallengeLayout;->sMotionInterpolator:Landroid/view/animation/Interpolator;

    invoke-direct {v0, p1, v1}, Landroid/widget/Scroller;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mScroller:Landroid/widget/Scroller;
    ...
    iput v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mMinVelocity:I

    invoke-virtual {v0}, Landroid/view/ViewConfiguration;->getScaledMaximumFlingVelocity()I

    move-result v0

    iput v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mMaxVelocity:I
    ...
    iput v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mDragHandleEdgeSlop:I
    ...
    iput v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mTouchSlop:I

    iget v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mTouchSlop:I

    iget v2, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mTouchSlop:I

    mul-int/2addr v1, v2

    iput v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mTouchSlopSquare:I

    invoke-virtual {v0}, Landroid/content/res/Resources;->getDisplayMetrics()Landroid/util/DisplayMetrics;

    move-result-object v1

    iput-object v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mDisplayMetrics:Landroid/util/DisplayMetrics;

    iget-object v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mDisplayMetrics:Landroid/util/DisplayMetrics;
    ...
    iput v2, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mDragHandleClosedAbove:I
    ...
    iput v2, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mDragHandleClosedBelow:I
    ...
    iput v2, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mDragHandleOpenAbove:I
    ...
    iput v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mDragHandleOpenBelow:I

    sget v1, Lcom/android/keyguard/R$dimen;->kg_widget_pager_bottom_padding:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mChallengeBottomBound:I

    invoke-virtual {p0, v6}, Lcom/android/keyguard/SlidingChallengeLayout;->setWillNotDraw(Z)V

    const/16 v0, 0x300

    invoke-virtual {p0, v0}, Lcom/android/keyguard/SlidingChallengeLayout;->setSystemUiVisibility(I)V
...
.method private getChallengeAlpha()F
    ...
    iget v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mChallengeOffset:F
...
.method private getChallengeMargin(Z)I
    ...
    :cond_1
    iget-boolean v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mHasGlowpad:Z
...
.method private getLayoutBottom()I
    ...
    iget v0, v0, Lcom/android/keyguard/SlidingChallengeLayout$LayoutParams;->bottomMargin:I
...
.method private getMaxChallengeBottom()I
    ...
    invoke-virtual {v1}, Lcom/android/keyguard/KeyguardSecurityContainer;->getMeasuredHeight()I

    move-result v1

    add-int/2addr v0, v1

    iget v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mChallengeBottomBound:I
...
.method private moveChallengeTo(I)Z
    ...
    invoke-virtual {v3}, Lcom/android/keyguard/KeyguardSecurityContainer;->getLeft()I
    ...
    invoke-virtual {v5}, Lcom/android/keyguard/KeyguardSecurityContainer;->getRight()I

    move-result v5

    invoke-virtual {v1, v3, v4, v5, v2}, Lcom/android/keyguard/KeyguardSecurityContainer;->layout(IIII)V
    ...
    invoke-virtual {v1, v2}, Lcom/android/keyguard/KeyguardSecurityContainer;->setAlpha(F)V
    ...
    :cond_3
    invoke-direct {p0, v6}, Lcom/android/keyguard/SlidingChallengeLayout;->setChallengeShowing(Z)V
    ...
    invoke-virtual {v2}, Lcom/android/keyguard/KeyguardSecurityContainer;->getTop()I

    move-result v2

    invoke-interface {v1, v0, v2}, Lcom/android/keyguard/SlidingChallengeLayout$OnChallengeScrolledListener;->onScrollPositionChanged(FI)V
...
.method private sendInitialListenerUpdates()V
    ...
    invoke-interface {v0, v1}, Lcom/android/keyguard/SlidingChallengeLayout$OnChallengeScrolledListener;->onScrollStateChanged(I)V
...
.method private showChallenge(I)V
    ...
    iget v3, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mMinVelocity:I
    ...
    :goto_0
    invoke-direct {p0, v1, p1}, Lcom/android/keyguard/SlidingChallengeLayout;->showChallenge(ZI)V
...
.method animateChallengeTo(II)V
    ...
    invoke-virtual {p0, v5}, Lcom/android/keyguard/SlidingChallengeLayout;->distanceInfluenceForSnapDuration(F)F
...
.method animateHandle(Z)V
    ...
    iget-object v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mHandleAnimation:Landroid/animation/ObjectAnimator;
    ...
    iput-object v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mHandleAnimation:Landroid/animation/ObjectAnimator;

    iget-object v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mHandleAnimation:Landroid/animation/ObjectAnimator;

    sget-object v1, Lcom/android/keyguard/SlidingChallengeLayout;->sHandleFadeInterpolator:Landroid/view/animation/Interpolator;
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :goto_0
    iget-object v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mWidgetsView:Landroid/view/View;
    ...
    iget-boolean v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mEdgeCaptured:Z
    ...
    iput-boolean v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mEdgeCaptured:Z
    ...
    :cond_7
    iget-boolean v3, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mEdgeCaptured:Z
...
.method public fadeChallenge(Z)V
    ...
    iput-object v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mFader:Landroid/animation/ObjectAnimator;

    iget-object v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mFader:Landroid/animation/ObjectAnimator;

    new-instance v2, Lcom/android/keyguard/SlidingChallengeLayout$9;

    invoke-direct {v2, p0, p1}, Lcom/android/keyguard/SlidingChallengeLayout$9;-><init>(Lcom/android/keyguard/SlidingChallengeLayout;Z)V
...
.method public hideBouncer()V
    ...
    iget-boolean v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mWasChallengeShowing:Z
    ...
    :goto_2
    iget-object v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mBouncerListener:Lcom/android/keyguard/ChallengeLayout$OnBouncerStateChangedListener;
    ...
    :cond_1
    invoke-virtual {p0, v4}, Lcom/android/keyguard/SlidingChallengeLayout;->showChallenge(Z)V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    :goto_1
    iget-boolean v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mBlockDrag:Z
    ...
    :goto_2
    iget-boolean v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mDragging:Z
    ...
    iput v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mGestureStartX:F

    invoke-virtual {p1}, Landroid/view/MotionEvent;->getY()F

    move-result v0

    iput v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mGestureStartY:F
    ...
    iput v3, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mGestureStartChallengeBottom:I
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/keyguard/SlidingChallengeLayout;->getChildAt(I)Landroid/view/View;
    ...
    iget v11, v1, Lcom/android/keyguard/SlidingChallengeLayout$LayoutParams;->childType:I
    ...
    iget v11, v1, Lcom/android/keyguard/SlidingChallengeLayout$LayoutParams;->leftMargin:I

    add-int/2addr v11, v3

    iget v1, v1, Lcom/android/keyguard/SlidingChallengeLayout$LayoutParams;->topMargin:I
    ...
    iget v1, v1, Lcom/android/keyguard/SlidingChallengeLayout$LayoutParams;->bottomMargin:I
    ...
    iget v15, v0, Lcom/android/keyguard/SlidingChallengeLayout;->mChallengeOffset:F
    ...
    invoke-virtual {v10, v11, v13, v12, v1}, Landroid/view/View;->layout(IIII)V
...
.method protected onMeasure(II)V
    ...
    const-string/jumbo v1, "SlidingChallengeLayout must be measured with an exact size"
    ...
    sget v1, Lcom/android/keyguard/R$id;->keyguard_selector_view:I
    ...
    const-string/jumbo v1, "There may only be one child with layout_isChallenge=\"true\""
    ...
    const-string/jumbo v1, "Challenge must be a KeyguardSecurityContainer"
    ...
    const-string/jumbo v1, "There may only be one child with layout_childType=\"expandChallengeHandle\""
    ...
    iget v0, v0, Lcom/android/keyguard/SlidingChallengeLayout$LayoutParams;->height:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0, v1}, Lcom/android/keyguard/SlidingChallengeLayout;->showChallenge(I)V

    goto :goto_2

    :pswitch_3
    iget v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mActivePointerId:I
    ...
    iget v2, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mMaxVelocity:I
    ...
    iget v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mActivePointerId:I
    ...
    invoke-direct {p0, v0}, Lcom/android/keyguard/SlidingChallengeLayout;->showChallenge(I)V
    ...
    invoke-virtual {p0, v7}, Lcom/android/keyguard/SlidingChallengeLayout;->setScrollState(I)V
    ...
    iget v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mGestureStartY:F
    ...
    iget v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mGestureStartChallengeBottom:I
    ...
    invoke-direct {p0, v3, v4}, Lcom/android/keyguard/SlidingChallengeLayout;->isInDragHandle(FF)Z
    ...
    iput v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mGestureStartChallengeBottom:I

    iput-boolean v7, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mDragging:Z
...
.method public showBouncer()V
    ...
    iput-boolean v0, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mWasChallengeShowing:Z
