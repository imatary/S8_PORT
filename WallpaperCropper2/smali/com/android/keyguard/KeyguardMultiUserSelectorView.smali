...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v1, v0}, Lcom/android/keyguard/KeyguardMultiUserSelectorView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private createAndAddUser(Landroid/content/pm/UserInfo;)Lcom/android/keyguard/KeyguardMultiUserAvatar;
    ...
    sget v0, Lcom/android/keyguard/R$layout;->keyguard_multi_user_avatar:I

    iget-object v1, p0, Lcom/android/keyguard/KeyguardMultiUserSelectorView;->mContext:Landroid/content/Context;

    invoke-static {v0, v1, p0, p1}, Lcom/android/keyguard/KeyguardMultiUserAvatar;->fromXml(ILandroid/content/Context;Lcom/android/keyguard/KeyguardMultiUserSelectorView;Landroid/content/pm/UserInfo;)Lcom/android/keyguard/KeyguardMultiUserAvatar;
...
.method public addUsers(Ljava/util/Collection;)V
    ...
    iget-object v2, p0, Lcom/android/keyguard/KeyguardMultiUserSelectorView;->mOrderAddedComparator:Ljava/util/Comparator;
    ...
    invoke-virtual {v1}, Landroid/os/PersonaManager;->getParentUserForCurrentPersona()I
    ...
    invoke-direct {p0, v0}, Lcom/android/keyguard/KeyguardMultiUserSelectorView;->createAndAddUser(Landroid/content/pm/UserInfo;)Lcom/android/keyguard/KeyguardMultiUserAvatar;
    ...
    :goto_3
    invoke-virtual {v4, v6, v6, v3}, Lcom/android/keyguard/KeyguardMultiUserAvatar;->setActive(ZZLjava/lang/Runnable;)V

    goto :goto_2

    :cond_4
    iput-object v4, p0, Lcom/android/keyguard/KeyguardMultiUserSelectorView;->mActiveUserAvatar:Lcom/android/keyguard/KeyguardMultiUserAvatar;
...
.method public onClick(Landroid/view/View;)V
    ...
    instance-of v0, p1, Lcom/android/keyguard/KeyguardMultiUserAvatar;

    if-eqz v0, :cond_0

    check-cast p1, Lcom/android/keyguard/KeyguardMultiUserAvatar;

    invoke-virtual {p1}, Lcom/android/keyguard/KeyguardMultiUserAvatar;->isClickable()Z
    ...
    invoke-interface {v0, v1}, Lcom/android/keyguard/KeyguardHostView$UserSwitcherCallback;->hideSecurityView(I)V

    invoke-direct {p0, v2}, Lcom/android/keyguard/KeyguardMultiUserSelectorView;->setAllClickable(Z)V

    invoke-virtual {p1, v3}, Lcom/android/keyguard/KeyguardMultiUserAvatar;->lockPressed(Z)V

    iget-object v0, p0, Lcom/android/keyguard/KeyguardMultiUserSelectorView;->mActiveUserAvatar:Lcom/android/keyguard/KeyguardMultiUserAvatar;

    new-instance v1, Lcom/android/keyguard/KeyguardMultiUserSelectorView$4;

    invoke-direct {v1, p0, p1}, Lcom/android/keyguard/KeyguardMultiUserSelectorView$4;-><init>(Lcom/android/keyguard/KeyguardMultiUserSelectorView;Lcom/android/keyguard/KeyguardMultiUserAvatar;)V

    invoke-virtual {v0, v2, v3, v1}, Lcom/android/keyguard/KeyguardMultiUserAvatar;->setActive(ZZLjava/lang/Runnable;)V
    ...
    invoke-interface {v0}, Lcom/android/keyguard/KeyguardHostView$UserSwitcherCallback;->showUnlockHint()V
