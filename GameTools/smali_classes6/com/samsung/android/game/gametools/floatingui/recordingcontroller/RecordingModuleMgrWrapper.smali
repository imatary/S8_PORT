...
# static fields
.field private static mInstance:Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModuleMgrWrapper;
...
.method static synthetic access$000(Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModuleMgrWrapper;)Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModuleMgrWrapper$AsyncListener;
    .locals 1
...
.method private createGCMetadata(IILjava/lang/String;Ljava/lang/String;)Lcom/gdg/recordinglib/ICallback$GCMetadata;
    .locals 4
    ...
    iput-object p4, v0, Lcom/gdg/recordinglib/ICallback$GCMetadata;->pkgName:Ljava/lang/String;
...
.method public static getInstance(Landroid/content/Context;)Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModuleMgrWrapper;
    ...
    sget-object v0, Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModuleMgrWrapper;->mInstance:Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModuleMgrWrapper;
    ...
    sput-object v0, Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModuleMgrWrapper;->mInstance:Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModuleMgrWrapper;
...
.method public startRecord(Ljava/lang/String;Ljava/lang/String;ILcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModuleMgrWrapper$AsyncListener;)V
    ...
    invoke-direct {p0, v4, p3, v2, p2}, Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModuleMgrWrapper;->createGCMetadata(IILjava/lang/String;Ljava/lang/String;)Lcom/gdg/recordinglib/ICallback$GCMetadata;

    move-result-object v3

    :try_start_0
    new-instance v0, Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModuleMgrWrapper$1;

    invoke-direct {v0, p0}, Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModuleMgrWrapper$1;-><init>(Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModuleMgrWrapper;)V
    ...
    invoke-static {v5}, Lcom/sec/game/gamecast/common/utility/CommonUtil;->makeDirectory(Ljava/lang/String;)V
    ...
    iget-object v5, p0, Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModuleMgrWrapper;->mContext:Landroid/content/Context;

    invoke-static {v5, p2, p1}, Lcom/sec/game/gamecast/common/utility/GameToolsFileInfoHelper;->writeIconOnSavedPath(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {}, Lcom/gdg/recordinglib/RecordingModuleMgr;->getInstance()Lcom/gdg/recordinglib/RecordingModuleMgr;

    move-result-object v5

    iget-object v6, p0, Lcom/samsung/android/game/gametools/floatingui/recordingcontroller/RecordingModuleMgrWrapper;->mContext:Landroid/content/Context;

    invoke-virtual {v5, v6, v3, v0}, Lcom/gdg/recordinglib/RecordingModuleMgr;->startRecord(Landroid/content/Context;Lcom/gdg/recordinglib/ICallback$GCMetadata;Lcom/gdg/recordinglib/ICallback;)V
    :try_end_0
    ...
    const-string/jumbo v6, "Exception occurred : startRecord"
