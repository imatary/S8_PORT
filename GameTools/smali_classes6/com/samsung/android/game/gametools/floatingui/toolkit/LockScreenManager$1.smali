...
.method public declared-synchronized onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :try_start_0
    sget-boolean v4, Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->mIsLocked:Z
    :try_end_0
    ...
    # getter for: Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->mTouchFlag:Z
    ...
    # invokes: Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->onActionDown(Landroid/view/MotionEvent;)V
    ...
    # getter for: Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->mTouchPoint:Landroid/graphics/PointF;
    ...
    # getter for: Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->mMovingPoint:Landroid/graphics/PointF;
    ...
    # setter for: Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->mMovingPoint:Landroid/graphics/PointF;
    ...
    # invokes: Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->getDistanceBeetweenPointF(Landroid/graphics/PointF;Landroid/graphics/PointF;)F
    ...
    # getter for: Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->SWIPE_CRTERION:F
    ...
    # getter for: Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->mLockView:Landroid/widget/FrameLayout;
    ...
    # getter for: Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->mTextLayout:Landroid/widget/RelativeLayout;
    ...
    # invokes: Lcom/samsung/android/game/gametools/floatingui/toolkit/LockScreenManager;->onActionUp(Landroid/view/MotionEvent;)V
