...
.method private initVirtualDisplay()V
    ...
    invoke-virtual {v10}, Landroid/media/projection/MediaProjectionManager;->semGetMediaProjection()Landroid/media/projection/MediaProjection;

    move-result-object v0

    iput-object v0, p0, Lcom/gdg/recordinglib/v2/GameRecorder;->mMediaProjection:Landroid/media/projection/MediaProjection;

    iget-object v0, p0, Lcom/gdg/recordinglib/v2/GameRecorder;->mMediaProjection:Landroid/media/projection/MediaProjection;
    ...
    const-string/jumbo v1, "GameRecorder"

    iget v2, p0, Lcom/gdg/recordinglib/v2/GameRecorder;->mWidth:I

    iget v3, p0, Lcom/gdg/recordinglib/v2/GameRecorder;->mHeight:I

    const/16 v4, 0xa0

    const/4 v5, 0x0

    iget-object v6, p0, Lcom/gdg/recordinglib/v2/GameRecorder;->mVideoCodecSurface:Landroid/view/Surface;
    ...
    iput-object v0, p0, Lcom/gdg/recordinglib/v2/GameRecorder;->mVirtualDisplay:Landroid/hardware/display/VirtualDisplay;
    :try_end_0
    ...
    invoke-direct {p0, v0}, Lcom/gdg/recordinglib/v2/GameRecorder;->setMediaProjectionLayer(Landroid/media/projection/MediaProjection;)V
    ...
    const-string/jumbo v0, "Exception occured in initVirtualDisplay"
...
.method private setMediaProjectionLayer(Landroid/media/projection/MediaProjection;)V
    .locals 14

    :try_start_0
    iget-object v9, p0, Lcom/gdg/recordinglib/v2/GameRecorder;->mContext:Landroid/content/Context;
    ...
    iget-object v10, p0, Lcom/gdg/recordinglib/v2/GameRecorder;->mPackageName:Ljava/lang/String;
    ...
    iget v5, v7, Landroid/app/ActivityManager$RunningAppProcessInfo;->uid:I
    ...
    :cond_1
    const-class v9, Landroid/media/projection/MediaProjection;

    const-string/jumbo v10, "LAYER_RECORDER_ENABLED"
    ...
    const-string/jumbo v10, ", gameUid :"
    ...
    const-string/jumbo v10, " , LAYER_RECORDER_ENABLED value :"
    ...
    invoke-static {v9}, Lcom/gdg/recordinglib/logger/SLog;->e(Ljava/lang/String;)V

    const-class v9, Landroid/media/projection/MediaProjection;

    const-string/jumbo v10, "setUserIdToRecord"
    ...
    const-string/jumbo v11, "GameRecorder"
