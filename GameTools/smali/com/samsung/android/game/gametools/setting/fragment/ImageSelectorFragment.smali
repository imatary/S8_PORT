...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/samsung/android/game/gametools/setting/fragment/ImageSelectorFragment$OnCompleteListener;
    }
.end annotation
...
.field private static final FILE_TYPE_CROP_BG:I = 0xc
...
.field private isExistDefaultImage:Z

.field protected isExistSettingImage:Z

.field private listener:Lcom/samsung/android/game/gametools/setting/fragment/ImageSelectorFragment$OnCompleteListener;
...
.method private correctCameraOrientation(Ljava/io/File;)V
    ...
    :try_start_2
    invoke-virtual {v1}, Lcom/samsung/android/game/gametools/setting/fragment/ImageSelectorFragment$RotateImageFailException;->printStackTrace()V
    :try_end_2
...
.method private cropImageFromSamsungGallery(Landroid/net/Uri;IIII)V
    ...
    invoke-direct {p0, v8, v6}, Lcom/samsung/android/game/gametools/setting/fragment/ImageSelectorFragment;->getTempImageFile(ZI)Ljava/io/File;
...
.method private getFileName(I)Ljava/lang/String;
    ...
    :pswitch_0
    const-string/jumbo v0, "crop_temp.jpg"
    ...
    :pswitch_2
    const-string/jumbo v0, "crop_bg_temp.jpg"
...
.method private getTempImageFile(ZI)Ljava/io/File;
    ...
    invoke-static {v3}, Lcom/sec/game/gamecast/common/utility/CommonUtil;->getExternalCacheDir(Landroid/content/Context;)Ljava/io/File;
...
# virtual methods
.method public getBitmapDrawable(Ljava/lang/String;IZ)Landroid/graphics/drawable/Drawable;
    .locals 2

    iget-object v1, p0, Lcom/samsung/android/game/gametools/setting/fragment/ImageSelectorFragment;->imgLoader:Lcom/sec/game/gamecast/common/utility/ImageLoader;

    invoke-virtual {v1, p1, p2, p3}, Lcom/sec/game/gamecast/common/utility/ImageLoader;->createBitmapDrawable(Ljava/lang/String;IZ)Landroid/graphics/drawable/Drawable;
...
.method protected saveImage(Ljava/lang/String;)V
    ...
    iget-boolean v5, p0, Lcom/samsung/android/game/gametools/setting/fragment/ImageSelectorFragment;->isExistDefaultImage:Z
...
.method public setImage(Landroid/widget/ImageView;IIIIIZLcom/samsung/android/game/gametools/setting/fragment/ImageSelectorFragment$OnCompleteListener;)V
    .locals 1
    ...
    iput-object p8, p0, Lcom/samsung/android/game/gametools/setting/fragment/ImageSelectorFragment;->listener:Lcom/samsung/android/game/gametools/setting/fragment/ImageSelectorFragment$OnCompleteListener;

    if-lez p6, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/samsung/android/game/gametools/setting/fragment/ImageSelectorFragment;->isExistDefaultImage:Z
...
.method public setImageDrawable(Landroid/widget/ImageView;I)V
    .locals 7

    const/4 v4, 0x1

    iget-object v0, p0, Lcom/samsung/android/game/gametools/setting/fragment/ImageSelectorFragment;->imgLoader:Lcom/sec/game/gamecast/common/utility/ImageLoader;
...
.method public setOnCompleteListener(Lcom/samsung/android/game/gametools/setting/fragment/ImageSelectorFragment$OnCompleteListener;)V
    .locals 0

    iput-object p1, p0, Lcom/samsung/android/game/gametools/setting/fragment/ImageSelectorFragment;->listener:Lcom/samsung/android/game/gametools/setting/fragment/ImageSelectorFragment$OnCompleteListener;
