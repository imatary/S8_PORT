...
.method private showDialog()V
    ...
    invoke-virtual/range {v23 .. v24}, Landroid/app/Dialog;->findViewById(I)Landroid/view/View;
    ...
    invoke-static/range {v23 .. v23}, Lcom/sec/android/mimage/photoretouching/lpe/util/Utils;->isThemeInstalled(Landroid/content/Context;)Z
    ...
    check-cast v23, Landroid/app/AlertDialog;

    const/16 v24, -0x1

    invoke-virtual/range {v23 .. v24}, Landroid/app/AlertDialog;->getButton(I)Landroid/widget/Button;
    ...
    invoke-virtual/range {v24 .. v25}, Landroid/app/AlertDialog$Builder;->setIcon(Landroid/graphics/drawable/Drawable;)Landroid/app/AlertDialog$Builder;
    ...
    invoke-virtual/range {v23 .. v25}, Landroid/app/AlertDialog$Builder;->setNeutralButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;

    move-result-object v23

    const v24, 0x7f070181
    ...
    check-cast v23, Lcom/sec/android/mimage/photoretouching/lpe/layer/LayerData;

    invoke-virtual/range {v23 .. v23}, Lcom/sec/android/mimage/photoretouching/lpe/layer/LayerData;->getImageData()Lcom/sec/android/mimage/photoretouching/lpe/core/ImageData;

    move-result-object v23

    invoke-virtual/range {v23 .. v23}, Lcom/sec/android/mimage/photoretouching/lpe/core/ImageData;->getThumbnail()Landroid/graphics/Bitmap;
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/sec/android/mimage/photoretouching/lpe/layer/LayerData;->getLayerId()I
    ...
    new-instance v23, Lcom/sec/android/mimage/photoretouching/lpe/util/DialogManager$4;
    ...
    const-string v24, "Select Background"
    ...
    new-instance v23, Lcom/sec/android/mimage/photoretouching/lpe/util/DialogManager$5;
    ...
    invoke-virtual/range {v23 .. v24}, Landroid/app/Dialog;->setCanceledOnTouchOutside(Z)V
    ...
    const v25, 0x7f0a00b8

    invoke-direct/range {v23 .. v25}, Landroid/app/AlertDialog$Builder;-><init>(Landroid/content/Context;I)V

    const-string v24, "Save As"

    invoke-virtual/range {v23 .. v24}, Landroid/app/AlertDialog$Builder;->setTitle(Ljava/lang/CharSequence;)Landroid/app/AlertDialog$Builder;

    move-result-object v23

    const-string v24, "Enter File Name"
    ...
    new-instance v25, Lcom/sec/android/mimage/photoretouching/lpe/util/DialogManager$6;
    ...
    const v24, 0x7f070334

    invoke-virtual/range {v23 .. v24}, Landroid/app/AlertDialog$Builder;->setMessage(I)Landroid/app/AlertDialog$Builder;

    move-result-object v23

    const v24, 0x7f070335
    ...
    const v24, 0x7f07026a

    invoke-virtual/range {v23 .. v24}, Landroid/app/AlertDialog$Builder;->setMessage(I)Landroid/app/AlertDialog$Builder;

    move-result-object v23

    const v24, 0x7f07026b
    ...
    invoke-virtual/range {v23 .. v24}, Landroid/app/Dialog;->setCancelable(Z)V
    ...
    const v24, 0x7f070289

    invoke-virtual/range {v23 .. v24}, Landroid/app/AlertDialog$Builder;->setMessage(I)Landroid/app/AlertDialog$Builder;

    move-result-object v23

    const v24, 0x7f07027e
