.class public Lcom/samsung/android/sdk/rclcamera/impl/se/util/CallState;
...
.method static constructor <clinit>()V
    ...
    const-class v1, Lcom/samsung/android/sdk/rclcamera/impl/se/util/CallState;
    ...
    sput-object v0, Lcom/samsung/android/sdk/rclcamera/impl/se/util/CallState;->TAG:Ljava/lang/String;
...
.method public static isCalling(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcom/samsung/android/sdk/rclcamera/impl/se/util/CallState;->isOffHook(Landroid/content/Context;)Z

    move-result v1

    or-int/2addr v0, v1

    invoke-static {p0}, Lcom/samsung/android/sdk/rclcamera/impl/se/util/CallState;->isOtherVTCallOngoing(Landroid/content/Context;)Z

    move-result v1

    or-int/2addr v0, v1

    invoke-static {}, Lcom/samsung/android/sdk/rclcamera/impl/se/util/CallState;->isVoIPCallOngoing()Z

    move-result v1

    or-int/2addr v0, v1

    invoke-static {p0}, Lcom/samsung/android/sdk/rclcamera/impl/se/util/CallState;->isVTCallOngoing(Landroid/content/Context;)Z
...
.method public static isOtherVTCallOngoing(Landroid/content/Context;)Z
    ...
    sget-object v2, Lcom/samsung/android/sdk/rclcamera/impl/se/util/CallState;->TAG:Ljava/lang/String;
