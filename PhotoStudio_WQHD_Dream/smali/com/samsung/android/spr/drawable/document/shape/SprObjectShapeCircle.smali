...
.method public constructor <init>()V
    ...
    iput v1, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeCircle;->cx:F

    iput v1, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeCircle;->cy:F

    iput v1, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeCircle;->cr:F
...
.method public draw(Lcom/samsung/android/spr/drawable/document/SprDocument;Landroid/graphics/Canvas;FFF)V
    ...
    iget v1, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeCircle;->alpha:F

    mul-float v0, p5, v1

    iget-object v1, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeCircle;->mAttributeList:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeCircle;->applyAttribute(Lcom/samsung/android/spr/drawable/document/SprDocument;Landroid/graphics/Canvas;F)V

    :cond_0
    invoke-virtual {p0}, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeCircle;->setShadowLayer()V

    iget-boolean v1, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeCircle;->isVisibleFill:Z

    if-eqz v1, :cond_1

    iget v1, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeCircle;->cx:F

    iget v2, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeCircle;->cy:F

    iget v3, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeCircle;->cr:F

    iget-object v4, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeCircle;->fillPaint:Landroid/graphics/Paint;

    invoke-virtual {p2, v1, v2, v3, v4}, Landroid/graphics/Canvas;->drawCircle(FFFLandroid/graphics/Paint;)V

    :cond_1
    iget-boolean v1, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeCircle;->isVisibleStroke:Z
    ...
    iget-object v4, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeCircle;->strokePaint:Landroid/graphics/Paint;

    invoke-virtual {p2, v1, v2, v3, v4}, Landroid/graphics/Canvas;->drawCircle(FFFLandroid/graphics/Paint;)V

    :cond_2
    invoke-virtual {p0}, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeCircle;->clearShadowLayer()V
