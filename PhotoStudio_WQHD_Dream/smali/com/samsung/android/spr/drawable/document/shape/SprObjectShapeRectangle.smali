...
.method public constructor <init>()V
    ...
    iput v1, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->left:F

    iput v1, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->top:F

    iput v1, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->right:F

    iput v1, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->bottom:F

    iput v1, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->rx:F

    iput v1, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->ry:F
...
.method public draw(Lcom/samsung/android/spr/drawable/document/SprDocument;Landroid/graphics/Canvas;FFF)V
    ...
    iget v2, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->alpha:F

    mul-float v0, p5, v2

    iget-object v2, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->mAttributeList:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->applyAttribute(Lcom/samsung/android/spr/drawable/document/SprDocument;Landroid/graphics/Canvas;F)V

    :cond_0
    new-instance v1, Landroid/graphics/RectF;

    iget v2, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->left:F

    iget v3, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->top:F

    iget v4, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->right:F

    iget v5, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->bottom:F

    invoke-direct {v1, v2, v3, v4, v5}, Landroid/graphics/RectF;-><init>(FFFF)V

    invoke-virtual {p0}, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->setShadowLayer()V

    iget v2, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->rx:F

    cmpl-float v2, v2, v6

    if-nez v2, :cond_1

    iget v2, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->ry:F
    ...
    :cond_1
    iget-boolean v2, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->isVisibleFill:Z

    if-eqz v2, :cond_2

    iget v2, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->rx:F

    iget v3, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->ry:F

    iget-object v4, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->fillPaint:Landroid/graphics/Paint;

    invoke-virtual {p2, v1, v2, v3, v4}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V

    :cond_2
    iget-boolean v2, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->isVisibleStroke:Z
    ...
    iget-object v4, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->strokePaint:Landroid/graphics/Paint;

    invoke-virtual {p2, v1, v2, v3, v4}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V

    :cond_3
    :goto_0
    invoke-virtual {p0}, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->clearShadowLayer()V
    ...
    iget-object v2, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->fillPaint:Landroid/graphics/Paint;
    ...
    iget-object v2, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeRectangle;->strokePaint:Landroid/graphics/Paint;
