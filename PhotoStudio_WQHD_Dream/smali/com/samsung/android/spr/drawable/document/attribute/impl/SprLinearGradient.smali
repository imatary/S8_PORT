...
.method public updateGradient()V
    ...
    iget-object v5, p0, Lcom/samsung/android/spr/drawable/document/attribute/impl/SprLinearGradient;->colors:[I

    iget-object v6, p0, Lcom/samsung/android/spr/drawable/document/attribute/impl/SprLinearGradient;->positions:[F

    sget-object v7, Lcom/samsung/android/spr/drawable/document/attribute/impl/SprLinearGradient;->sTileModeArray:[Landroid/graphics/Shader$TileMode;

    iget-byte v8, p0, Lcom/samsung/android/spr/drawable/document/attribute/impl/SprLinearGradient;->spreadMode:B
    ...
    iput-object v0, p0, Lcom/samsung/android/spr/drawable/document/attribute/impl/SprLinearGradient;->shader:Landroid/graphics/Shader;

    iget-object v0, p0, Lcom/samsung/android/spr/drawable/document/attribute/impl/SprLinearGradient;->matrix:Landroid/graphics/Matrix;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/samsung/android/spr/drawable/document/attribute/impl/SprLinearGradient;->shader:Landroid/graphics/Shader;

    iget-object v1, p0, Lcom/samsung/android/spr/drawable/document/attribute/impl/SprLinearGradient;->matrix:Landroid/graphics/Matrix;
