...
.method public constructor <init>(Landroid/graphics/drawable/Drawable;Lcom/samsung/android/spr/drawable/document/SprDocument;)V
    ...
    iget-object v0, p0, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationFrame;->mDocument:Lcom/samsung/android/spr/drawable/document/SprDocument;

    invoke-virtual {v0}, Lcom/samsung/android/spr/drawable/document/SprDocument;->getFrameAnimationCount()I

    move-result v0

    iput v0, p0, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationFrame;->mFrameCount:I

    iget v0, p0, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationFrame;->mFrameCount:I

    iget-object v1, p0, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationFrame;->mDocument:Lcom/samsung/android/spr/drawable/document/SprDocument;

    iget v1, v1, Lcom/samsung/android/spr/drawable/document/SprDocument;->mRepeatCount:I

    mul-int/2addr v0, v1

    iput v0, p0, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationFrame;->mTotalFrameCount:I
...
.method public getAnimationIndex()I
    ...
    iget-object v2, p0, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationFrame;->mDocument:Lcom/samsung/android/spr/drawable/document/SprDocument;

    iget-byte v2, v2, Lcom/samsung/android/spr/drawable/document/SprDocument;->mRepeatMode:B

    const/4 v3, 0x2

    if-ne v2, v3, :cond_0

    iget v2, p0, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationFrame;->mCurrentFrameIndex:I

    iget v3, p0, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationFrame;->mFrameCount:I
    ...
    iget v2, p0, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationFrame;->mFrameCount:I
...
.method public run()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationFrame;->mDrawable:Landroid/graphics/drawable/Drawable;

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J

    move-result-wide v2

    iget v1, p0, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationFrame;->mInterval:I
    ...
    iput-boolean v0, p0, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationFrame;->mIsRunning:Z
