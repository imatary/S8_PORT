...
.source "HermesServiceManagerWrapper.java"
...
.method public static create(Landroid/content/Context;)Lcom/samsung/android/spen/libwrapper/HermesServiceManagerWrapper;
    ...
    :try_start_0
    new-instance v1, Lcom/samsung/android/spen/libwrapper/HermesServiceManagerWrapper;

    new-instance v2, Lcom/samsung/android/spen/libse/SeHermesServiceManager;

    invoke-direct {v2, p0}, Lcom/samsung/android/spen/libse/SeHermesServiceManager;-><init>(Landroid/content/Context;)V

    invoke-direct {v1, v2}, Lcom/samsung/android/spen/libwrapper/HermesServiceManagerWrapper;-><init>(Lcom/samsung/android/spen/libinterface/HermesServiceManagerInterface;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    new-instance v2, Lcom/samsung/android/spen/libsdl/SdlHermesServiceManager;

    invoke-direct {v2, p0}, Lcom/samsung/android/spen/libsdl/SdlHermesServiceManager;-><init>(Landroid/content/Context;)V
...
.method public dismissHermes()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/samsung/android/spen/libwrapper/HermesServiceManagerWrapper;->instance:Lcom/samsung/android/spen/libinterface/HermesServiceManagerInterface;

    invoke-interface {v1}, Lcom/samsung/android/spen/libinterface/HermesServiceManagerInterface;->dismissHermes()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/Error; {:try_start_0 .. :try_end_0} :catch_1
...
.method public showHermes(Ljava/lang/String;Landroid/graphics/Rect;)V
    ...
    invoke-interface {v1, p1, p2}, Lcom/samsung/android/spen/libinterface/HermesServiceManagerInterface;->showHermes(Ljava/lang/String;Landroid/graphics/Rect;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/Error; {:try_start_0 .. :try_end_0} :catch_1
