...
.method public static create(Landroid/content/Context;)Lcom/samsung/android/spen/libwrapper/TypefaceWrapper;
    ...
    :try_start_0
    new-instance v1, Lcom/samsung/android/spen/libwrapper/TypefaceWrapper;

    new-instance v2, Lcom/samsung/android/spen/libse/SeTypeface;

    invoke-direct {v2}, Lcom/samsung/android/spen/libse/SeTypeface;-><init>()V

    invoke-direct {v1, v2}, Lcom/samsung/android/spen/libwrapper/TypefaceWrapper;-><init>(Lcom/samsung/android/spen/libinterface/TypefaceInterface;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    new-instance v2, Lcom/samsung/android/spen/libsdl/SdlTypeface;

    invoke-direct {v2}, Lcom/samsung/android/spen/libsdl/SdlTypeface;-><init>()V
...
.method public getFontPathOfCurrentFontStyle(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/samsung/android/spen/libwrapper/TypefaceWrapper;->instance:Lcom/samsung/android/spen/libinterface/TypefaceInterface;

    invoke-interface {v1, p1, p2}, Lcom/samsung/android/spen/libinterface/TypefaceInterface;->getFontPathOfCurrentFontStyle(Landroid/content/Context;I)Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/Error; {:try_start_0 .. :try_end_0} :catch_1
