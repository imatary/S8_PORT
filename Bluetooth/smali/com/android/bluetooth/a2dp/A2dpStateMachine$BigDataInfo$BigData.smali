...
# direct methods
.method static synthetic -wrap0(Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;Ljava/lang/String;I)Ljava/lang/String;
    .locals 1

    invoke-direct {p0, p1, p2}, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->getBigDataString(Ljava/lang/String;I)Ljava/lang/String;
...
.method static synthetic -wrap2(Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;Ljava/lang/String;)V
    .locals 0
...
.method private checkEachData(Lorg/json/JSONObject;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->getBigDataString(Ljava/lang/String;I)Ljava/lang/String;

    move-result-object v1

    const-string/jumbo v2, "ACFR"

    invoke-static {v0, v1, v2}, Lcom/android/bluetooth/a2dp/A2dpStateMachine;->-wrap24(Lcom/android/bluetooth/a2dp/A2dpStateMachine;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, v2}, Lcom/android/bluetooth/a2dp/A2dpStateMachine;->-wrap23(Lcom/android/bluetooth/a2dp/A2dpStateMachine;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, v2}, Lcom/android/bluetooth/a2dp/A2dpStateMachine;->-wrap34(Lcom/android/bluetooth/a2dp/A2dpStateMachine;ILjava/lang/String;)V
    ...
    invoke-static {v0, v1, v2}, Lcom/android/bluetooth/a2dp/A2dpStateMachine;->-wrap32(Lcom/android/bluetooth/a2dp/A2dpStateMachine;ILjava/lang/String;)V
...
.method private getBigDataString(Ljava/lang/String;I)Ljava/lang/String;
    .locals 4
    ...
    const-string/jumbo v1, ",\"FVER\":\""

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v1, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mFirmwareVer:Ljava/lang/String;
    ...
    const-string/jumbo v1, ",\"RCOD\":\""

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v1, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mPeerCod:I
...
.method private initBigData()V
    ...
    iput-object v0, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mFirmwareVer:Ljava/lang/String;

    iput-object v3, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mPeerOui:Ljava/lang/String;

    iput-object v3, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mPeerFullOui:Ljava/lang/String;

    iput-object v3, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mPeerName:Ljava/lang/String;

    iput v2, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mPeerCod:I

    const/16 v0, 0xff

    iput v0, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mCurCodec:I

    iput v2, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mPeerCodecs:I

    iput v2, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mPreOverflowCount:I

    iput v2, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mOverflowCount:I

    iput v2, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mBusyLevel:I

    iput v2, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mConnectionFailReason:I

    iput v2, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mLinkFeedbackInfomation:I

    iput v2, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mBitRate:I

    iput-wide v4, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mServiceStartTime:J

    iput-wide v4, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mServiceEndTime:J

    iput-wide v4, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mConnectedTotalTime:J

    iput-wide v4, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mPlayStartTime:J

    iput-wide v4, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mPlayingTotalTime:J

    iput-wide v4, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mUhqaReconfiguredTime:J

    iput-wide v4, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mUhqaTotalTime:J

    iput-wide v4, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mPreOverflowTime:J

    iput-wide v4, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mTotalOverflowDuration:J

    iput v2, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mConfigLength:I
...
.method private setOverflowCount(I)V
    ...
    invoke-static {v3}, Lcom/android/bluetooth/a2dp/A2dpStateMachine;->-get10(Lcom/android/bluetooth/a2dp/A2dpStateMachine;)Landroid/content/Context;
    ...
    invoke-static {v3}, Lcom/android/bluetooth/a2dp/A2dpStateMachine;->-get15(Lcom/android/bluetooth/a2dp/A2dpStateMachine;)Z
    ...
    invoke-static {v3, v8}, Lcom/android/bluetooth/a2dp/A2dpStateMachine;->-set4(Lcom/android/bluetooth/a2dp/A2dpStateMachine;Z)Z
    ...
    invoke-static {v3, v4}, Lcom/android/bluetooth/a2dp/A2dpStateMachine;->-wrap30(Lcom/android/bluetooth/a2dp/A2dpStateMachine;Ljava/lang/String;)V
...
.method private setPeerName(Ljava/lang/String;)V
    ...
    invoke-static {v3}, Lcom/android/bluetooth/a2dp/A2dpStateMachine;->-get4(Lcom/android/bluetooth/a2dp/A2dpStateMachine;)Landroid/bluetooth/BluetoothAdapter;
    ...
    iput v3, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mPeerCod:I

    iget v3, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mPeerCod:I
    ...
    iget v5, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mPeerCod:I
...
.method public checkServiceTime(I)V
    ...
    :cond_1
    iget-wide v2, p0, Lcom/android/bluetooth/a2dp/A2dpStateMachine$BigDataInfo$BigData;->mServiceStartTime:J
