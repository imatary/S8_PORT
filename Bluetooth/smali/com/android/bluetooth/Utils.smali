...
.field private static mDualAudioDuration:J

.field private static mDualAudioStartTime:J

.field private static mMultiPlayingDuration:J

.field private static mMultiPlayingStartTime:J

.field private static mTotalPlayingDuration:J

.field private static mTotalPlayingStartTime:J
...
.method public static getCustomHeadsUpNotificationView(Landroid/content/Context;)Landroid/widget/RemoteViews;
    .locals 3
...
.method public static getDualAudioTime(IZ)J
    .locals 5
    ...
    sget-wide v0, Lcom/android/bluetooth/Utils;->mMultiPlayingStartTime:J

    :cond_0
    :goto_0
    sget-boolean v2, Lcom/android/bluetooth/Utils;->DEBUG:Z
    ...
    const-string/jumbo v4, "getDualAudioTime type : "
    ...
    :cond_2
    sget-wide v0, Lcom/android/bluetooth/Utils;->mMultiPlayingDuration:J
    ...
    sget-wide v0, Lcom/android/bluetooth/Utils;->mTotalPlayingStartTime:J

    goto :goto_0

    :cond_4
    sget-wide v0, Lcom/android/bluetooth/Utils;->mTotalPlayingDuration:J
    ...
    sget-wide v0, Lcom/android/bluetooth/Utils;->mDualAudioStartTime:J

    goto :goto_0

    :cond_6
    sget-wide v0, Lcom/android/bluetooth/Utils;->mDualAudioDuration:J
...
.method public static getSecureModeSetting(Ljava/lang/String;)Z
    .locals 6
    ...
    invoke-virtual {v3, p0}, Landroid/bluetooth/BluetoothSecureManager;->getSecureModeSetting(Ljava/lang/String;)I
    :try_end_0
    ...
    const-string/jumbo v3, "BluetoothUtils"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v5, "getSecMgr error : "
...
.method public static getSepPlatformVersion(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/android/bluetooth/Utils;->isSemAvailable(Landroid/content/Context;)Z
...
.method public static insertEventLog(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-boolean v1, Lcom/android/bluetooth/Utils;->DEBUG:Z
    ...
    const-string/jumbo v3, "insertEventLog :: viewID = "
    ...
    const-string/jumbo v2, "Exception occurred when getting SA"
...
.method public static insertEventLog(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "insertEventLogWithDetail viewID: "
    ...
    const-string/jumbo v3, ", detailValue: "
...
.method public static isSecureModeEnabled()Z
    .locals 4
    ...
    const-string/jumbo v3, "getSecMgr error : "
...
.method public static launchDualPlayNotification(Landroid/content/Context;Z)V
    .locals 14

    const-string/jumbo v11, "BluetoothUtils"

    const-string/jumbo v12, "launchDualPlayNotification :: "
    ...
    const-string/jumbo v11, "dual_play"
    ...
    invoke-virtual {v5, v2}, Landroid/app/Notification$Builder;->addExtras(Landroid/os/Bundle;)Landroid/app/Notification$Builder;
    ...
    const-string/jumbo v11, "com.samsung.bluetooth.a2dp.intent.extra.DUAL_PLAY_NOTI_TYPE"
    ...
    invoke-static {p0, v11, v0, v12}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v5, v12, v11, v7}, Landroid/app/Notification$Builder;->addAction(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroid/app/Notification$Builder;
    ...
    invoke-static {p0, v11, v10, v12}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v5, v12, v11, v9}, Landroid/app/Notification$Builder;->addAction(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroid/app/Notification$Builder;
    ...
    invoke-static {p0}, Lcom/android/bluetooth/Utils;->getCustomHeadsUpNotificationView(Landroid/content/Context;)Landroid/widget/RemoteViews;
    ...
    invoke-static {v1, v11, v12}, Lcom/android/bluetooth/Utils;->setIconCustomNotification(Landroid/widget/RemoteViews;II)V
    ...
    invoke-static {v1, v12, v11}, Lcom/android/bluetooth/Utils;->setTextCustomNotification(Landroid/widget/RemoteViews;ILjava/lang/String;)V
    ...
    invoke-static {v1, v12, v11, v7}, Lcom/android/bluetooth/Utils;->setButtonCustomNotification(Landroid/widget/RemoteViews;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-static {v1, v12, v11, v9}, Lcom/android/bluetooth/Utils;->setButtonCustomNotification(Landroid/widget/RemoteViews;ILjava/lang/String;Landroid/app/PendingIntent;)V

    iput-object v1, v4, Landroid/app/Notification;->headsUpContentView:Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v6, v11, v12, v4}, Landroid/app/NotificationManager;->notify(Ljava/lang/String;ILandroid/app/Notification;)V
    ...
    :cond_1
    iget-object v11, v4, Landroid/app/Notification;->headsUpContentView:Landroid/widget/RemoteViews;

    iput-object v11, v4, Landroid/app/Notification;->headsUpContentView:Landroid/widget/RemoteViews;

    goto :goto_1
.end method

.method public static launchDualPlayOnGoingNotification(Landroid/content/Context;)V
    .locals 15
    ...
    const-string/jumbo v9, "launchDualPlayOnGoingNotification :: "
    ...
    const-string/jumbo v8, "dual_play"

    invoke-virtual {v4, v8, v12}, Landroid/app/NotificationManager;->cancel(Ljava/lang/String;I)V
    ...
    const-string/jumbo v8, "android.substName"
    ...
    const-string/jumbo v8, "com.samsung.bluetooth.a2dp.intent.action.DUAL_PLAY_NOTI_SELECTED"

    invoke-direct {v7, v8}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    const-string/jumbo v8, "com.samsung.bluetooth.a2dp.intent.extra.DUAL_PLAY_NOTI_SELECT_TYPE"

    invoke-virtual {v7, v8, v13}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string/jumbo v8, "com.samsung.bluetooth.a2dp.intent.extra.DUAL_PLAY_NOTI_TYPE"

    invoke-virtual {v7, v8, v12}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    invoke-static {p0, v13, v7, v14}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v3, v11, v8, v6}, Landroid/app/Notification$Builder;->addAction(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroid/app/Notification$Builder;

    new-instance v1, Landroid/content/Intent;

    const-string/jumbo v8, "com.samsung.settings.BLUETOOTH_DUAL_PLAY_SETTINGS"
    ...
    invoke-static {p0, v11, v1, v14}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v4, v8, v12, v2}, Landroid/app/NotificationManager;->notify(Ljava/lang/String;ILandroid/app/Notification;)V
...
.method public static setButtonCustomNotification(Landroid/widget/RemoteViews;ILjava/lang/String;Landroid/app/PendingIntent;)V
    .locals 2
...
.method public static setDualAudioTime(IZZJ)V
    .locals 5
    ...
    sput-wide p3, Lcom/android/bluetooth/Utils;->mMultiPlayingStartTime:J
    ...
    const-string/jumbo v2, "setDualAudioTime mMultiPlayingStartTime : "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget-wide v2, Lcom/android/bluetooth/Utils;->mMultiPlayingStartTime:J

    invoke-virtual {v1, v2, v3}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v2, ", mMultiPlayingDuration : "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget-wide v2, Lcom/android/bluetooth/Utils;->mMultiPlayingDuration:J

    invoke-virtual {v1, v2, v3}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v2, ", mTotalPlayingStartTime : "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget-wide v2, Lcom/android/bluetooth/Utils;->mTotalPlayingStartTime:J

    invoke-virtual {v1, v2, v3}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v2, ", mTotalPlayingDuration : "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget-wide v2, Lcom/android/bluetooth/Utils;->mTotalPlayingDuration:J

    invoke-virtual {v1, v2, v3}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v2, ", mDualAudioStartTime : "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget-wide v2, Lcom/android/bluetooth/Utils;->mDualAudioStartTime:J

    invoke-virtual {v1, v2, v3}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v2, ", mDualAudioDuration : "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget-wide v2, Lcom/android/bluetooth/Utils;->mDualAudioDuration:J
    ...
    :cond_2
    sput-wide p3, Lcom/android/bluetooth/Utils;->mMultiPlayingDuration:J
    ...
    sput-wide v0, Lcom/android/bluetooth/Utils;->mMultiPlayingDuration:J
    ...
    sput-wide p3, Lcom/android/bluetooth/Utils;->mTotalPlayingStartTime:J

    goto :goto_0

    :cond_5
    sput-wide p3, Lcom/android/bluetooth/Utils;->mTotalPlayingDuration:J
    ...
    sput-wide v0, Lcom/android/bluetooth/Utils;->mTotalPlayingDuration:J
    ...
    sput-wide p3, Lcom/android/bluetooth/Utils;->mDualAudioStartTime:J

    goto/16 :goto_0

    :cond_8
    sput-wide p3, Lcom/android/bluetooth/Utils;->mDualAudioDuration:J
    ...
    sput-wide v0, Lcom/android/bluetooth/Utils;->mDualAudioDuration:J
...
.method public static setIconCustomNotification(Landroid/widget/RemoteViews;II)V
    .locals 1
...
.method public static setTextCustomNotification(Landroid/widget/RemoteViews;ILjava/lang/String;)V
    .locals 2
