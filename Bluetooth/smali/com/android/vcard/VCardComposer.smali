...
.method private createOneEntryInternal(JLjava/lang/reflect/Method;)Ljava/lang/String;
    ...
    sget-wide v24, Landroid/provider/ContactsContract$Contacts;->ENTERPRISE_CONTACT_ID_BASE:J
    ...
    const-string/jumbo v6, "knoxContainerId"
    ...
    :cond_0
    :goto_0
    const-string/jumbo v22, "contact_id=?"
    ...
    :try_start_2
    const-string/jumbo v4, "VCardComposer"

    const-string/jumbo v6, "EntityIterator is null"
    ...
    const-string/jumbo v6, "InvocationTargetException has been thrown: "
    ...
    const-string/jumbo v7, "IllegalAccessException has been thrown: "
    ...
    const-string/jumbo v7, "IllegalArgumentException has been thrown: "
    ...
    const-string/jumbo v9, "is_super_primary desc"
    ...
    const-string/jumbo v7, "Data does not exist. contactId: "
...
.method public buildVCard(Ljava/util/Map;)Ljava/lang/String;
    ...
    const-string/jumbo v1, "vnd.sec.cursor.item/name_card"
